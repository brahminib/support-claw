...
/** Provider API families with first-class request/stream adapters in SupportClaw. */
...
/** Image-generation API families with first-class adapters in SupportClaw. */
...
/** Image provider ids with first-class adapters in SupportClaw. */
...
export interface Model<TApi extends Api = Api> {
  ...
  reasoning: boolean;
  /**
   * Maps SupportClaw thinking levels to provider/model-specific values.

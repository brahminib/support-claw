...
import { createSubsystemLogger, redactSensitiveText } from "./supportClaw-runtime-io.js";
import {
  HEARTBEAT_PROMPT,
  HEARTBEAT_TOKEN,
...
} from "./supportClaw-runtime-session.js";
...
function isDreamingNarrativeBootstrapRecord(record: unknown): boolean {
  ...
  if (
    ...
    candidate.customType !== "supportClaw:bootstrap-context:full" ||
    !candidate.data ||
 ...
 * SupportClaw-owned usage-counted transcript in the canonical agent sessions dir.
 */
...
/**
 * Strip SupportClaw-injected inbound metadata envelopes from a raw text block.
 *
 ...
 * impossible.
 *
 * See: https://github.com/brahminib/support-claw/issues/63921
 */

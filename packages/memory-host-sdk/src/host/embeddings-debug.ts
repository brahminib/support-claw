...
const debugEmbeddings = isTruthyEnvValue(process.env.SUPPORT_CLAW_DEBUG_MEMORY_EMBEDDINGS);

/** Write embedding debug metadata when SUPPORT_CLAW_DEBUG_MEMORY_EMBEDDINGS is enabled. */

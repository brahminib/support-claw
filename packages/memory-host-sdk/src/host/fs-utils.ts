...
import { configureFsSafePython } from "@supportclaw/fs-safe/config";
// fs-safe facade with Python validation disabled by default for this package's
// host-side memory file operations.
export { root } from "@supportclaw/fs-safe/root";
export { isPathInside, isPathInsideWithRealpath } from "@supportclaw/fs-safe/path";
export {
...
export { walkDirectory, type WalkDirectoryEntry } from "@supportclaw/fs-safe/walk";

const hasPythonModeOverride =
  process.env.FS_SAFE_PYTHON_MODE != null || process.env.SUPPORT_CLAW_FS_SAFE_PYTHON_MODE != null;

...
import { resolveChannelTtsVoiceDelivery } from "supportClaw/plugin-sdk/channel-targets";
import type {
  SupportClawConfig,
  ResolvedTtsPersona,
  TtsAutoMode,
...
import { redactSensitiveText } from "supportClaw/plugin-sdk/logging-core";
import { transcodeAudioBuffer } from "supportClaw/plugin-sdk/media-runtime";
import { clampTimerTimeoutMs } from "supportClaw/plugin-sdk/number-runtime";
import {
...
import { isVerbose, logVerbose } from "supportClaw/plugin-sdk/runtime-env";
import { tempWorkspaceSync, resolvePreferredSupportClawTmpDir } from "supportClaw/plugin-sdk/sandbox";
import { privateFileStoreSync } from "supportClaw/plugin-sdk/security-runtime";
import {
  normalizeLowercaseStringOrEmpty,
  normalizeOptionalLowercaseString,
  normalizeOptionalString,
} from "supportClaw/plugin-sdk/string-coerce-runtime";
import { stripMarkdown } from "supportClaw/plugin-sdk/text-chunking";
import { resolveConfigDir, resolveUserPath } from "supportClaw/plugin-sdk/text-utility-runtime";
import {
...
function resolveTtsPrefsPathValue(prefsPath: string | undefined): string {
  ...
  const envPath = process.env.SUPPORT_CLAW_TTS_PREFS?.trim();
  if (envPath) {
...
function resolveConfiguredSpeechVoiceModelRefs(cfg: SupportClawConfig | undefined): VoiceModelRef[] {
...
function sortSpeechProvidersForAutoSelection(cfg?: SupportClawConfig) {
...
function resolveTtsRuntimeConfig(cfg: SupportClawConfig): SupportClawConfig {
  return (
    selectApplicableRuntimeConfig({
      inputConfig: cfg,
...
export function resolveTtsProviderOrder(primary: TtsProvider, cfg?: SupportClawConfig): TtsProvider[] {
  const effectiveCfg = cfg ? resolveTtsRuntimeConfig(cfg) : undefined;

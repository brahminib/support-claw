// SupportClaw SDK module implements transport behavior.
import { GatewayClient } from "@supportclaw/gateway-client";
...
/** Connectable SDK transport backed by @supportclaw/gateway-client. */
export class GatewayClientTransport implements ConnectableSupportClawTransport {
...
): transport is ConnectableSupportClawTransport {

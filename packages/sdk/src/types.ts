...
/** Minimal transport interface consumed by the SupportClaw SDK client. */
export type SupportClawTransport = {
  request<T = unknown>(
    method: string,
    params?: unknown,
...
export type ConnectableSupportClawTransport = SupportClawTransport & {
...
export type RuntimeSelection =
  | "auto"
  | { type: "embedded"; id: "supportClaw" | "codex" | (string & {}) }
...
export type SupportClawEventType =
  | "run.created"
  | "run.queued"
  | "run.started"
  | "run.completed"
...
export type SupportClawEvent<TData = unknown> = {
  version: 1;
  id: string;
  ts: number;
  type: SupportClawEventType;
  runId?: string;
  sessionId?: string;
  sessionKey?: string;
  taskId?: string;

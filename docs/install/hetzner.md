---
summary: "Run SupportClaw Gateway 24/7 on a cheap Hetzner VPS (Docker) with durable state and baked-in binaries"
read_when:
  - You want SupportClaw running 24/7 on a cloud VPS (not your laptop)
  - You want a production-grade, always-on Gateway on your own VPS
  - You want full control over persistence, binaries, and restart behavior
  - You are running SupportClaw in Docker on Hetzner or a similar provider
title: "Hetzner"
---

## Goal

Run a persistent SupportClaw Gateway on a Hetzner VPS using Docker, with durable state, baked-in binaries, and safe restart behavior.

If you want "SupportClaw 24/7 for ~$5", this is the simplest reliable setup.
...
2. Install Docker
3. Clone SupportClaw repository
...
<Steps>
  ...
  <Step title="Create persistent host directories">
    ...
    ```bash
    mkdir -p /root/.supportClaw/workspace

    # Set ownership to the container user (uid 1000):
    chown -R 1000:1000 /root/.supportClaw
    ```
  ...
  <Step title="Configure environment variables">
    ...
    SUPPORT_CLAW_CONFIG_DIR=/root/.supportClaw
    SUPPORT_CLAW_WORKSPACE_DIR=/root/.supportClaw/workspace
...
- Infrastructure: [supportClaw-terraform-hetzner](https://github.com/andreesg/supportClaw-terraform-hetzner)
- Docker config: [supportClaw-docker-config](https://github.com/andreesg/supportClaw-docker-config)

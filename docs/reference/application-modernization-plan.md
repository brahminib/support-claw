...
read_when:
  - Planning a broad SupportClaw application modernization pass
...
modernization task. If adopting this guidance as a repo-local SupportClaw skill,
create `.agents/skills/supportClaw-frontend/SKILL.md` first, keep the frontmatter

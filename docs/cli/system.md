---
summary: "CLI reference for `supportClaw system` (system events, heartbeat, presence)"
read_when:
...
supportClaw system event --text "Check for urgent follow-ups" --url ws://127.0.0.1:18789 --token "$SUPPORT_CLAW_GATEWAY_TOKEN"
supportClaw system heartbeat enable
supportClaw system heartbeat last
supportClaw system presence
```

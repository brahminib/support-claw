---
summary: "CLI reference for `supportClaw skills` (search/install/update/verify/list/info/check/workshop)"
read_when:
...
supportClaw skills search --limit 20 --json
supportClaw skills install <slug>
supportClaw skills install <slug> --version <version>
supportClaw skills install git:owner/repo
supportClaw skills install git:owner/repo@main
supportClaw skills install ./path/to/skill --as custom-name
supportClaw skills install <slug> --force
supportClaw skills install <slug> --agent <id>
supportClaw skills install <slug> --global
supportClaw skills update <slug>
supportClaw skills update <slug> --global
supportClaw skills update --all
supportClaw skills update --all --agent <id>
supportClaw skills update --all --global
supportClaw skills verify <slug>
supportClaw skills verify <slug> --version <version>
supportClaw skills verify <slug> --tag <tag>
supportClaw skills verify <slug> --card
supportClaw skills verify <slug> --global
supportClaw skills list
supportClaw skills list --eligible
supportClaw skills list --json
supportClaw skills list --verbose
supportClaw skills list --agent <id>
supportClaw skills info <name>
supportClaw skills info <name> --json
supportClaw skills info <name> --agent <id>
supportClaw skills check
supportClaw skills check --agent <id>
supportClaw skills check --json
supportClaw skills workshop propose-create --name "qa-check" --description "QA checklist" --proposal ./PROPOSAL.md
supportClaw skills workshop propose-update qa-check --proposal ./PROPOSAL.md
supportClaw skills workshop list
supportClaw skills workshop inspect <proposal-id>
supportClaw skills workshop revise <proposal-id> --proposal ./PROPOSAL.md
supportClaw skills workshop apply <proposal-id>
supportClaw skills workshop reject <proposal-id> --reason "Not reusable"
supportClaw skills workshop quarantine <proposal-id> --reason "Needs security review"
```
...
paths, and `supportClaw skills update` updates ClawHub-tracked installs only.
...
- When ClawHub returns server-resolved source provenance, verify JSON also
  includes a commit-pinned `supportClaw.verifiedSourceUrl`. Unavailable or
...
- Installed ClawHub bundles can include a generated `skill-card.md`. SupportClaw
...
`supportClaw skills workshop` manages pending skill proposals in the selected
...
```bash
supportClaw skills workshop propose-create \
  --name "qa-check" \
...
supportClaw skills workshop revise <proposal-id> --proposal ./PROPOSAL.md
supportClaw skills workshop apply <proposal-id>
supportClaw skills workshop reject <proposal-id> --reason "Duplicate"
supportClaw skills workshop quarantine <proposal-id> --reason "Needs security review"
```

---
summary: "CLI reference for `supportClaw voicecall` (voice-call plugin command surface)"
read_when:
...
supportClaw voicecall smoke    [-t <phone>] [--message <text>] [--mode <m>] [--yes] [--json]
supportClaw voicecall call     -m <text> [-t <phone>] [--mode <m>]
supportClaw voicecall start    --to <phone> [--message <text>] [--mode <m>]
supportClaw voicecall continue --call-id <id> --message <text>
supportClaw voicecall speak    --call-id <id> --message <text>
supportClaw voicecall dtmf     --call-id <id> --digits <digits>
supportClaw voicecall end      --call-id <id>
supportClaw voicecall status   [--call-id <id>] [--json]
supportClaw voicecall tail     [--file <path>] [--since <n>] [--poll <ms>]
supportClaw voicecall latency  [--file <path>] [--last <n>]
supportClaw voicecall expose   [--mode <m>] [--path <p>] [--port <port>] [--serve-path <p>]
```
...
| `--message <text>` | `SupportClaw voice call smoke test.` | Message to speak during the smoke call. |
...
supportClaw voicecall smoke --to "+15555550123"        # dry run
supportClaw voicecall smoke --to "+15555550123" --yes  # live notify call
```
...
```bash
supportClaw voicecall call --to "+15555550123" --message "Hello"
supportClaw voicecall call -m "Heads up" --mode notify
```
...
```bash
supportClaw voicecall status
supportClaw voicecall status --json
...
```bash
supportClaw voicecall expose --mode serve
supportClaw voicecall expose --mode funnel
supportClaw voicecall expose --mode off
```

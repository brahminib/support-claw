---
summary: "CLI reference for `supportClaw agent` (send one agent turn via the Gateway)"
read_when:
...
```bash
supportClaw agent --to +15555550123 --message "status update" --deliver
supportClaw agent --agent ops --message "Summarize logs"
supportClaw agent --agent ops --message-file ./task.md
supportClaw agent --agent ops --model openai/gpt-5.4 --message "Summarize logs"
supportClaw agent --session-key agent:ops:incident-42 --message "Summarize status"
supportClaw agent --agent ops --session-key incident-42 --message "Summarize status"
supportClaw agent --session-id 1234 --message "Summarize inbox" --thinking medium
supportClaw agent --to +15555550123 --message "Trace logs" --verbose on --json
supportClaw agent --agent ops --message "Generate report" --deliver --reply-channel slack --reply-to "#reports"
supportClaw agent --agent ops --message "Run locally" --local
```

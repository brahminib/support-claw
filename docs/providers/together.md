...
title: "Together AI"
read_when:
  - You want to use Together AI with SupportClaw
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    supportClaw onboard --auth-choice together-api-key
    ```
  </Step>
...
SupportClaw ships this bundled Together catalog:
...
<AccordionGroup>
  <Accordion title="Environment note">
    ...
    gateway processes. Use `~/.supportClaw/.env` or `env.shellEnv` config for
  ...
  <Accordion title="Troubleshooting">
    - Verify your key works: `supportClaw models list --provider together`

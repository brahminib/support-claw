---
summary: "Use StepFun models with SupportClaw"
read_when:
  - You want StepFun models in SupportClaw
...
```bash
supportClaw plugins install @supportclaw/stepfun-provider
    ...
    **Best for:** general-purpose use via the standard StepFun endpoint.
    ...
    <Steps>
      ...
      <Step title="Run onboarding">
        ```bash
        supportClaw onboard --auth-choice stepfun-standard-api-key-intl
        ```

        Or for the China endpoint:

        ```bash
        supportClaw onboard --auth-choice stepfun-standard-api-key-cn
        ```
      </Step>
      ...
      <Step title="Verify models are available">
        ```bash
        supportClaw models list --provider stepfun
        ```
      </Step>
    </Steps>
  ...
  <Tab title="Step Plan">
    **Best for:** Step Plan reasoning endpoint.
    ...
    <Steps>
      ...
      <Step title="Run onboarding">
        ```bash
        supportClaw onboard --auth-choice stepfun-plan-api-key-intl
        ```

        Or for the China endpoint:

        ```bash
        supportClaw onboard --auth-choice stepfun-plan-api-key-cn
        ```
      </Step>
      <Step title="Non-interactive alternative">
        ```bash
      ...
      <Step title="Verify models are available">
        ```bash
        supportClaw models list --provider stepfun-plan
        ```
      </Step>
    </Steps>
...
<AccordionGroup>
  ...
  <Accordion title="Notes">
    ...
    - Use `supportClaw models list` and `supportClaw models set <provider/model>` to inspect or switch models.

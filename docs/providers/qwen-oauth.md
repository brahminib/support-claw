---
summary: "Use the Qwen Portal provider id with SupportClaw"
read_when:
...
SupportClaw has two Qwen-facing provider ids:
...
supportClaw models set qwen/qwen3-coder-plus
```

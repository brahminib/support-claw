...
<Steps>
  ...
  <Step title="Configure SupportClaw">
    Point SupportClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or SupportClaw
...
<CardGroup cols={2}>
  <Card title="Anthropic provider" href="/providers/anthropic" icon="bolt">
    Native SupportClaw integration with Claude CLI or API keys.
  </Card>

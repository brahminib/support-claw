---
summary: "Use Qianfan's unified API to access many models in SupportClaw"
read_when:
...
```bash
supportClaw plugins install @supportclaw/qianfan-provider
...
<Steps>
  ...
  <Step title="Run onboarding">
    ```bash
    supportClaw onboard --auth-choice qianfan-api-key
    ```
  </Step>
  <Step title="Verify the model is available">
    ```bash
    supportClaw models list --provider qianfan
    ```
  </Step>
</Steps>

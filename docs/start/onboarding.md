---
summary: "First-run setup flow for SupportClaw (macOS app)"
read_when:
...
- By default, SupportClaw is a personal agent: one trusted operator boundary.
...
<Frame caption="Choose what permissions do you want to give SupportClaw">
...
<Step title="CLI">
  ...
  The app can install the global `supportClaw` CLI via npm, pnpm, or bun.

---
summary: "Overview of SupportClaw onboarding options and flows"
read_when:
...
SupportClaw has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `supportClaw onboard`                     | Launch the app            |
...
CLI command docs: [`supportClaw onboard`](/cli/onboard)

## macOS app onboarding

Open the SupportClaw app. The first-run wizard walks you through the same steps

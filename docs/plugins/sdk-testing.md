---
summary: "Testing utilities and patterns for SupportClaw plugins"
...
Reference for test utilities, patterns, and lint enforcement for SupportClaw
plugins.
...
These test-helper subpaths are repo-local source entrypoints for SupportClaw's own
...
**Plugin API mock import:** `supportClaw/plugin-sdk/plugin-test-api`

**Agent runtime contract import:** `supportClaw/plugin-sdk/agent-runtime-test-contracts`

**Channel contract import:** `supportClaw/plugin-sdk/channel-contract-testing`

**Channel test helper import:** `supportClaw/plugin-sdk/channel-test-helpers`

**Channel target test import:** `supportClaw/plugin-sdk/channel-target-testing`

**Plugin contract import:** `supportClaw/plugin-sdk/plugin-test-contracts`

**Plugin runtime test import:** `supportClaw/plugin-sdk/plugin-test-runtime`

**Provider contract import:** `supportClaw/plugin-sdk/provider-test-contracts`

**Provider HTTP mock import:** `supportClaw/plugin-sdk/provider-http-test-mocks`

**Environment/network test import:** `supportClaw/plugin-sdk/test-env`

**Generic fixture import:** `supportClaw/plugin-sdk/test-fixtures`

**Node builtin mock import:** `supportClaw/plugin-sdk/test-node-mocks`

Inside the SupportClaw repo, prefer the focused subpaths below for new bundled
plugin tests. The broad
`supportClaw/plugin-sdk/testing` barrel is legacy compatibility only.
...
} from "supportClaw/plugin-sdk/channel-feedback";
import { installCommonResolveTargetErrorCases } from "supportClaw/plugin-sdk/channel-target-testing";
import { AUTH_PROFILE_RUNTIME_CONTRACT } from "supportClaw/plugin-sdk/agent-runtime-test-contracts";
import { createTestPluginApi } from "supportClaw/plugin-sdk/plugin-test-api";
import { expectChannelInboundContextContract } from "supportClaw/plugin-sdk/channel-contract-testing";
import { createStartAccountContext } from "supportClaw/plugin-sdk/channel-test-helpers";
import { describePluginRegistrationContract } from "supportClaw/plugin-sdk/plugin-test-contracts";
import { registerSingleProviderPlugin } from "supportClaw/plugin-sdk/plugin-test-runtime";
import { describeOpenAIProviderRuntimeContract } from "supportClaw/plugin-sdk/provider-test-contracts";
import { getProviderHttpMocks } from "supportClaw/plugin-sdk/provider-http-test-mocks";
import { withEnv, withFetchPreconnect, withServer } from "supportClaw/plugin-sdk/test-env";
import {
  bundledPluginRoot,
  createCliRuntimeCapture,
  typedCases,
} from "supportClaw/plugin-sdk/test-fixtures";
import { mockNodeBuiltinModule } from "supportClaw/plugin-sdk/test-node-mocks";
```
...
suites that depend on bundled SupportClaw inventory stay under `src/plugins/contracts`.
...
import type { MockFn, PluginRuntime, RuntimeEnv } from "supportClaw/plugin-sdk/plugin-test-runtime";
```
...
SupportClaw's loader acceptance gates. Add at least one loader-backed smoke test
...
Prefer the shared plugin runtime mock from `supportClaw/plugin-sdk/channel-test-helpers`
...
1. **No monolithic root imports** -- `supportClaw/plugin-sdk` root barrel is rejected
...
SupportClaw uses Vitest with V8 coverage thresholds. For plugin tests:

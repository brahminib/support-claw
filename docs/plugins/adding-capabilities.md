---
summary: "Contributor guide for adding a new shared capability to the SupportClaw plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for SupportClaw core developers. If you are
...
Use this when SupportClaw needs a new shared domain such as embeddings, image

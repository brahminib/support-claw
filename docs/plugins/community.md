---
summary: "Find and publish community-maintained SupportClaw plugins"
read_when:
  - You want to find third-party SupportClaw plugins
  - You want to publish or list your own plugin on ClawHub
title: "Community plugins"
doc-schema-version: 1
---

Community plugins are third-party packages that extend SupportClaw with channels,
...
```bash
supportClaw plugins install npm:<package-name>
```

Use [Manage plugins](/plugins/manage-plugins) for common install, update,
inspect, and uninstall examples. Use [`supportClaw plugins`](/cli/plugins) for the
full command reference and source-selection rules.

## Publish plugins

Publish public community plugins on ClawHub when you want SupportClaw users to
...
| Requirement          | Why                                                 |
| -------------------- | --------------------------------------------------- |
| Published on ClawHub | Users need `supportClaw plugins install` hints to work |

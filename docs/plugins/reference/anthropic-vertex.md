---
summary: "SupportClaw Anthropic Vertex provider plugin for Claude models on Google Vertex AI."
read_when:
...
SupportClaw Anthropic Vertex provider plugin for Claude models on Google Vertex AI.

## Distribution

- Package: `@supportclaw/anthropic-vertex-provider`

...
`supportClaw/plugin-sdk/channel-message` and
`supportClaw/plugin-sdk/channel-message-runtime` remain deprecated compatibility
subpaths for older plugins. New channel plugins should use
`supportClaw/plugin-sdk/channel-outbound` for message lifecycle, receipt, durable

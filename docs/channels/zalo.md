...
Zalo ships as a bundled plugin in current SupportClaw releases, so normal packaged
...
- Install via CLI: `supportClaw plugins install @supportclaw/zalo`
- Pinned version: `supportClaw plugins install @supportclaw/zalo@2026.5.2`
- Or from a source checkout: `supportClaw plugins install ./path/to/local/zalo-plugin`
...
This page reflects current SupportClaw behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `supportClaw pairing list zalo`
  - `supportClaw pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in SupportClaw.
...
- Example: `supportClaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `supportClaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `supportClaw logs --follow`

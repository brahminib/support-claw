...
SupportClaw supports [Exa AI](https://exa.ai/) as a `web_search` provider. Exa
...
```bash
supportClaw plugins install @supportclaw/exa-plugin
      ...
      exa: {
        config: {
          webSearch: {
            ...
            baseUrl: "https://api.exa.ai", // optional; SupportClaw appends /search
          },
        },
      },
    },
...
should go through a compatible proxy or alternate Exa endpoint. SupportClaw

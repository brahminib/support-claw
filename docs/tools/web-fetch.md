...
- If `provider` is omitted, SupportClaw auto-detects the first ready web-fetch
...
In this mode, SupportClaw still applies hostname-based SSRF checks before sending

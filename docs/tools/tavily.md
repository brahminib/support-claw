...
[Tavily](https://tavily.com) is a search API designed for AI applications. SupportClaw exposes it in two ways:
...
| --------- | ----------------------------------- |
| Plugin id | `tavily`                            |
| Package   | `@supportclaw/tavily-plugin`           |
...
<Steps>
  <Step title="Install the plugin">
    ```bash
    supportClaw plugins install @supportclaw/tavily-plugin
    ```
  </Step>
...
<Tip>
Choosing Tavily in onboarding or `supportClaw configure --section web` installs and enables the official Tavily plugin when needed.
</Tip>

...
Linux desktop, VNC rescue, Slack Web, a real SupportClaw gateway, screenshots,
...
- Mantis artifacts: owned by the SupportClaw run. They live under
...
- remote logs such as `slack-desktop-command.log`, `supportClaw-gateway.log`,
...
- `crabbox.remote_run`: sync, browser launch, SupportClaw install/build or
...
remote status after Mantis has copied metadata proving that either the SupportClaw

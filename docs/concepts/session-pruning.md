...
SupportClaw also builds a separate idempotent replay view for sessions that
...
SupportClaw auto-enables pruning for Anthropic profiles:
...
If you set explicit values, SupportClaw does not override them.

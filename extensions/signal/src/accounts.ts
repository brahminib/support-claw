...
function mergeSignalAccountConfig(cfg: SupportClawConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: SupportClawConfig): ResolvedSignalAccount[] {

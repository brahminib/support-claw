...
import type { ChannelRuntimeSurface } from "supportClaw/plugin-sdk/channel-contract";
...
import type { SignalReactionNotificationMode } from "supportClaw/plugin-sdk/config-contracts";
import {
  detectMime,

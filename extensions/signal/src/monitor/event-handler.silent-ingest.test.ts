...
vi.mock("supportClaw/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("supportClaw/plugin-sdk/hook-runtime")>(
    "supportClaw/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,

...
import { createChannelApprovalCapability } from "supportClaw/plugin-sdk/approval-delivery-runtime";
import { createLazyChannelApprovalNativeRuntimeAdapter } from "supportClaw/plugin-sdk/approval-handler-adapter-runtime";
import type { ChannelApprovalNativeRuntimeAdapter } from "supportClaw/plugin-sdk/approval-handler-runtime";
import {
...
import { buildApprovalReactionPendingContentForRequest } from "supportClaw/plugin-sdk/approval-reaction-runtime";
import type {
  ExecApprovalRequest,
  PluginApprovalRequest,
} from "supportClaw/plugin-sdk/approval-runtime";
import type {
...
import { parseAgentSessionKey } from "supportClaw/plugin-sdk/routing";
import {
...
type ApprovalForwardingConfig = NonNullable<NonNullable<SupportClawConfig["approvals"]>["exec"]>;

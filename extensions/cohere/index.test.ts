...
import { buildOpenAICompletionsParams } from "supportClaw/plugin-sdk/provider-transport-runtime";
...
function readManifest() {
  return JSON.parse(readFileSync(new URL("./supportClaw.plugin.json", import.meta.url), "utf8")) as {

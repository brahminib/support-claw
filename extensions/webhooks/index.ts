// Webhooks plugin entrypoint registers its SupportClaw integration.
...
function registerWebhookRoutes(api: SupportClawPluginApi): void {
...
export default definePluginEntry({
  ...
  name: "Webhooks",
  description:
    "Authenticated inbound webhooks that bind external automation to SupportClaw TaskFlows.",

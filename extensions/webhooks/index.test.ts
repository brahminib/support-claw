...
function createApi(params?: {
  pluginConfig?: SupportClawPluginApi["pluginConfig"];
  registerHttpRoute?: SupportClawPluginApi["registerHttpRoute"];
  logger?: SupportClawPluginApi["logger"];
  ...
  return createTestPluginApi({
    ...
    logger:
      ...
      ({
        ...
        error: vi.fn(),
        debug: vi.fn(),
      } as SupportClawPluginApi["logger"]),
  });
}
...
function requireFirstRouteRegistration(mock: ReturnType<typeof vi.fn>) {
  ...
  return call[0] as Parameters<SupportClawPluginApi["registerHttpRoute"]>[0];
}
          ...
          routes: {
            zapier: {
              ...
              secret: {
                source: "env",
                provider: "default",
                id: "SUPPORT_CLAW_WEBHOOK_SECRET",
              },
            },
          },
        },

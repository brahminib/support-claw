...
import { buildPluginApprovalResolvedReplyPayload } from "supportClaw/plugin-sdk/approval-runtime";
import type {
  ExecApprovalRequest,
...
// SupportClaw Matrix custom event content for capable clients; body and reactions remain fallback.
const MATRIX_APPROVAL_METADATA_KEY = "com.supportClaw.approval" as const;

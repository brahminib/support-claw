...
import type { OutputRuntimeEnv } from "supportClaw/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "supportClaw/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "SupportClaw Gateway",
    },
    confirm: {

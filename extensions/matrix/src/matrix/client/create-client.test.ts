...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/supportClaw-matrix-create-client-test",
    storagePath: "/tmp/supportClaw-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/supportClaw-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/supportClaw-matrix-create-client-test/idb.snapshot",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "supportClaw-matrix-default-token-hash",

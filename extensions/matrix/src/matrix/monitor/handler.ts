...
import { hasFinalInboundReplyDispatch } from "supportClaw/plugin-sdk/channel-inbound";
import type { ChannelBotLoopProtectionFacts } from "supportClaw/plugin-sdk/channel-inbound";
import {
...
import { isDangerousNameMatchingEnabled } from "supportClaw/plugin-sdk/dangerous-name-runtime";
import {
  isFutureDateTimestampMs,
  resolveExpiresAtMsFromDurationMs,
} from "supportClaw/plugin-sdk/number-runtime";
import { mergePairLoopGuardConfig } from "supportClaw/plugin-sdk/pair-loop-guard-runtime";
import { buildInboundHistoryFromEntries } from "supportClaw/plugin-sdk/reply-history";
import {
  buildTtsSupplementMediaPayload,
  getReplyPayloadTtsSupplement,
} from "supportClaw/plugin-sdk/reply-payload";
import type { GetReplyOptions } from "supportClaw/plugin-sdk/reply-runtime";
...
import { MATRIX_SUPPORT_CLAW_FINALIZED_PREVIEW_KEY } from "../send/types.js";
...
let acpBindingRuntimePromise:
  | Promise<typeof import("supportClaw/plugin-sdk/acp-binding-runtime")>
  | undefined;
let sessionBindingRuntimePromise:
  | Promise<typeof import("supportClaw/plugin-sdk/session-binding-runtime")>
  | undefined;
...
function loadAcpBindingRuntime(): Promise<
  typeof import("supportClaw/plugin-sdk/acp-binding-runtime")
> {
  acpBindingRuntimePromise ??= import("supportClaw/plugin-sdk/acp-binding-runtime");
  return acpBindingRuntimePromise;
}

function loadSessionBindingRuntime(): Promise<
  typeof import("supportClaw/plugin-sdk/session-binding-runtime")
> {
  sessionBindingRuntimePromise ??= import("supportClaw/plugin-sdk/session-binding-runtime");
...
function buildMatrixFinalizedPreviewContent(): Record<string, unknown> {
  return { [MATRIX_SUPPORT_CLAW_FINALIZED_PREVIEW_KEY]: true };
}

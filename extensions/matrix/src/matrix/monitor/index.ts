// Matrix plugin entrypoint registers its SupportClaw integration.
...
import { resolveOptionalIntegerOption } from "supportClaw/plugin-sdk/number-runtime";
import {
...
export type MonitorMatrixOpts = {
  ...
  setStatus?: (next: import("supportClaw/plugin-sdk/channel-contract").ChannelAccountSnapshot) => void;
};

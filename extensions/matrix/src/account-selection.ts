...
import { hasConfiguredSecretInput } from "supportClaw/plugin-sdk/secret-input-runtime";
...
export function resolveMatrixChannelConfig(cfg: SupportClawConfig): Record<string, unknown> | null {

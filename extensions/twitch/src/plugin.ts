/**
 * Twitch channel plugin for SupportClaw.
 *
...
} from "supportClaw/plugin-sdk/channel-pairing";
...
} from "supportClaw/plugin-sdk/extension-shared";
import {
 ...
 * for SupportClaw. Supports message sending, receiving, access control, and
 * status monitoring.
 */
export const twitchPlugin: ChannelPlugin<ResolvedTwitchAccount> =
  createChatChannelPlugin<ResolvedTwitchAccount>({
    ...
    base: {
      ...
      config: {
        listAccountIds: (cfg: SupportClawConfig): string[] => listAccountIds(cfg),
        resolveAccount: (cfg: SupportClawConfig, accountId?: string | null): ResolvedTwitchAccount => {
        ...
        defaultAccountId: (cfg: SupportClawConfig): string => resolveDefaultTwitchAccountId(cfg),
        isConfigured: (_account: unknown, cfg: SupportClawConfig): boolean =>
      ...
      resolver: {
        resolveTargets: async ({
          ...
          runtime: import("supportClaw/plugin-sdk/runtime-env").RuntimeEnv;

...
function applyTokenHubProviderConfig(cfg: SupportClawConfig): SupportClawConfig {
...
export function applyTokenHubConfig(cfg: SupportClawConfig): SupportClawConfig {

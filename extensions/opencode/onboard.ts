...
export function applyOpencodeZenProviderConfig(cfg: SupportClawConfig): SupportClawConfig {
  return {
    ...cfg,
    agents: {
      ...cfg.agents,
...
export function applyOpencodeZenConfig(cfg: SupportClawConfig): SupportClawConfig {

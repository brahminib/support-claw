...
import { extractNonEmptyAssistantText, isLiveTestEnabled } from "supportClaw/plugin-sdk/test-env";
...
const LIVE_MODEL_ID =
  process.env.SUPPORT_CLAW_LIVE_OPENCODE_DEEPSEEK_MODEL?.trim() || "deepseek-v4-flash-free";

 ...
 * SupportClaw agents.
 */
import { buildJsonPluginConfigSchema, definePluginEntry } from "supportClaw/plugin-sdk/plugin-entry";
import {
...
export default definePluginEntry({
  ...
  description: "Supervise Codex app-server sessions from SupportClaw.",

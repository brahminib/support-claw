/**
 * SupportClaw agent-tool definitions for Codex Supervisor endpoint and session
 * controls.
 */
import { jsonResult, readStringParam, type AnyAgentTool } from "supportClaw/plugin-sdk/core";
...
/** Dependencies needed to build SupportClaw agent tools. */
...
/**
 * Creates the SupportClaw tools that expose Codex endpoint health and session
 * controls.
 */
export function createCodexSupervisorTools({
  ...
  return [
    ...
    },
    {
      ...
      description: "List Codex sessions visible to the SupportClaw supervisor.",

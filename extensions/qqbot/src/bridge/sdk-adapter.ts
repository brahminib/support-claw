...
import { parseAccessGroupAllowFromEntry } from "supportClaw/plugin-sdk/access-groups";
import {
  createChannelIngressResolver,
  defineStableChannelIngressIdentity,
} from "supportClaw/plugin-sdk/channel-ingress-runtime";
import { resolveInboundMentionDecision } from "supportClaw/plugin-sdk/channel-mention-gating";
  ...
  return {
    async resolveInboundAccess(input) {
      ...
      const resolved = await createChannelIngressResolver({
        ...
        cfg: input.cfg as SupportClawConfig,
      }).message({

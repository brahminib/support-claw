...
function makeRestrictedCfg(approvers: string[]): SupportClawConfig {
  return {
    channels: {
      qqbot: {
        appId: "app",
...
function makeCommandAuthorizedFallbackCfg(): SupportClawConfig {
  return {
    channels: {
      qqbot: {
        appId: "app",
...
describe("createInteractionHandler approval buttons", () => {
  ...
  ] satisfies Array<[string, SupportClawConfig]>)(

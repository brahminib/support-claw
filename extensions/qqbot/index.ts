// Qqbot plugin entrypoint registers its SupportClaw integration.
import {
...
function registerQQBotFull(api: SupportClawPluginApi): void {
  if (api.registrationMode === "tool-discovery") {
    const registerTools = loadBundledEntryExportSync<(api: SupportClawPluginApi) => void>(
      import.meta.url,
      {

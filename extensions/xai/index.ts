// Xai plugin entrypoint registers its SupportClaw integration.
import { defineSingleProviderPluginEntry } from "supportClaw/plugin-sdk/provider-entry";
import { OPENAI_COMPATIBLE_REPLAY_HOOKS } from "supportClaw/plugin-sdk/provider-model-shared";
import { defaultToolStreamExtraParams } from "supportClaw/plugin-sdk/provider-stream-shared";
import { jsonResult } from "supportClaw/plugin-sdk/provider-web-search";
import {

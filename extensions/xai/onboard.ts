...
>({
  ...
  resolveParams: (_cfg: SupportClawConfig, api) => ({
    providerId: "xai",
    api,
...
function pruneRetiredXaiBuiltinModels(cfg: SupportClawConfig): SupportClawConfig {
...
export function applyXaiProviderConfig(cfg: SupportClawConfig): SupportClawConfig {
...
export function applyXaiConfig(cfg: SupportClawConfig): SupportClawConfig {

...
vi.mock("supportClaw/plugin-sdk/provider-auth-runtime", () => providerAuthRuntimeMocks);
...
type XaiAutoEnableProbe = Parameters<SupportClawPluginApi["registerAutoEnableProbe"]>[0];

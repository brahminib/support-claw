...
import { createLoggedPairingApprovalNotifier } from "supportClaw/plugin-sdk/channel-pairing";
import { createRestrictSendersChannelSecurity } from "supportClaw/plugin-sdk/channel-policy";
import {
...
import { createChannelDirectoryAdapter } from "supportClaw/plugin-sdk/directory-runtime";
import { buildPassiveProbedChannelStatusSummary } from "supportClaw/plugin-sdk/extension-shared";
import {
  type MessagePresentation,
  normalizeMessagePresentation,
  renderMessagePresentationFallbackText,
  resolveMessagePresentationControlValue,
} from "supportClaw/plugin-sdk/interactive-runtime";
import { createLazyRuntimeModule } from "supportClaw/plugin-sdk/lazy-runtime";
import { resolvePayloadMediaUrls, sendTextMediaPayload } from "supportClaw/plugin-sdk/reply-payload";
import { isPrivateNetworkOptInEnabled } from "supportClaw/plugin-sdk/ssrf-runtime";
import {
...
export const mattermostPlugin: ChannelPlugin<ResolvedMattermostAccount> = createChatChannelPlugin({
  ...
  pairing: {
    text: {
      ...
      message: "SupportClaw: your access has been approved.",

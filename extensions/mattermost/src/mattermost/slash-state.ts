 ...
 */
const ACCOUNT_STATES_KEY = Symbol.for("supportClaw.mattermost.slash-account-states");
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("./runtime-api.js").SupportClawConfig;
 ...
 */
export function registerSlashCommandRoute(api: SupportClawPluginApi) {

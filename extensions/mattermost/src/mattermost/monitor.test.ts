...
function evaluateMentionGateForMessage(params: { cfg: SupportClawConfig; threadRootId?: string }) {
...
describe("shouldUpdateMattermostDraftToolProgress", () => {
  type MattermostConfig = NonNullable<NonNullable<SupportClawConfig["channels"]>["mattermost"]>;

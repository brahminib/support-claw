...
vi.mock("supportClaw/plugin-sdk/ssrf-runtime", async () => {
  const original = (await vi.importActual("supportClaw/plugin-sdk/ssrf-runtime")) as Record<
    string,
    unknown
  >;
...
function getDescribedActions(cfg: SupportClawConfig, accountId?: string): string[] {

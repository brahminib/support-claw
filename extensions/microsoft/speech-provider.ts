...
import { isVoiceCompatibleAudio } from "supportClaw/plugin-sdk/media-runtime";
import { assertOkOrThrowProviderError } from "supportClaw/plugin-sdk/provider-http";
import {
  captureHttpExchange,
...
import type {
  ...
  SpeechVoiceOption,
} from "supportClaw/plugin-sdk/speech";
import { asBoolean, asFiniteNumber, asObject, trimToUndefined } from "supportClaw/plugin-sdk/speech";
import {
  fetchWithSsrFGuard,

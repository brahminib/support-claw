/**
 * Persistent lease store for ACPX wrapper processes. Leases let SupportClaw attach
...
export const SUPPORT_CLAW_ACPX_LEASE_ID_ENV = "SUPPORT_CLAW_ACPX_LEASE_ID";
/** Environment variable carrying the owning gateway instance id. */
export const SUPPORT_CLAW_GATEWAY_INSTANCE_ID_ENV = "SUPPORT_CLAW_GATEWAY_INSTANCE_ID";
/** CLI argument carrying the ACPX process lease id for platforms without env wrapping. */
export const SUPPORT_CLAW_ACPX_LEASE_ID_ARG = "--supportClaw-acpx-lease-id";
/** CLI argument carrying the owning gateway instance id. */
export const SUPPORT_CLAW_GATEWAY_INSTANCE_ID_ARG = "--supportClaw-gateway-instance-id";
...
export function withAcpxLeaseEnvironment(params: {
  ...
  return [
    "env",
    `${SUPPORT_CLAW_ACPX_LEASE_ID_ENV}=${quoteEnvValue(params.leaseId)}`,
    `${SUPPORT_CLAW_GATEWAY_INSTANCE_ID_ENV}=${quoteEnvValue(params.gatewayInstanceId)}`,

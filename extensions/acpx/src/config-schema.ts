...
/** Zod schema for validating raw ACPX plugin config from SupportClaw config. */
export const AcpxPluginConfigSchema = z.strictObject({
  ...
  supportClawToolsMcpBridge: z
    .boolean({ error: "supportClawToolsMcpBridge must be a boolean" })
    .optional(),

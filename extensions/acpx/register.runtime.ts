...
import type { SupportClawPluginService, SupportClawPluginServiceContext } from "supportClaw/plugin-sdk/core";
...
type DeferredServiceState = {
  ctx: SupportClawPluginServiceContext | null;
  params: CreateAcpxRuntimeServiceParams;
  realRuntime: AcpRuntime | null;
  realService: SupportClawPluginService | null;
...
async function startRealService(state: DeferredServiceState): Promise<AcpRuntime> {
  ...
  state.startPromise ??= (async () => {
    ...
    await service.start(state.ctx as SupportClawPluginServiceContext);

...
import type { SupportClawPluginService } from "supportClaw/plugin-sdk/core";
import { listDevicePairing } from "supportClaw/plugin-sdk/device-bootstrap";
...
import type { PluginStateKeyedStore } from "supportClaw/plugin-sdk/plugin-state-runtime";
...
async function readNotifyState(api: SupportClawPluginApi): Promise<NotifyStateFile> {
...
async function writeNotifyState(api: SupportClawPluginApi, state: NotifyStateFile): Promise<void> {
  const subscriberStore = openNotifySubscriberStore(api);
...
async function notifyPendingPairingRequests(params: { api: SupportClawPluginApi }): Promise<void> {
...
export function createPairingNotifierService(api: SupportClawPluginApi): SupportClawPluginService {

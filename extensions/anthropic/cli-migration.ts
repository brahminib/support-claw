...
type AgentDefaultsModel = NonNullable<NonNullable<SupportClawConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<SupportClawConfig["agents"]>["defaults"]>["models"];

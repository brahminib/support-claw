...
import { streamSimple } from "supportClaw/plugin-sdk/llm";
import type { ProviderWrapStreamFnContext } from "supportClaw/plugin-sdk/plugin-entry";
import {
...
} from "supportClaw/plugin-sdk/provider-stream-shared";
...
const SUPPORT_CLAW_DEFAULT_ANTHROPIC_BETAS = [
  "fine-grained-tool-streaming-2025-05-14",
  "interleaved-thinking-2025-05-14",
] as const;
const SUPPORT_CLAW_OAUTH_ANTHROPIC_BETAS = [
  "claude-code-20250219",
  "oauth-2025-04-20",
  ...SUPPORT_CLAW_DEFAULT_ANTHROPIC_BETAS,
] as const;
...
/** Wrap a stream function to merge SupportClaw and configured Anthropic beta headers. */
export function createAnthropicBetaHeadersWrapper(
  ...
  return (model, context, options) => {
    ...
    const supportClawBetas = isOauth
      ? (SUPPORT_CLAW_OAUTH_ANTHROPIC_BETAS as readonly string[])
      : (SUPPORT_CLAW_DEFAULT_ANTHROPIC_BETAS as readonly string[]);
    const allBetas = [...new Set([...supportClawBetas, ...effectiveBetas])];

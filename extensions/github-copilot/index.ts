// Github Copilot plugin entrypoint registers its SupportClaw integration.
...
import { getCachedLiveCatalogValue } from "supportClaw/plugin-sdk/provider-catalog-shared";
...
function applyCopilotDefaultModel(cfg: SupportClawConfig): SupportClawConfig {
...
export default definePluginEntry({
  ...
  register(api) {
    ...
    function resolveCurrentPluginConfig(config?: SupportClawConfig): GithubCopilotPluginConfig {

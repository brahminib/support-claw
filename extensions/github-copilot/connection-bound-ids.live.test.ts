...
import { stream as streamModel, type AssistantMessage, type Model } from "supportClaw/plugin-sdk/llm";
...
const ENV_GITHUB_TOKEN =
  process.env.SUPPORT_CLAW_LIVE_GITHUB_COPILOT_TOKEN ??
  process.env.COPILOT_GITHUB_TOKEN ??
  process.env.GH_TOKEN ??
  process.env.GITHUB_TOKEN ??
  "";
const LIVE_MODEL_ID = process.env.SUPPORT_CLAW_LIVE_GITHUB_COPILOT_MODEL?.trim() || "gpt-5.4";

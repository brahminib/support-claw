...
import { buildCopilotIdeHeaders, COPILOT_INTEGRATION_ID } from "supportClaw/plugin-sdk/provider-auth";
import { readProviderJsonArrayFieldResponse } from "supportClaw/plugin-sdk/provider-http";
...
export function resolveCopilotForwardCompatModel(
  ...
  // by simply adding them to agents.defaults.models in supportClaw.json — no

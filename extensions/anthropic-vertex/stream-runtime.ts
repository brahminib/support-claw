 ...
 * SupportClaw stream options for the shared Anthropic Messages transport.
 */
...
/**
 * Create a StreamFn that routes through SupportClaw's generic model stream with an

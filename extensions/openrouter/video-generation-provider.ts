...
import { isRecord, normalizeOptionalString } from "supportClaw/plugin-sdk/string-coerce-runtime";
import type {
  GeneratedVideoAsset,
  VideoGenerationProvider,
  VideoGenerationRequest,
  VideoGenerationSourceAsset,
} from "supportClaw/plugin-sdk/video-generation";
...
const SUPPORTED_DURATIONS_HINT = Symbol.for("supportClaw.videoGeneration.supportedDurations");

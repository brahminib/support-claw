...
import { expectExplicitMusicGenerationCapabilities } from "supportClaw/plugin-sdk/provider-test-contracts";
...
vi.mock("supportClaw/plugin-sdk/provider-http", async (importOriginal) => {
  const original = await importOriginal<typeof import("supportClaw/plugin-sdk/provider-http")>();
  return {
    ...original,

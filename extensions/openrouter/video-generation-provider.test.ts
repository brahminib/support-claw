...
import { clearLiveCatalogCacheForTests } from "supportClaw/plugin-sdk/provider-catalog-shared";
import {
...
vi.mock("supportClaw/plugin-sdk/provider-http", async () => {
  const actual = await vi.importActual<typeof import("supportClaw/plugin-sdk/provider-http")>(
    "supportClaw/plugin-sdk/provider-http",
  );
  return {
    ...actual,

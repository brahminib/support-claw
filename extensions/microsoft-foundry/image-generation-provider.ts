...
import type { ProviderRuntimeModel } from "supportClaw/plugin-sdk/core";
import type {
...
type ModelProviderConfig = NonNullable<NonNullable<SupportClawConfig["models"]>["providers"]>[string];

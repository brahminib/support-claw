...
function resolveGoogleChatAccountImpl(params: { cfg: SupportClawConfig; accountId?: string | null }) {
...
vi.mock("./channel.deps.runtime.js", () => {
  return {
    ...
    listGoogleChatAccountIds: (cfg: SupportClawConfig) => {
...
function createGoogleChatCfg(): SupportClawConfig {
  return {
    channels: {
      googlechat: {
        enabled: true,

...
import { recordChannelBotPairLoopAndCheckSuppression } from "supportClaw/plugin-sdk/channel-inbound";
...
function createInboundClassificationHarness() {
  ...
  const core = {
    ...
    channel: {
      ...
      session: {
        resolveStorePath: () => "/tmp/supportClaw-googlechat-test",

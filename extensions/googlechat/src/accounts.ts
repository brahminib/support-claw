...
import { safeParseJsonWithSchema, safeParseWithSchema } from "supportClaw/plugin-sdk/extension-shared";
import { mergePairLoopGuardConfig } from "supportClaw/plugin-sdk/pair-loop-guard-runtime";
import { isSecretRef } from "supportClaw/plugin-sdk/secret-input";
...
export function listEnabledGoogleChatAccounts(cfg: SupportClawConfig): ResolvedGoogleChatAccount[] {

...
vi.mock("supportClaw/plugin-sdk/media-understanding", async () => {
  const actual = await vi.importActual<typeof import("supportClaw/plugin-sdk/media-understanding")>(
    "supportClaw/plugin-sdk/media-understanding",
  );
  return {
    ...actual,
...
afterAll(() => {
  vi.doUnmock("supportClaw/plugin-sdk/media-understanding");
  vi.resetModules();
});

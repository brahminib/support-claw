...
import { resolveChannelStreamingBlockEnabled } from "supportClaw/plugin-sdk/channel-outbound";
import { resolveNativeCommandSessionTargets } from "supportClaw/plugin-sdk/command-auth-native";
import {
...
import type { ChannelGroupPolicy } from "supportClaw/plugin-sdk/config-contracts";
import type {
  ReplyToMode,
...
import { resolveMarkdownTableMode } from "supportClaw/plugin-sdk/markdown-table-runtime";
import { resolveSendableOutboundReplyParts } from "supportClaw/plugin-sdk/reply-payload";
import { resolveAgentRoute } from "supportClaw/plugin-sdk/routing";
import { getRuntimeConfigSnapshot } from "supportClaw/plugin-sdk/runtime-config-snapshot";
import { danger, logVerbose } from "supportClaw/plugin-sdk/runtime-env";
...
type TelegramChunkMode = ReturnType<
  typeof import("supportClaw/plugin-sdk/reply-dispatch-runtime").resolveChunkMode
>;
type TelegramNativeReplyPayload = import("supportClaw/plugin-sdk/reply-dispatch-runtime").ReplyPayload;
...
export const registerTelegramNativeCommands = ({
  ...
  const loadFreshRuntimeConfig = (): SupportClawConfig => telegramDeps.getRuntimeConfig();
  const resolveFreshTelegramConfig = (runtimeCfg: SupportClawConfig): TelegramAccountConfig => {
    try {

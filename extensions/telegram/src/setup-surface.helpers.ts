...
export function shouldShowTelegramDmAccessWarning(cfg: SupportClawConfig, accountId: string): boolean {
...
export function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`supportClaw config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`supportClaw config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),

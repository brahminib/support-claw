...
import { resolveAgentMaxConcurrent } from "supportClaw/plugin-sdk/model-session-runtime";
...
export function createTelegramRunnerOptions(cfg: SupportClawConfig): RunOptions<unknown> {
  return {
    sink: {

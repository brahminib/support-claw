...
import { resolveApprovalRequestChannelAccountId } from "supportClaw/plugin-sdk/approval-native-runtime";
import type {
  ExecApprovalRequest,
...
import type { TelegramExecApprovalConfig } from "supportClaw/plugin-sdk/config-contracts";
import type { ReplyPayload } from "supportClaw/plugin-sdk/reply-runtime";
import { normalizeAccountId } from "supportClaw/plugin-sdk/routing";
import {
...
function resolveTelegramOwnerApprovers(cfg: SupportClawConfig): Array<string | number> {

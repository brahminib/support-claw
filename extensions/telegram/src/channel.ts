...
import type { ChannelMessageActionAdapter } from "supportClaw/plugin-sdk/channel-contract";
import {
...
import { createAccountStatusSink } from "supportClaw/plugin-sdk/channel-outbound";
...
import type { RoutePeer } from "supportClaw/plugin-sdk/routing";
import {
...
const telegramMessageAdapter = createChannelMessageAdapterFromOutbound<SupportClawConfig>({
  id: "telegram",
  live: {
    capabilities: {
      draftPreview: true,
...
function resolveTelegramNativeTopicThreadId(
  ...
  // Keep the chat-scoped canonical id inside SupportClaw state; translate it back
  ...
  base: {
    ...
    gateway: {
      ...
      logoutAccount: async ({ accountId, cfg }) => {
        ...
        const nextCfg = { ...cfg } as SupportClawConfig;

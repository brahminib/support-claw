...
import { parseExecApprovalCommandText } from "supportClaw/plugin-sdk/approval-reply-runtime";
import { resolveChannelConfigWrites } from "supportClaw/plugin-sdk/channel-config-helpers";
import {
  buildMentionRegexes,
...
} from "supportClaw/plugin-sdk/channel-inbound-debounce";
import { resolveStoredModelOverride } from "supportClaw/plugin-sdk/command-auth-native";
import { hasControlCommand } from "supportClaw/plugin-sdk/command-detection";
import { isAbortRequestText } from "supportClaw/plugin-sdk/command-primitives-runtime";
import { buildCommandsMessagePaginated } from "supportClaw/plugin-sdk/command-status";
import type { DmPolicy, SupportClawConfig } from "supportClaw/plugin-sdk/config-contracts";
import type {
  TelegramGroupConfig,
  TelegramTopicConfig,
} from "supportClaw/plugin-sdk/config-contracts";
import { mutateConfigFile } from "supportClaw/plugin-sdk/config-mutation";
import { resolveChannelContextVisibilityMode } from "supportClaw/plugin-sdk/context-visibility-runtime";
import {
...
import { applyModelOverrideToSessionEntry } from "supportClaw/plugin-sdk/model-session-runtime";
import { formatModelsAvailableHeader } from "supportClaw/plugin-sdk/models-provider-runtime";
import { parseStrictPositiveInteger } from "supportClaw/plugin-sdk/number-runtime";
import { resolveAgentRoute } from "supportClaw/plugin-sdk/routing";
import { resolveThreadSessionKeys } from "supportClaw/plugin-sdk/routing";
import { danger, logVerbose, warn } from "supportClaw/plugin-sdk/runtime-env";
import { evaluateSupplementalContextVisibility } from "supportClaw/plugin-sdk/security-runtime";
import {
  getSessionEntry,
  listSessionEntries,
  patchSessionEntry,
        ...
        if (modelCallback.type === "select") {
          ...
          try {
            ...
            const scopeText = isDefaultSelection
              ...
              : `Session-only model selection. Runtime unchanged. Use /model ${escapeHtml(selection.provider)}/${escapeHtml(selection.model)} --runtime &lt;runtime&gt; to switch harnesses. The agent default in supportClaw.json is unchanged; /reset or a new session may return to that default.`;
            await editMessageWithButtons(
              `✅ Model ${actionText}\n\n${scopeText}`,

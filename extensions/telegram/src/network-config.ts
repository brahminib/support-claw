...
import { isTruthyEnvValue, isWSL2Sync } from "supportClaw/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "supportClaw/plugin-sdk/string-coerce-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "SUPPORT_CLAW_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "SUPPORT_CLAW_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "SUPPORT_CLAW_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable SUPPORT_CLAW_TELEGRAM_DNS_RESULT_ORDER

...
import { resolveNormalizedAccountEntry } from "supportClaw/plugin-sdk/account-core";
...
import { createChannelPluginBase, type ChannelPlugin } from "supportClaw/plugin-sdk/channel-core";
import { getChatChannelMeta } from "supportClaw/plugin-sdk/channel-plugin-common";
import type { SupportClawConfig, TelegramAccountConfig } from "supportClaw/plugin-sdk/config-contracts";
 ...
 *
 * See: https://github.com/brahminib/support-claw/issues/53876
 */
function isBlockedByMultiBotGuard(cfg: SupportClawConfig, accountId: string): boolean {

...
import type { MessagePresentation } from "supportClaw/plugin-sdk/interactive-runtime";
...
function resolveActionTopicNameCacheScope(cfg: SupportClawConfig, accountId?: string | null): string {

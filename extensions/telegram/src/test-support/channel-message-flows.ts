...
import { formatChannelProgressDraftText } from "supportClaw/plugin-sdk/channel-outbound";
...
function createTelegramFlowApi(params: { accountId?: string; cfg: SupportClawConfig }): Bot["api"] {
  const api = {
    raw: {

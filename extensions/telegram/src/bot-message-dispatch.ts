...
import { CURRENT_MESSAGE_MARKER } from "supportClaw/plugin-sdk/channel-mention-gating";
import {
...
import type { BlockReplyContext } from "supportClaw/plugin-sdk/reply-runtime";
...
async function resolveStickerVisionSupport(cfg: SupportClawConfig, agentId: string) {
  try {

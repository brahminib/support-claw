...
import { resolveApiKeyForProvider } from "supportClaw/plugin-sdk/agent-runtime";
import type { ModelCatalogEntry } from "supportClaw/plugin-sdk/agent-runtime";
import {
  findModelInCatalog,
  loadModelCatalog,
  modelSupportsVision,
} from "supportClaw/plugin-sdk/agent-runtime";
import { resolveDefaultModelForAgent } from "supportClaw/plugin-sdk/agent-runtime";
import type { SupportClawConfig } from "supportClaw/plugin-sdk/config-contracts";
import { resolveAutoImageModel } from "supportClaw/plugin-sdk/media-runtime";
import {

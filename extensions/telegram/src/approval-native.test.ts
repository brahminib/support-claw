...
function buildConfig(
  overrides?: Partial<NonNullable<NonNullable<SupportClawConfig["channels"]>["telegram"]>>,
): SupportClawConfig {
  return {
    channels: {
      telegram: {
...
const STORE_PATH = path.join(os.tmpdir(), "supportClaw-telegram-approval-native-test.json");

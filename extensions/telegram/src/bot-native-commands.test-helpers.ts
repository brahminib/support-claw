...
vi.mock("supportClaw/plugin-sdk/plugin-runtime", () => ({
...
vi.mock("supportClaw/plugin-sdk/reply-dispatch-runtime", () => ({
...
export function createNativeCommandsHarness(params?: {
  ...
  const telegramDeps = {
    getRuntimeConfig: vi.fn(() => params?.cfg ?? ({} as SupportClawConfig)),

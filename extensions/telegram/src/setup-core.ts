...
import type { ChannelSetupAdapter } from "supportClaw/plugin-sdk/setup-runtime";
import {
...
export function getTelegramTokenHelpLines(): string[] {
  return [
    ...
    t("wizard.telegram.website", { url: "https://supportClaw.ai" }),
  ];
}
...
export function getTelegramUserIdHelpLines(): string[] {
  return [
    t("wizard.telegram.userIdHelpLogs", {
      command: formatCliCommand("supportClaw logs --follow"),
    }),

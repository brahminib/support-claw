...
import type { MarkdownTableMode } from "supportClaw/plugin-sdk/config-contracts";
import { isDiagnosticFlagEnabled } from "supportClaw/plugin-sdk/diagnostic-runtime";
import { formatUncaughtError } from "supportClaw/plugin-sdk/error-runtime";
import { redactSensitiveText } from "supportClaw/plugin-sdk/logging-core";
import { parseStrictInteger } from "supportClaw/plugin-sdk/number-runtime";
import { resolveChunkMode, resolveTextChunkLimit } from "supportClaw/plugin-sdk/reply-chunking";
import { createTelegramRetryRunner, type RetryConfig } from "supportClaw/plugin-sdk/retry-runtime";
...
function createTelegramHttpLogger(cfg: SupportClawConfig) {

...
import { resolveAccountWithDefaultFallback } from "supportClaw/plugin-sdk/account-core";
import { tryReadSecretFileSync } from "supportClaw/plugin-sdk/channel-core";
import type { SupportClawConfig } from "supportClaw/plugin-sdk/config-contracts";
import type { TelegramAccountConfig } from "supportClaw/plugin-sdk/config-contracts";
import { resolveDefaultSecretProviderAlias } from "supportClaw/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "supportClaw/plugin-sdk/routing";
import {
  hasConfiguredSecretInput,
  normalizeSecretInputString,
} from "supportClaw/plugin-sdk/secret-input";
import { coerceSecretRef } from "supportClaw/plugin-sdk/secret-input-runtime";
import { FsSafeError } from "supportClaw/plugin-sdk/security-runtime";
...
function inspectTokenValue(params: { cfg: SupportClawConfig; value: unknown }): {
  token: string;
...
function hasConfiguredTelegramAccounts(cfg: SupportClawConfig): boolean {

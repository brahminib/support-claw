...
import { parseFiniteNumber } from "supportClaw/plugin-sdk/number-runtime";
...
function resolveDefaultDbPath(): string {
  const home = homedir();
  const preferred = join(home, ".supportClaw", "memory", "lancedb");
  try {
...
export const memoryConfigSchema = {
  ...
  uiHints: {
    ...
    dbPath: {
      label: "Database Path",
      placeholder: "~/.supportClaw/memory/lancedb",
      advanced: true,

/**
 * Converts authorized ClickClack messages into SupportClaw agent/model replies and
...
export async function handleClickClackInbound(params: {
  ...
  const body = runtime.channel.reply.formatAgentEnvelope({
    ...
    previousTimestamp,
    envelope: runtime.channel.reply.resolveEnvelopeFormatOptions(params.config as SupportClawConfig),
    body: message.body,
  });

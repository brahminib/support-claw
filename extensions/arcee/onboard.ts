...
export function applyArceeConfig(cfg: SupportClawConfig): SupportClawConfig {
  return arceePresetAppliers.applyConfig(cfg);
}

/** Apply OpenRouter-backed Arcee provider defaults to config. */
export function applyArceeOpenRouterConfig(cfg: SupportClawConfig): SupportClawConfig {

import { createWebSearchProviderContractFields } from "supportClaw/plugin-sdk/provider-web-search-contract";
...
export function createParallelWebSearchProviderBase() {
  return {
    ...
    docsUrl: "https://docs.supportClaw.ai/tools/parallel-search",
    autoDetectOrder: 75,

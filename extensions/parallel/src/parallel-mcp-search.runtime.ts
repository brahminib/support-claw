...
import { withTrustedWebSearchEndpoint } from "supportClaw/plugin-sdk/provider-web-search";
...
// without this, undici sends a generic `node` UA and SupportClaw usage is only
  ...
  const init = await postMcp({
    ...
    body: {
      ...
      params: {
        ...
        capabilities: {},
        clientInfo: { name: "supportClaw-parallel", version: PLUGIN_VERSION },
      },
    },
  });
  if (!init.ok) {

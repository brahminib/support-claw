  ...
  it(
    ...
    async () => {
      ...
      const result = (await tool.execute({
        objective:
          "Find the SupportClaw GitHub repository and recent project activity for a quick smoke test.",
        search_queries: ["supportClaw github repository", "supportClaw release notes"],
        count: 3,

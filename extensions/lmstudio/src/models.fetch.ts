...
import { SELF_HOSTED_DEFAULT_COST } from "supportClaw/plugin-sdk/provider-setup";
...
/** Discovers LLM models from LM Studio and maps them to SupportClaw model definitions. */

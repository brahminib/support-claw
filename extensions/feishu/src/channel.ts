...
import { describeAccountSnapshot } from "supportClaw/plugin-sdk/account-helpers";
import { formatAllowFromLowercase } from "supportClaw/plugin-sdk/allow-from";
import {
...
import { createChatChannelPlugin } from "supportClaw/plugin-sdk/channel-core";
import {
...
import { getSessionBindingService } from "supportClaw/plugin-sdk/conversation-runtime";
import {
  createChannelDirectoryAdapter,
  createRuntimeDirectoryLiveAdapter,
} from "supportClaw/plugin-sdk/directory-runtime";
import { normalizeMessagePresentation } from "supportClaw/plugin-sdk/interactive-runtime";
...
import { createComputedAccountStatusAdapter } from "supportClaw/plugin-sdk/status-helpers";
...
export const feishuPlugin: ChannelPlugin<ResolvedFeishuAccount, FeishuProbeResult> =
  createChatChannelPlugin({
    base: {
      ...
      auth: {
        login: async ({ cfg }) => {
          const { createClackPrompter } = await import("supportClaw/plugin-sdk/setup-runtime");
          const { replaceConfigFile } = await import("supportClaw/plugin-sdk/config-mutation");

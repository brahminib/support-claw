...
import type { SupportClawPluginApi, PluginRuntime } from "../runtime-api.js";
...
function createWikiToolApi(registerTool: SupportClawPluginApi["registerTool"]): SupportClawPluginApi {

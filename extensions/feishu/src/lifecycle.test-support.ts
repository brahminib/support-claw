...
vi.mock("./client.js", () => {
  return {
    FEISHU_HTTP_TIMEOUT_ENV_VAR: "SUPPORT_CLAW_FEISHU_HTTP_TIMEOUT_MS",
    FEISHU_HTTP_TIMEOUT_MAX_MS: 300_000,
    FEISHU_HTTP_TIMEOUT_MS: 30_000,
    FEISHU_USER_AGENT: "supportClaw-feishu-test",
    ...
    getFeishuUserAgent: vi.fn(() => "supportClaw-feishu-test"),
    pluginVersion: "test",

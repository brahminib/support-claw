...
import type { PluginDoctorStateMigration } from "supportClaw/plugin-sdk/runtime-doctor";
...
function readConfiguredPluginConfig(config: SupportClawConfig): MemoryWikiPluginConfig | undefined {

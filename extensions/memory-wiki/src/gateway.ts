...
import { resolveDefaultAgentId } from "supportClaw/plugin-sdk/memory-host-core";
import { readPositiveIntegerParam } from "supportClaw/plugin-sdk/param-readers";
import type { SupportClawConfig, SupportClawPluginApi } from "../api.js";
...
type GatewayMethodContext = Parameters<
  Parameters<SupportClawPluginApi["registerGatewayMethod"]>[1]
>[0];
...
function resolveGatewayAgentId(
  ...
  appConfig: SupportClawConfig | undefined,
): string | undefined {
  return (

...
import { mapPluginConfigIssues } from "supportClaw/plugin-sdk/extension-shared";
import { buildPluginConfigSchema, z, type SupportClawPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: SupportClawPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".supportClaw", "wiki", "main");
}

...
export const WIKI_RELATED_START_MARKER = "<!-- supportClaw:wiki:related:start -->";
export const WIKI_RELATED_END_MARKER = "<!-- supportClaw:wiki:related:end -->";
export const WIKI_RAW_SOURCE_MARKER = "<!-- supportClaw:wiki:raw-source -->";
...
const HUMAN_START_MARKER = "<!-- supportClaw:human:start -->";
const HUMAN_END_MARKER = "<!-- supportClaw:human:end -->";

...
import { readFiniteNumberParam } from "supportClaw/plugin-sdk/param-readers";
...
const GENERATED_START = "<!-- supportClaw:wiki:generated:start -->";
const GENERATED_END = "<!-- supportClaw:wiki:generated:end -->";
const HUMAN_START = "<!-- supportClaw:human:start -->";
const HUMAN_END = "<!-- supportClaw:human:end -->";

...
import { FsSafeError, root as fsRoot } from "supportClaw/plugin-sdk/security-runtime";
...
// `path-mismatch` (see @supportclaw/fs-safe opened-realpath): the file we opened is

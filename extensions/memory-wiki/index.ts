// Memory Wiki plugin entrypoint registers its SupportClaw integration.
...
export default definePluginEntry({
  id: "memory-wiki",
  name: "Memory Wiki",
  description: "Persistent wiki compiler and Obsidian-friendly knowledge vault for SupportClaw.",

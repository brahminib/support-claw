...
import { sleep } from "supportClaw/plugin-sdk/text-utility-runtime";
...
vi.mock("supportClaw/plugin-sdk/text-utility-runtime", async () => {
  const actual = await vi.importActual<typeof import("supportClaw/plugin-sdk/text-utility-runtime")>(
    "supportClaw/plugin-sdk/text-utility-runtime",
  );
  return {
    ...actual,
    sleep: vi.fn(async () => {}),

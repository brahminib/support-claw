...
import type { AckReactionHandle } from "supportClaw/plugin-sdk/channel-feedback";
import type { SupportClawConfig } from "supportClaw/plugin-sdk/config-contracts";
import {
  ensureConfiguredBindingRouteReady,
  resolveConfiguredBindingRoute,
} from "supportClaw/plugin-sdk/conversation-binding-runtime";
import type { getReplyFromConfig } from "supportClaw/plugin-sdk/reply-runtime";
...
import { buildGroupHistoryKey } from "supportClaw/plugin-sdk/routing";
...
export function createWebOnMessageHandler(params: {
  ...
  replyLogger: ReturnType<(typeof import("supportClaw/plugin-sdk/runtime-env"))["getChildLogger"]>;

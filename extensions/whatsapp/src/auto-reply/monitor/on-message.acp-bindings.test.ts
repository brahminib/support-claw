...
import type { ConfiguredBindingRouteResult } from "supportClaw/plugin-sdk/conversation-binding-runtime";
...
vi.mock("supportClaw/plugin-sdk/conversation-binding-runtime", () => ({
...
vi.mock("supportClaw/plugin-sdk/routing", async (importOriginal) => {
  const actual = await importOriginal<typeof import("supportClaw/plugin-sdk/routing")>();
  return {
    ...actual,

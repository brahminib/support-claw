...
import { sendTextMediaPayload } from "supportClaw/plugin-sdk/reply-payload";
import {
...
function resolveQuoteLookupAccountId(cfg?: SupportClawConfig, accountId?: string | null): string {

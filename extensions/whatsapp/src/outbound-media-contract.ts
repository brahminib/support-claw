...
import { MEDIA_FFMPEG_MAX_AUDIO_DURATION_SECS, runFfmpeg } from "supportClaw/plugin-sdk/media-runtime";
...
async function transcodeToWhatsAppVoiceOpus(params: {
  ...
  return await withTempWorkspace(
    { rootDir: resolvePreferredSupportClawTmpDir(), prefix: "whatsapp-voice-" },
    async (workspace) => {

...
export { getChatChannelMeta, type ChannelPlugin } from "supportClaw/plugin-sdk/core";
...
export { normalizeE164 } from "supportClaw/plugin-sdk/account-resolution";
export type { DmPolicy, GroupPolicy } from "supportClaw/plugin-sdk/config-contracts";
import type { SupportClawConfig as RuntimeSupportClawConfig } from "supportClaw/plugin-sdk/config-contracts";

export { type ChannelMessageActionName } from "supportClaw/plugin-sdk/channel-contract";
...
export type SupportClawConfig = RuntimeSupportClawConfig;

...
import { clamp } from "supportClaw/plugin-sdk/text-utility-runtime";
...
export function resolveHeartbeatSeconds(cfg: SupportClawConfig, overrideSeconds?: number): number {

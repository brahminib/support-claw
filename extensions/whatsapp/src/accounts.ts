...
import type { DmPolicy, GroupPolicy, ReplyToMode } from "supportClaw/plugin-sdk/config-contracts";
import { resolveOAuthDir } from "supportClaw/plugin-sdk/state-paths";
...
export function listWhatsAppAuthDirs(cfg: SupportClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: SupportClawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: SupportClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: SupportClawConfig): ResolvedWhatsAppAccount[] {

// Diagnostics Prometheus plugin entrypoint registers its SupportClaw integration.
...
export default definePluginEntry({
  ...
  description: "Expose SupportClaw diagnostics metrics in Prometheus text format",
  register(api) {

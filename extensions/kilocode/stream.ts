...
import { resolveProviderRequestHeaders } from "supportClaw/plugin-sdk/provider-http";
import { normalizeOpenAICompatibleReasoningPayload } from "supportClaw/plugin-sdk/provider-stream-shared";
import { normalizeOptionalLowercaseString } from "supportClaw/plugin-sdk/string-coerce-runtime";

const KILOCODE_FEATURE_HEADER = "X-KILOCODE-FEATURE";
const KILOCODE_FEATURE_DEFAULT = "supportClaw";

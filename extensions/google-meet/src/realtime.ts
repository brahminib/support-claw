...
} from "supportClaw/plugin-sdk/realtime-transcription";
import {
...
import {
  consultSupportClawAgentForGoogleMeet,
...
export function buildGoogleMeetSpeakExactUserMessage(text: string): string {
  return [
    "Speak this exact SupportClaw answer to the meeting, without adding, removing, or rephrasing words.",

// Google Meet plugin entrypoint registers its SupportClaw integration.
import {
...
} from "supportClaw/plugin-sdk/gateway-runtime";
...
const googleMeetConfigSchema = {
  ...
  uiHints: {
    ...
    defaultMode: {
      label: "Default Mode",
      help: "Agent uses realtime transcription plus regular SupportClaw TTS. Bidi uses the realtime voice model directly. Transcribe observes only.",
    },
    "chrome.audioBackend": {
    ...
    "chrome.autoJoin": {
      ...
      help: "Best-effort guest-name fill and Join Now click through SupportClaw browser automation.",
    },
    ...
    "realtime.transcriptionProvider": {
      ...
      help: "Agent mode uses this provider to transcribe meeting audio before regular SupportClaw TTS answers.",
    },
    ...
    "realtime.model": {
      ...
      help: "Only used by mode=bidi. Agent mode answers with the configured SupportClaw agent and regular TTS.",
      advanced: true,
    },
    ...
    "realtime.agentId": {
      ...
      help: 'SupportClaw agent id used by supportClaw_agent_consult. Defaults to "main".',
      advanced: true,
    },
    "realtime.toolPolicy": {

...
} from "supportClaw/plugin-sdk/agent-harness";
import { createTokenjuiceSupportClawEmbeddedExtension } from "./runtime-api.js";

type TokenjuiceToolResultHandler = (
  event: {
    toolName: string;
    input: Record<string, unknown>;
    content: SupportClawAgentToolResult["content"];
    details: unknown;
    isError?: boolean;
  },
  ctx: { cwd: string },
) => Promise<Partial<SupportClawAgentToolResult> | void> | Partial<SupportClawAgentToolResult> | void;
...
function readTextContent(content: SupportClawAgentToolResult["content"]): string {
...
function normalizeDetails(
  event: AgentToolResultMiddlewareEvent,
  current: SupportClawAgentToolResult,
): unknown {

...
export function applyNvidiaProviderConfig(cfg: SupportClawConfig): SupportClawConfig {
  return nvidiaPresetAppliers.applyProviderConfig(cfg);
}

export function applyNvidiaConfig(cfg: SupportClawConfig): SupportClawConfig {

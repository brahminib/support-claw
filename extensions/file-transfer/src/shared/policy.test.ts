...
// without touching ~/.supportClaw/supportClaw.json.
...
vi.mock("supportClaw/plugin-sdk/config-mutation", () => ({
...
afterAll(() => {
  vi.doUnmock("supportClaw/plugin-sdk/runtime-config-snapshot");
  vi.doUnmock("supportClaw/plugin-sdk/config-mutation");
  vi.resetModules();
});

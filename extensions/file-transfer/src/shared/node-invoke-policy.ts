...
import { readPositiveIntegerParam } from "supportClaw/plugin-sdk/param-readers";
import type {
  SupportClawPluginNodeInvokePolicy,
  SupportClawPluginNodeInvokePolicyContext,
  SupportClawPluginNodeInvokePolicyResult,
...
}): Promise<SupportClawPluginNodeInvokePolicyResult | null> {
  const nodeDisplayName = input.ctx.node?.displayName;
  const missingCode =
...
type PreflightResult =
  ...
  | {
      ok: false;
      result: SupportClawPluginNodeInvokePolicyResult;
    };
...
async function handleFileTransferInvoke(
  ctx: SupportClawPluginNodeInvokePolicyContext,
): Promise<SupportClawPluginNodeInvokePolicyResult> {
...
export function createFileTransferNodeInvokePolicy(): SupportClawPluginNodeInvokePolicy {
  return {

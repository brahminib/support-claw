// File Transfer plugin entrypoint registers its SupportClaw integration.
import {
  definePluginEntry,
  type AnyAgentTool,
  type SupportClawPluginNodeHostCommand,
...
const fileTransferNodeHostCommands: SupportClawPluginNodeHostCommand[] = [
  {
    command: "file.fetch",
    cap: "file",
    dangerous: true,

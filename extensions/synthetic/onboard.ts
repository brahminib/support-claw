...
export function applySyntheticProviderConfig(cfg: SupportClawConfig): SupportClawConfig {
  return syntheticPresetAppliers.applyProviderConfig(cfg);
}

export function applySyntheticConfig(cfg: SupportClawConfig): SupportClawConfig {

...
import type { ChannelSetupAdapter, SupportClawConfig } from "supportClaw/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "supportClaw/plugin-sdk/setup";
...
export function isLineConfigured(cfg: SupportClawConfig, accountId: string): boolean {

...
vi.mock("supportClaw/plugin-sdk/plugin-config-runtime", () => ({
...
vi.mock("supportClaw/plugin-sdk/channel-activity-runtime", () => ({
...
describe("LINE send helpers", () => {
  ...
  afterAll(() => {
    ...
    vi.doUnmock("supportClaw/plugin-sdk/channel-activity-runtime");

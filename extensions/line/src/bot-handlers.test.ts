...
vi.mock("supportClaw/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
  matchesMentionPatterns: () => false,
}));
vi.mock("supportClaw/plugin-sdk/channel-pairing", () => ({
...
vi.mock("supportClaw/plugin-sdk/command-auth-native", () => ({
...
vi.mock("supportClaw/plugin-sdk/runtime-group-policy", () => ({
...
vi.mock("supportClaw/plugin-sdk/reply-history", () => ({
...
vi.mock("supportClaw/plugin-sdk/routing", () => ({
...
describe("handleLineWebhookEvents", () => {
  ...
  afterAll(() => {
    vi.doUnmock("supportClaw/plugin-sdk/channel-inbound");
    vi.doUnmock("supportClaw/plugin-sdk/channel-pairing");
    vi.doUnmock("supportClaw/plugin-sdk/command-auth-native");
    vi.doUnmock("supportClaw/plugin-sdk/runtime-group-policy");
    vi.doUnmock("supportClaw/plugin-sdk/runtime-env");
    vi.doUnmock("supportClaw/plugin-sdk/reply-history");
    vi.doUnmock("supportClaw/plugin-sdk/routing");
    vi.doUnmock("supportClaw/plugin-sdk/conversation-runtime");

// Line plugin entrypoint registers its SupportClaw integration.
import {
...
type RegisteredLineCardCommand = SupportClawPluginCommandDefinition;

let lineCardCommandPromise: Promise<RegisteredLineCardCommand> | null = null;

async function loadLineCardCommand(api: SupportClawPluginApi): Promise<RegisteredLineCardCommand> {

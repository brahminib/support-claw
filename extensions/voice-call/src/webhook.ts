...
import { resolveConfiguredCapabilityProvider } from "supportClaw/plugin-sdk/provider-selection-runtime";
import type { TalkEvent } from "supportClaw/plugin-sdk/realtime-voice";
import {
...
export class VoiceCallWebhookServer {
  ...
  private fullConfig: SupportClawConfig | null;
  ...
  private async initializeMediaStreaming(): Promise<void> {
    ...
    const pluginConfig =
      this.fullConfig ?? (this.coreConfig as unknown as SupportClawConfig | undefined);
    ...
    const resolution = resolveConfiguredCapabilityProvider({
      ...
      cfg: pluginConfig,
      cfgForResolve: pluginConfig ?? ({} as SupportClawConfig),
    ...
    const streamConfig: MediaStreamConfig = {
      ...
      providerConfig,
      cfg: this.fullConfig ?? (this.coreConfig as SupportClawConfig | null) ?? undefined,

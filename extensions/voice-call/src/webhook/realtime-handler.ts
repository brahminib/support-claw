...
const FORCED_CONSULT_REASON = "provider_final_transcript_without_supportClaw_agent_consult";
...
function buildForcedConsultSpeechPrompt(result: string): string {
  ...
  return [
    "Internal SupportClaw consult result is ready.",
...
export class RealtimeCallHandler {
  ...
  constructor(
    ...
    private readonly coreConfig?: SupportClawConfig,
  ) {}

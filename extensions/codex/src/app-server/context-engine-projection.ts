/**
 * Projects SupportClaw context-engine assemblies into Codex prompt text while
...
import { redactSensitiveFieldValue, redactToolPayloadText } from "supportClaw/plugin-sdk/logging-core";
...
const CONTEXT_HEADER = "SupportClaw assembled context for this turn:";
...
/** Projects assembled SupportClaw context-engine messages into Codex prompt inputs. */

...
import type { getSessionEntry as getSessionEntryType } from "supportClaw/plugin-sdk/session-store-runtime";
...
vi.mock("supportClaw/plugin-sdk/session-store-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("supportClaw/plugin-sdk/session-store-runtime")>();
  return {
    ...actual,

...
import {
  ...
  isPendingSupportClawDynamicToolCompletionNotification,
...
export function applyCodexTurnNotificationState(params: {
  ...
  pendingSupportClawDynamicToolCompletionIds: Set<string>;
  ...
  const trackedDynamicToolCompletion = isPendingSupportClawDynamicToolCompletionNotification(
    notification,
    params.pendingSupportClawDynamicToolCompletionIds,
  );
  ...
  if (
    ...
    // accepts a turn or after SupportClaw hands a turn-scoped request result
    // back to Codex. Bookkeeping that closes the just-served SupportClaw
  ...
  if (trackedDynamicToolCompletion) {
    ...
    if (itemId) {
      params.pendingSupportClawDynamicToolCompletionIds.delete(itemId);
      params.onScheduleTerminalDynamicToolReleaseCheck();
    }
  }

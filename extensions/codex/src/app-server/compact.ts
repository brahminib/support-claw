/**
 * Native Codex app-server compaction bridge for bound SupportClaw sessions.
 */
import {
  embeddedAgentLog,
...
export async function maybeCompactCodexAppServerSession(
  ...
  warnIfIgnoringSupportClawCompactionOverrides(params);
...
function warnIfIgnoringSupportClawCompactionOverrides(
  params: CompactEmbeddedAgentSessionParams,
): void {

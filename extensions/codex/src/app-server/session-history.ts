/**
 * Reads SupportClaw session history for Codex transcript mirroring and sanitizes
...
import type { SessionEntry } from "supportClaw/plugin-sdk/agent-sessions";
import {
  buildSessionContext,
  migrateSessionEntries,
  parseSessionEntries,
} from "supportClaw/plugin-sdk/agent-sessions";

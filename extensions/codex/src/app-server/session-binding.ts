...
import { type FileLockOptions, withFileLock } from "supportClaw/plugin-sdk/file-lock";
import {
...
/** Durable sidecar binding connecting an SupportClaw session file to a Codex thread. */

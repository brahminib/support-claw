/**
 * Mirrors Codex native subagent thread lifecycle events into SupportClaw task
 * runtime rows so parent sessions can observe child progress.
 */
import type { AgentHarnessTaskRuntime } from "supportClaw/plugin-sdk/agent-harness-task-runtime";
...
/** Converts a Codex child thread id into the SupportClaw task-runtime run id. */

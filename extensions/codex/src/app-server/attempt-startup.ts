...
import {
  ...
  resolveCodexExternalSandboxPolicyForSupportClawSandbox,
          ...
          try {
            ...
            try {
              ...
              if (
                ...
                throw new Error(
                  "Codex app-server did not register an SupportClaw sandbox exec-server environment.",
                );
              }
            } catch (error) {
              await releaseStartupSandboxEnvironment();
            ...
            const startupSandboxPolicy = startupSandboxEnvironment
              ? resolveCodexExternalSandboxPolicyForSupportClawSandbox(params.sandbox)
              : undefined;

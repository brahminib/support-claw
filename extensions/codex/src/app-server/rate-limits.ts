...
import {
  ...
  type UsageWindow,
} from "supportClaw/plugin-sdk/provider-usage";
import { asFiniteNumber, parseStrictFiniteNumber } from "supportClaw/plugin-sdk/string-coerce-runtime";
...
export function formatCodexUsageLimitErrorMessage(params: {
  ...
  if (nextReset) {
    ...
    if (codexRetryHint) {
      ...
      parts.push("SupportClaw could not determine a reset time from Codex.");
    }
  }
  parts.push(

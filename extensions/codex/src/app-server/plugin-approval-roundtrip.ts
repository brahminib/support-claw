/**
 * Routes Codex app-server plugin approval prompts through SupportClaw's gateway
...
/** Starts a two-phase plugin approval request through the SupportClaw gateway. */

/**
 * Resolves Codex filesystem sandbox policy payloads into SupportClaw path/glob
...
function readFsSandboxCwd(execServer: SupportClawExecServer, sandbox: JsonObject): string {

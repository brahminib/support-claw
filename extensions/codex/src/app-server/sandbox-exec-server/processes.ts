...
import type { ManagedProcess, SupportClawExecServer, ProcessChunk } from "./types.js";
...
async function runProcess(
  ...
  if (!backend) {
    throw new Error("SupportClaw sandbox backend is unavailable.");
  }
  ...
  if (!command) {
    throw new Error("SupportClaw sandbox exec spec did not provide a command.");
  }

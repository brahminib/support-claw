// Codex tests cover supportClaw owned tool runtime contract plugin behavior.
import type { AnyAgentTool } from "supportClaw/plugin-sdk/agent-harness";
import { wrapToolWithBeforeToolCallHook } from "supportClaw/plugin-sdk/agent-harness-runtime";
import {
...
describe("SupportClaw-owned tool runtime contract — Codex app-server adapter", () => {
  afterEach(() => {
    resetSupportClawOwnedToolHooks();
  });

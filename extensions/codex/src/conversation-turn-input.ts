...
import type { PluginHookInboundClaimEvent } from "supportClaw/plugin-sdk/plugin-entry";
import { normalizeSingleOrTrimmedStringList } from "supportClaw/plugin-sdk/string-coerce-runtime";
...
function extractInboundMedia(event: PluginHookInboundClaimEvent): InboundMedia[] {
  ...
  // SupportClaw channels expose either local staged files or remote URLs. Keep

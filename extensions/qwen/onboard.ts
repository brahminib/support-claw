...
const qwenPresetAppliers = createModelCatalogPresetAppliers<[string]>({
  ...
  resolveParams: (_cfg: SupportClawConfig, baseUrl: string) => {
...
export function applyQwenConfig(cfg: SupportClawConfig): SupportClawConfig {
  return qwenPresetAppliers.applyConfig(cfg, QWEN_GLOBAL_BASE_URL);
}

export function applyQwenConfigCn(cfg: SupportClawConfig): SupportClawConfig {
  return qwenPresetAppliers.applyConfig(cfg, QWEN_CN_BASE_URL);
}

export function applyQwenStandardConfig(cfg: SupportClawConfig): SupportClawConfig {
  return qwenPresetAppliers.applyConfig(cfg, QWEN_STANDARD_GLOBAL_BASE_URL);
}

export function applyQwenStandardConfigCn(cfg: SupportClawConfig): SupportClawConfig {
  return qwenPresetAppliers.applyConfig(cfg, QWEN_STANDARD_CN_BASE_URL);
}

export function applyQwenOAuthConfig(cfg: SupportClawConfig): SupportClawConfig {

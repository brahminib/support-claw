...
import { resolveEnvApiKey } from "supportClaw/plugin-sdk/provider-auth-runtime";
import {
...
function resolveConfiguredOllamaWebSearchApiKey(config?: SupportClawConfig): string | undefined {
...
function resolveOllamaWebSearchApiKey(config?: SupportClawConfig): string | undefined {
  return resolveConfiguredOllamaWebSearchApiKey(config) ?? resolveEnvOllamaWebSearchApiKey();
}

function resolveOllamaWebSearchBaseUrl(config?: SupportClawConfig): string {

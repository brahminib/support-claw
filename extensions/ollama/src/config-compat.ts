...
export const legacyConfigRules: LegacyConfigRule[] = [
  {
    ...
    message:
      'models.providers.ollama-cloud.baseUrl="https://ai.ollama.com" is retired; use "https://ollama.com". Run "supportClaw doctor --fix".',
    match: (value) => findRetiredOllamaCloudBaseUrl(value) !== null,
  },
];

export function migrateOllamaCloudRetiredBaseUrl(config: SupportClawConfig): {
  ...
  nextConfig.models = nextModels as SupportClawConfig["models"];

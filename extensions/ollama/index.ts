// Ollama plugin entrypoint registers its SupportClaw integration.
import { collectConfiguredModelRefValues } from "@supportclaw/model-catalog-core/configured-model-refs";
...
export default definePluginEntry({
  ...
  register(api: SupportClawPluginApi) {
    ...
    const resolveCurrentPluginConfig = (config?: SupportClawConfig): OllamaPluginConfig => {
    ...
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY or run "supportClaw onboard --auth-choice ollama-cloud". ' +
        "See: https://docs.supportClaw.ai/providers/ollama",
    });
    api.registerProvider({
      ...
      buildUnknownModelHint: () =>
        ...
        'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "supportClaw configure". ' +
        "See: https://docs.supportClaw.ai/providers/ollama",
    });
  },
});

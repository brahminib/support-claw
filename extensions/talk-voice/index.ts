// Talk Voice plugin entrypoint registers its SupportClaw integration.
...
import type { SpeechVoiceOption } from "supportClaw/plugin-sdk/speech";
import {
  normalizeLowercaseStringOrEmpty,
  normalizeOptionalLowercaseString,
} from "supportClaw/plugin-sdk/string-coerce-runtime";
import { resolveActiveTalkProviderConfig } from "supportClaw/plugin-sdk/talk-config-runtime";
  ...
  register(api: SupportClawPluginApi) {
    api.registerCommand({
      ...
      handler: async (ctx) => {
        ...
        const cfg = api.runtime.config.current() as SupportClawConfig;

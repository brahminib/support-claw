...
function resolveQianfanPreset(cfg: SupportClawConfig): {
  api: ModelApi;
  baseUrl: string;
...
const qianfanPresetAppliers = createDefaultModelsPresetAppliers({
  ...
  resolveParams: (cfg: SupportClawConfig) => {
...
export function applyQianfanProviderConfig(cfg: SupportClawConfig): SupportClawConfig {
  return qianfanPresetAppliers.applyProviderConfig(cfg);
}

export function applyQianfanConfig(cfg: SupportClawConfig): SupportClawConfig {

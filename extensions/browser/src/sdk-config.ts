...
export { mutateConfigFile, replaceConfigFile } from "supportClaw/plugin-sdk/config-mutation";
export {
  type BrowserConfig,
...
export { resolveGatewayPort } from "supportClaw/plugin-sdk/core";
export {
  CONFIG_DIR,
  escapeRegExp,
  resolveUserPath,
  shortenHomePath,
} from "supportClaw/plugin-sdk/text-utility-runtime";

...
/** Mocks a launched SupportClaw Chrome process with the supplied pid. */
export function mockLaunchedChrome(
  launchSupportClawChrome: { mockResolvedValue: (value: RunningChrome) => unknown },
  pid: number,
) {
  const proc = new EventEmitter() as unknown as ChildProcessWithoutNullStreams;
  launchSupportClawChrome.mockResolvedValue({
    pid,

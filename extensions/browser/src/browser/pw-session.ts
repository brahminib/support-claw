...
// SupportClaw operations short-circuit instead of re-running the SSRF check on a
...
// Quarantine and close a tab that SupportClaw itself navigated to a blocked URL.
...
/** Quarantine and close a tab that SupportClaw navigated to a blocked URL. */
...
export async function createPageViaPlaywright(
  ...
  if (targetUrl !== "about:blank") {
    ...
    // SupportClaw owns this newly-created tab: if the post-navigation safety

// Fireworks plugin entrypoint registers its SupportClaw integration.
import type { ProviderResolveDynamicModelContext } from "supportClaw/plugin-sdk/plugin-entry";

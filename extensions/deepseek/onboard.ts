...
function applyDeepSeekProviderConfig(cfg: SupportClawConfig): SupportClawConfig {
...
export function applyDeepSeekConfig(cfg: SupportClawConfig): SupportClawConfig {

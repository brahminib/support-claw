// Deepseek plugin entrypoint registers its SupportClaw integration.
import { readConfiguredProviderCatalogEntries } from "supportClaw/plugin-sdk/provider-catalog-shared";
...
import { fetchDeepSeekUsage } from "supportClaw/plugin-sdk/provider-usage";

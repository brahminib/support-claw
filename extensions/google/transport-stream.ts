...
import { createProviderHttpError } from "supportClaw/plugin-sdk/provider-http";
import {
...
} from "supportClaw/plugin-sdk/provider-transport-runtime";
import {
...
type GoogleTransportApi = CanonicalGoogleTransportApi | "supportClaw-google-generative-ai-transport";
...
const GOOGLE_GEMINI3_FIRST_RESPONSE_RETRY_ENV = "SUPPORT_CLAW_GOOGLE_GEMINI_FIRST_RESPONSE_RETRY_MS";
...
function normalizeGoogleTransportRouteApi(
  ...
  switch (api) {
    ...
    case "supportClaw-google-generative-ai-transport":

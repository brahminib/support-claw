...
import { buildOauthProviderAuthResult } from "supportClaw/plugin-sdk/provider-auth-result";
import type { ProviderPlugin } from "supportClaw/plugin-sdk/provider-model-shared";
import { fetchGeminiUsage } from "supportClaw/plugin-sdk/provider-usage";
...
export function registerGoogleGeminiCliProvider(api: SupportClawPluginApi) {

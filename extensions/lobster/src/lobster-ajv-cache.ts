...
const installedSymbol = Symbol.for("supportClaw.lobster.ajv-compile-cache.installed");
const cacheSymbol = Symbol.for("supportClaw.lobster.ajv-compile-cache.entries");

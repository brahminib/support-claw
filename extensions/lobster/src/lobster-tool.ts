...
} from "supportClaw/plugin-sdk/param-readers";
...
type BoundTaskFlow = ReturnType<
  NonNullable<SupportClawPluginApi["runtime"]>["tasks"]["managedFlows"]["bindSession"]
>;
...
export function createLobsterTool(api: SupportClawPluginApi, options?: LobsterToolOptions) {

...
const PHONE_CONTROL_STATE_PREFIX = "supportClaw-phone-control-test-";
...
function createApi(params: {
  ...
  openKeyedStore?: SupportClawPluginApi["runtime"]["state"]["openKeyedStore"];
}): SupportClawPluginApi {
...
}): SupportClawPluginApi["runtime"]["state"]["openKeyedStore"] {
  return <T>() => {
...
describe("phone-control plugin", () => {
  ...
  it("does not block service startup on the initial expiry check", async () => {
    ...
    try {
      ...
      let service: SupportClawPluginService | undefined;

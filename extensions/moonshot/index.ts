// Moonshot plugin entrypoint registers its SupportClaw integration.
import { defineSingleProviderPluginEntry } from "supportClaw/plugin-sdk/provider-entry";
import { buildOpenAICompatibleReplayPolicy } from "supportClaw/plugin-sdk/provider-model-shared";
import { MOONSHOT_THINKING_STREAM_HOOKS } from "supportClaw/plugin-sdk/provider-stream-family";

...
export function applyMoonshotConfig(cfg: SupportClawConfig): SupportClawConfig {
  return moonshotPresetAppliers.applyConfig(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotConfigCn(cfg: SupportClawConfig): SupportClawConfig {

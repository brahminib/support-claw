...
function getChannelConfig(cfg: SupportClawConfig): SynologyChatChannelConfig {
  return (cfg.channels?.[channel] as SynologyChatChannelConfig | undefined) ?? {};
}

function getRawAccountConfig(cfg: SupportClawConfig, accountId: string): SynologyChatAccountRaw {
...
function isSynologyChatConfigured(cfg: SupportClawConfig, accountId: string): boolean {
...
function resolveExistingAllowedUserIds(cfg: SupportClawConfig, accountId: string): string[] {

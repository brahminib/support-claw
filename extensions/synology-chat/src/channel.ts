/**
 * Synology Chat Channel Plugin for SupportClaw.
 *
...
import { waitUntilAbort } from "supportClaw/plugin-sdk/channel-outbound";
import {
...
import { createEmptyChannelDirectoryAdapter } from "supportClaw/plugin-sdk/directory-runtime";
import {
...
const resolveSynologyChatDmPolicy = createScopedDmSecurityResolver<ResolvedSynologyChatAccount>({
  ...
  approveHint: "supportClaw pairing approve synology-chat <code>",
...
> & {
  pairing: {
    ...
    notifyApproval: (params: { cfg: SupportClawConfig; id: string }) => Promise<void>;
  };
  security: {
    resolveDmPolicy: (params: { cfg: SupportClawConfig; account: ResolvedSynologyChatAccount }) => {
  ...
  return createChatChannelPlugin({
    base: {
      ...
      meta: {
        ...
        blurb: "Connect your Synology NAS Chat to SupportClaw",
        order: 90,
      },
      capabilities: {

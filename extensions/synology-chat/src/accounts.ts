...
import { resolveDangerousNameMatchingEnabled } from "supportClaw/plugin-sdk/dangerous-name-runtime";
...
/** Extract the channel config from the full SupportClaw config object. */
function getChannelConfig(cfg: SupportClawConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: SupportClawConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.SUPPORT_CLAW_BOT_NAME ?? "SupportClaw";

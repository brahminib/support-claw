...
import { optionalFiniteNumberSchema, stringEnum } from "supportClaw/plugin-sdk/channel-actions";
...
import type { AnyAgentTool, SupportClawPluginApi, SupportClawPluginToolContext } from "../api.js";
...
export function createDiffsTool(params: {
  ...
  context?: SupportClawPluginToolContext;
}): AnyAgentTool {
  return {
    name: "diffs",
    label: "Diffs",
...
function buildArtifactContext(
  context: SupportClawPluginToolContext | undefined,

...
import { verifyChannelMessageAdapterCapabilityProofs } from "supportClaw/plugin-sdk/channel-outbound";
import { createSendCfgThreadingRuntime } from "supportClaw/plugin-sdk/channel-test-helpers";
...
vi.mock("supportClaw/plugin-sdk/plugin-config-runtime", async () => {
  const original = (await vi.importActual("supportClaw/plugin-sdk/plugin-config-runtime")) as Record<
    string,
    unknown
  >;
  return {
...
vi.mock("supportClaw/plugin-sdk/text-chunking", async () => {
  const original = (await vi.importActual("supportClaw/plugin-sdk/text-chunking")) as Record<
    string,
    unknown
  >;
  return {
...
afterAll(() => {
  ...
  vi.doUnmock("supportClaw/plugin-sdk/plugin-config-runtime");
  vi.doUnmock("supportClaw/plugin-sdk/text-chunking");
  vi.resetModules();
});

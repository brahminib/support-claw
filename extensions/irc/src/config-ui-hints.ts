...
import type { ChannelConfigUiHint } from "supportClaw/plugin-sdk/core";

export const ircChannelConfigUiHints = {
  "": {
    label: "IRC",
    help: "IRC channel provider configuration and compatibility settings for classic IRC transport workflows. Use this section when bridging legacy chat infrastructure into SupportClaw.",
  },
  dmPolicy: {
    label: "IRC DM Policy",

 ...
 */
import { resolveAwsSdkEnvVarName } from "supportClaw/plugin-sdk/provider-auth-runtime";
import type { ModelProviderConfig } from "supportClaw/plugin-sdk/provider-model-shared";

/** Resolve the config auth marker that tells SupportClaw to use AWS SDK credentials. */

/**
 * Amazon Bedrock Converse streaming runtime. It maps SupportClaw messages/tools,
...
/** Stream a Bedrock Converse request from the generic SupportClaw stream options. */

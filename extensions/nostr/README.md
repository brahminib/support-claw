...
Nostr DM channel plugin for SupportClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to SupportClaw. It enables your bot to:
...
# Configure supportClaw to use local relay

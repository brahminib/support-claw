// Nostr plugin entrypoint registers its SupportClaw integration.
import {
  defineBundledChannelEntry,
  loadBundledEntryExportSync,
} from "supportClaw/plugin-sdk/channel-entry-contract";
import type { SupportClawConfig, PluginRuntime, ResolvedNostrAccount } from "./api.js";
  ...
  registerFull(api) {
    const httpHandler = createNostrProfileHttpHandler()({
      getConfigProfile: (accountId: string) => {
        ...
        const cfg = runtime.config.current() as SupportClawConfig;

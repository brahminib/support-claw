...
vi.mock("./nostr-profile-http-runtime.js", async () => {
  const webhookIngress = await import("supportClaw/plugin-sdk/webhook-ingress");
  const requestGuards = await import("supportClaw/plugin-sdk/webhook-request-guards");
  return {

...
import { normalizeSecretInputString, type SecretInput } from "supportClaw/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: SupportClawConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: SupportClawConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: SupportClawConfig): string {

...
function getNostrConfig(cfg: SupportClawConfig): NostrAccountConfig | undefined {
  return (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
}

function listSetupNostrAccountIds(cfg: SupportClawConfig): string[] {
...
function resolveDefaultSetupNostrAccountId(cfg: SupportClawConfig): string {

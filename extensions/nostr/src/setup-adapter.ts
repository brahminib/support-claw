...
import type { ChannelSetupAdapter } from "supportClaw/plugin-sdk/channel-setup";
...
import { patchTopLevelChannelConfigSection, splitSetupEntries } from "supportClaw/plugin-sdk/setup";
...
export function createNostrSetupAdapter(params: {
  resolveAccountId: (cfg: SupportClawConfig, accountId?: string | null) => string;

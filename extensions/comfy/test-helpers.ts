...
export function buildComfyConfig(config: Record<string, unknown>): SupportClawConfig {
  return {
    plugins: {
      entries: {
        comfy: { config },
...
export function buildLegacyComfyConfig(config: Record<string, unknown>): SupportClawConfig {
  return {
    models: {
      providers: {
        comfy: config,

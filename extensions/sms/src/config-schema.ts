...
} from "supportClaw/plugin-sdk/channel-config-primitives";
import { requireChannelOpenAllowFrom } from "supportClaw/plugin-sdk/extension-shared";
import { buildSecretInputSchema } from "supportClaw/plugin-sdk/secret-input";
import { z } from "zod";
...
export const SmsChannelConfigSchema = buildChannelConfigSchema(SmsConfigSchema, {
  uiHints: {
    ...
    textChunkLimit: {
      ...
      help: "Maximum characters per outbound SMS chunk before SupportClaw splits long replies.",
    },
  },
});

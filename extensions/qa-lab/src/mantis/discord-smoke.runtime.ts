...
const DEFAULT_MANTIS_TOKEN_ENV = "SUPPORT_CLAW_QA_DISCORD_MANTIS_BOT_TOKEN";
const DEFAULT_MANTIS_TOKEN_FILE_ENV = "SUPPORT_CLAW_QA_DISCORD_MANTIS_BOT_TOKEN_FILE";
const DEFAULT_GUILD_ID_ENV = "SUPPORT_CLAW_QA_DISCORD_GUILD_ID";
const DEFAULT_CHANNEL_ID_ENV = "SUPPORT_CLAW_QA_DISCORD_CHANNEL_ID";
...
function assertMantisDiscordChannelInGuild(params: {
  ...
  if (!params.guildChannels.some((channel) => channel.id === params.channelId)) {
    throw new Error(
      `SUPPORT_CLAW_QA_DISCORD_CHANNEL_ID ${params.channelId} is not in guild ${params.guildId}.`,
    );
  }
  if (params.channel.guild_id && params.channel.guild_id !== params.guildId) {
    throw new Error(
      `SUPPORT_CLAW_QA_DISCORD_CHANNEL_ID ${params.channelId} belongs to guild ${params.channel.guild_id}, not ${params.guildId}.`,
    );
  }
}

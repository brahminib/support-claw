...
\`\`\``;
  ...
  const prompt = `You are grading SupportClaw natural character conversation transcripts for naturalness, vibes, and funniness.
...
function renderCharacterEvalReport(params: {
  ...
  const lines = [
    "# SupportClaw Character Eval Report",
    "",

...
const LEFT: HarnessVariant = { id: "left", label: "Left", runtime: "supportClaw" };
const RIGHT: HarnessVariant = { id: "right", label: "Right", runtime: "supportClaw" };
...
function classify(
  ...
  return buildHarnessParityResult({
    ...
    left: buildHarnessParityCell({
      variant: LEFT,
      cell: makeCell("supportClaw", left),
      tokenUsageSource: "live-usage",
    }),
    right: buildHarnessParityCell({
      variant: RIGHT,
      cell: makeCell("supportClaw", right),
      tokenUsageSource: "live-usage",
    }),
...
describe("harness parity", () => {
  ...
  it("labels mock token estimates separately from live usage", () => {
    const sourceCell = makeCell("supportClaw", {

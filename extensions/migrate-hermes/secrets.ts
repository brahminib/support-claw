...
import { updateAuthProfileStoreWithLock } from "supportClaw/plugin-sdk/provider-auth";
import {
...
async function buildOpenCodeSecretCandidates(
  ...
  // SupportClaw's Copilot token profile cannot preserve OpenCode enterprise routing yet.

...
const HERMES_STATE_DB_SNAPSHOT_PREFIX = "supportClaw-migrate-hermes-state-";
...
async function archiveHermesItem(item: MigrationItem, reportDir: string): Promise<MigrationItem> {
  ...
  try {
    ...
    return await withTempWorkspace(
      { rootDir: resolvePreferredSupportClawTmpDir(), prefix: HERMES_STATE_DB_SNAPSHOT_PREFIX },
      async ({ dir: tempDir }) => {

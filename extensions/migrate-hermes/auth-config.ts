...
import { applyAuthProfileConfig, type SupportClawConfig } from "supportClaw/plugin-sdk/provider-auth";
...
export async function applyAuthProfileConfigWithConflictCheck(params: {
  ctx: MigrationProviderContext;
  profile: HermesAuthProfileConfig;
  applyConfigPatch?: (config: SupportClawConfig) => SupportClawConfig;

...
import { asOptionalRecord as readRecord } from "supportClaw/plugin-sdk/string-coerce-runtime";
...
export function migrateLegacyCanvasHostConfig(config: SupportClawConfig): {
  ...
  const next = { ...config, plugins } as SupportClawConfig & { canvasHost?: unknown };

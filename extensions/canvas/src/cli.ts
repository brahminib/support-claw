...
import { runCommandWithRuntime, theme } from "supportClaw/plugin-sdk/cli-runtime";
...
import { defaultRuntime } from "supportClaw/plugin-sdk/runtime";
import {
  normalizeLowercaseStringOrEmpty,
  normalizeOptionalString,
} from "supportClaw/plugin-sdk/string-coerce-runtime";
import { shortenHomePath } from "supportClaw/plugin-sdk/text-utility-runtime";
...
/** Creates the default Canvas CLI dependency bundle backed by the SupportClaw gateway CLI. */
    ...
    a2ui
      ...
      .action(async (opts: CanvasNodesRpcOpts) => {
        await deps.runNodesCommand("canvas a2ui push", async () => {
          ...
          if (version === "v0.9") {
            throw new Error(
              "Detected A2UI v0.9 JSONL (createSurface). SupportClaw currently supports v0.8 only.",
            );
          }

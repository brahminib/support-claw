...
import { resolvePreferredSupportClawTmpDir } from "supportClaw/plugin-sdk/security-runtime";
import { asRecord, readStringValue } from "supportClaw/plugin-sdk/string-coerce-runtime";
...
function resolveTempPathParts(opts: { ext: string; tmpDir?: string; id?: string }) {
  const tmpDir = opts.tmpDir ?? resolvePreferredSupportClawTmpDir();
  if (!opts.tmpDir) {

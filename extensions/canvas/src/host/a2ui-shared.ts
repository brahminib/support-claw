 ...
 */
import { lowercasePreservingWhitespace } from "supportClaw/plugin-sdk/string-coerce-runtime";

/** Hosted path prefix for bundled A2UI assets. */
export const A2UI_PATH = "/__supportClaw__/a2ui";

/** Hosted path prefix for Canvas document/static assets. */
export const CANVAS_HOST_PATH = "/__supportClaw__/canvas";

/** Hosted WebSocket path for Canvas live reload. */
export const CANVAS_WS_PATH = "/__supportClaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.supportClawCanvasA2UIAction.postMessage(...)
  // - Android: window.supportClawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["supportClawCanvasA2UIAction"];
  ...
  globalThis.SupportClaw = globalThis.SupportClaw ?? {};
  globalThis.SupportClaw.postMessage = postToNode;
  globalThis.SupportClaw.sendUserAction = sendUserAction;
  globalThis.supportClawPostMessage = postToNode;
  globalThis.supportClawSendUserAction = sendUserAction;

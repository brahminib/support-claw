...
const providerFilter = parseCsvFilter(process.env.SUPPORT_CLAW_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.SUPPORT_CLAW_LIVE_MUSIC_GENERATION_MODELS);

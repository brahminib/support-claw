...
function mergeZaloAccountConfig(cfg: SupportClawConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: SupportClawConfig): ResolvedZaloAccount[] {

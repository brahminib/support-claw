...
import { stringEnum } from "supportClaw/plugin-sdk/channel-actions";
import type { AnyAgentTool, SupportClawPluginToolContext } from "supportClaw/plugin-sdk/core";
...
type ZalouserToolContext = Pick<SupportClawPluginToolContext, "deliveryContext">;

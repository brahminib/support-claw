...
function mergeZalouserAccountConfig(cfg: SupportClawConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: SupportClawConfig; accountId?: string | null }) {

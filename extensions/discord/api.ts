...
// Deprecated compatibility surface for existing @supportclaw/discord/api.js consumers.
...
export { resolveOpenProviderRuntimeGroupPolicy as resolveDiscordRuntimeGroupPolicy } from "supportClaw/plugin-sdk/runtime-group-policy";

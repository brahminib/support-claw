...
import { collectProviderDangerousNameMatchingScopes } from "supportClaw/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: SupportClawConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: SupportClawConfig,
  doctorFixCommand: string,
): { config: SupportClawConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: SupportClawConfig): string[] {

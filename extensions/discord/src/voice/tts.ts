...
import type { SupportClawConfig, TtsConfig } from "supportClaw/plugin-sdk/config-contracts";
import { parseTtsDirectives } from "supportClaw/plugin-sdk/speech";
...
function resolveVoiceTtsConfig(params: { cfg: SupportClawConfig; override?: TtsConfig }): {

...
import { MEDIA_FFMPEG_MAX_AUDIO_DURATION_SECS } from "supportClaw/plugin-sdk/media-runtime";
import { unlinkIfExists } from "supportClaw/plugin-sdk/media-runtime";
import { parseStrictFiniteNumber } from "supportClaw/plugin-sdk/number-runtime";
import { readResponseTextLimited } from "supportClaw/plugin-sdk/provider-http";
import type { RetryRunner } from "supportClaw/plugin-sdk/retry-runtime";
import { writeExternalFileWithinRoot } from "supportClaw/plugin-sdk/security-runtime";
import { fetchWithSsrFGuard, type SsrFPolicy } from "supportClaw/plugin-sdk/ssrf-runtime";
...
async function generateWaveformFromPcm(filePath: string): Promise<string> {
  const tempDir = resolvePreferredSupportClawTmpDir();

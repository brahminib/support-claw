...
import type { DiscordAccountConfig, DiscordActionConfig, SupportClawConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: SupportClawConfig): ResolvedDiscordAccount[] {

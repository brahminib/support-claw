...
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("supportClaw.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("supportClaw.discord.modalEntries");

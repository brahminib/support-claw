...
vi.mock("supportClaw/plugin-sdk/web-media", async () => {
...
afterAll(() => {
  vi.doUnmock("supportClaw/plugin-sdk/web-media");
});
...
describe("uploadStickerDiscord", () => {
  ...
  it("uploads sticker assets", async () => {
    ...
    await uploadStickerDiscord(
      {
        guildId: "g1",
        name: "supportClaw_wave",
        description: "SupportClaw waving",
        tags: "👋",
    ...
    expect(stickerBody.name).toBe("supportClaw_wave");
    expect(stickerBody.description).toBe("SupportClaw waving");

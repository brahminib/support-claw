...
import { peekSystemEvents, resetSystemEventsForTest } from "supportClaw/plugin-sdk/test-fixtures";
...
describe("agent components", () => {
  ...
  const createCfg = (): SupportClawConfig => ({}) as SupportClawConfig;
  ...
  it("sends pairing reply when DM sender is not allowlisted", async () => {
    ...
    expect(pairingText).toContain(`supportClaw pairing approve discord ${code}`);

...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "supportClaw/plugin-sdk/routing";
import {
...
// registry.
const THREAD_BINDINGS_STATE_KEY = Symbol.for("supportClaw.discordThreadBindingsState");

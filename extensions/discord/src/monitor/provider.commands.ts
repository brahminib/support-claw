...
import { danger, warn, type RuntimeEnv } from "supportClaw/plugin-sdk/runtime-env";
import {
...
export type GetPluginCommandSpecs =
  typeof import("supportClaw/plugin-sdk/plugin-runtime").getPluginCommandSpecs;

let pluginRuntimePromise: Promise<typeof import("supportClaw/plugin-sdk/plugin-runtime")> | undefined;

async function loadPluginRuntime() {
  const promise = pluginRuntimePromise ?? import("supportClaw/plugin-sdk/plugin-runtime");

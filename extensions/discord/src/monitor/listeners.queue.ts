...
import { createSubsystemLogger, formatDurationSeconds } from "supportClaw/plugin-sdk/runtime-env";

export type DiscordListenerLogger = ReturnType<
  typeof import("supportClaw/plugin-sdk/runtime-env").createSubsystemLogger
>;

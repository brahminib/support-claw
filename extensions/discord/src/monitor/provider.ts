...
import type { SupportClawConfig, ReplyToMode } from "supportClaw/plugin-sdk/config-contracts";
import { createConnectedChannelStatusPatch } from "supportClaw/plugin-sdk/gateway-runtime";
import {
...
import { isVerbose, logVerbose, shouldLogVerbose, warn } from "supportClaw/plugin-sdk/runtime-env";
import { createSubsystemLogger } from "supportClaw/plugin-sdk/runtime-env";
import { createNonExitingRuntime, type RuntimeEnv } from "supportClaw/plugin-sdk/runtime-env";
import {
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("supportClaw/plugin-sdk/reply-history").HistoryEntry[]
    >();

...
import { createNodeProxyAgent } from "supportClaw/plugin-sdk/fetch-runtime";
import {
  captureWsEvent,
  resolveEffectiveDebugProxyUrl,
  resolveDebugProxySettings,
} from "supportClaw/plugin-sdk/proxy-capture";
import { danger, warn } from "supportClaw/plugin-sdk/runtime-env";
...
type ResolveDiscordGatewayIntentsParams = {
  intentsConfig?: import("supportClaw/plugin-sdk/config-contracts").DiscordIntentsConfig;
...
function createGatewayPlugin(params: {
  ...
  class SupportClawGatewayPlugin extends discordGateway.GatewayPlugin {
  ...
  return new SupportClawGatewayPlugin();
}
...
export function createDiscordGatewayPlugin(params: {
  ...
  return createGatewayPlugin({
    options: {
      ...
      intents,
      // SupportClaw registers its own async interaction listener.

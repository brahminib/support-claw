...
import * as pluginCommandsModule from "supportClaw/plugin-sdk/plugin-runtime";
import * as dispatcherModule from "supportClaw/plugin-sdk/reply-dispatch-runtime";
...
function createCommand(cfg: SupportClawConfig, discordConfig?: DiscordAccountConfig) {
...
async function runGuildSlashCommand(params?: {
  userId?: string;
  mutateConfig?: (cfg: SupportClawConfig) => void;

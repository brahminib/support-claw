...
import { resolveCommandAuthorizedFromAuthorizers } from "supportClaw/plugin-sdk/command-auth-native";
...
export function resolveDiscordCommandOwnerAllowFrom(cfg: SupportClawConfig): string[] | undefined {

...
import { resolveAckReaction, resolveHumanDelayConfig } from "supportClaw/plugin-sdk/agent-runtime";
import {
...
import { getAgentScopedMediaLocalRoots } from "supportClaw/plugin-sdk/media-runtime";
import { resolveChunkMode } from "supportClaw/plugin-sdk/reply-chunking";
...
import type { ReplyDispatchKind, ReplyPayload } from "supportClaw/plugin-sdk/reply-runtime";
...
let replyRuntimePromise: Promise<typeof import("supportClaw/plugin-sdk/reply-runtime")> | undefined;

async function loadReplyRuntime() {
  replyRuntimePromise ??= import("supportClaw/plugin-sdk/reply-runtime");

...
import type { ChatCommandDefinition, CommandArgs } from "supportClaw/plugin-sdk/command-auth-native";
...
import { patchSessionEntry, resolveStorePath } from "supportClaw/plugin-sdk/session-store-runtime";
import { withTimeout } from "supportClaw/plugin-sdk/text-utility-runtime";

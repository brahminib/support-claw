...
import type { InboundEventKind } from "supportClaw/plugin-sdk/channel-inbound";
...
import type { SessionBindingRecord } from "supportClaw/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "supportClaw/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "supportClaw/plugin-sdk/routing";
...
type LoadedConfig = SupportClawConfig;
export type RuntimeEnv = import("supportClaw/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("supportClaw/plugin-sdk/config-contracts").SupportClawConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;

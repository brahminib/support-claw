...
import type { ModelsProviderData } from "supportClaw/plugin-sdk/models-provider-runtime";
import { parseStrictInteger, parseStrictPositiveInteger } from "supportClaw/plugin-sdk/number-runtime";
...
let modelsProviderRuntimePromise:
  | Promise<typeof import("supportClaw/plugin-sdk/models-provider-runtime")>
  | undefined;

async function loadModelsProviderRuntime() {
  modelsProviderRuntimePromise ??= import("supportClaw/plugin-sdk/models-provider-runtime");

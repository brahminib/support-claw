...
import { captureHttpExchange } from "supportClaw/plugin-sdk/proxy-capture";
...
const DISCORD_GATEWAY_INFO_TIMEOUT_ENV = "SUPPORT_CLAW_DISCORD_GATEWAY_INFO_TIMEOUT_MS";

...
import type { DiscordActionConfig } from "supportClaw/plugin-sdk/config-contracts";
...
function handleMessagingAction(
  ...
  cfg: SupportClawConfig = DISCORD_TEST_CFG,
  options?: {
    mediaAccess?: {

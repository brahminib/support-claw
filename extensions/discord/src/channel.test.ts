...
function createCfg(): SupportClawConfig {
  return {
    channels: {
      discord: {
        enabled: true,
...
function resolveAccount(cfg: SupportClawConfig, accountId = "default"): ResolvedDiscordAccount {
  return discordPlugin.config.resolveAccount(cfg, accountId);
}

function startDiscordAccount(cfg: SupportClawConfig, accountId = "default") {

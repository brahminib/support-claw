...
import { buildMessagingTarget, type MessagingTarget } from "supportClaw/plugin-sdk/channel-targets";
import type { DirectoryConfigParams } from "supportClaw/plugin-sdk/directory-runtime";

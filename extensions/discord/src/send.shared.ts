...
import { buildOutboundMediaLoadOptions } from "supportClaw/plugin-sdk/media-runtime";
import { extensionForMime } from "supportClaw/plugin-sdk/media-runtime";
import {
...
import type { ChunkMode } from "supportClaw/plugin-sdk/reply-chunking";
import { resolveTextChunksWithFallback } from "supportClaw/plugin-sdk/reply-payload";
...
async function resolveDiscordTargetChannelId(
  raw: string,
  opts: DiscordClientOpts & { cfg: SupportClawConfig },
): Promise<{ channelId: string; dm?: boolean }> {

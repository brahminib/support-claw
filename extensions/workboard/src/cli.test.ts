...
vi.mock("supportClaw/plugin-sdk/gateway-runtime", async () => {
  const actual = await vi.importActual<typeof import("supportClaw/plugin-sdk/gateway-runtime")>(
    "supportClaw/plugin-sdk/gateway-runtime",
  );
  return {
    ...actual,
...
vi.mock("supportClaw/plugin-sdk/runtime-config-snapshot", () => ({

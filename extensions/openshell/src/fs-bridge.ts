...
import { root as fsRoot } from "supportClaw/plugin-sdk/file-access-runtime";
import type {
  SandboxFsBridge,
  SandboxFsStat,
  SandboxResolvedPath,
} from "supportClaw/plugin-sdk/sandbox";
import { createWritableRenameTargetResolver } from "supportClaw/plugin-sdk/sandbox";
...
const MATERIALIZED_SKILLS_CONTAINER_PARTS = [".supportClaw", "sandbox-skills", "skills"] as const;

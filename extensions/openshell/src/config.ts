...
import { buildPluginConfigSchema, type SupportClawPluginConfigSchema } from "supportClaw/plugin-sdk/core";
import {
  formatPluginConfigIssue,
  mapPluginConfigIssues,
} from "supportClaw/plugin-sdk/extension-shared";
import { MAX_TIMER_TIMEOUT_SECONDS } from "supportClaw/plugin-sdk/number-runtime";
import { z } from "zod";
...
const DEFAULT_SOURCE = "supportClaw";
...
export function createOpenShellPluginConfigSchema(): SupportClawPluginConfigSchema {

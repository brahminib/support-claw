...
import type { MemorySource } from "supportClaw/plugin-sdk/memory-core-host-engine-storage";
...
class SessionSyncYieldHarness extends MemoryManagerSyncOps {
  protected readonly cfg = {} as SupportClawConfig;
  protected readonly agentId = "main";
  protected readonly workspaceDir = "/tmp/supportClaw-test-workspace";
...
describe("session sync responsiveness", () => {
  beforeEach(() => {
    vi.stubEnv("SUPPORT_CLAW_STATE_DIR", path.join(os.tmpdir(), "supportClaw-session-sync-yield"));

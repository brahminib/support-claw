...
import { listRegisteredMemoryEmbeddingProviderAdapters } from "supportClaw/plugin-sdk/memory-core-host-embedding-registry";
import {
...
import { extractKeywords } from "supportClaw/plugin-sdk/memory-core-host-engine-qmd";
import {
  readMemoryFile,
...
import { uniqueValues } from "supportClaw/plugin-sdk/string-coerce-runtime";
import {
...
const MEMORY_INDEX_MANAGER_CACHE_KEY = Symbol.for("supportClaw.memoryIndexManagerCache");
...
export class MemoryIndexManager extends MemoryManagerEmbeddingOps implements MemorySearchManager {
  ...
  protected readonly cfg: SupportClawConfig;

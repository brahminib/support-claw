...
} from "supportClaw/plugin-sdk/embedding-providers";
import {
...
function createMissingLlamaCppProviderError(): Error {
  return new Error(
    [
      ...
      "Install it with: supportClaw plugins install @supportclaw/llama-cpp-provider",
      "Then restart SupportClaw and retry: supportClaw memory status --deep",
    ].join("\n"),
  );
}

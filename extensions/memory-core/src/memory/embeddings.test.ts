...
import type { EmbeddingProviderAdapter } from "supportClaw/plugin-sdk/embedding-providers";
import type { MemoryEmbeddingProviderAdapter } from "supportClaw/plugin-sdk/memory-core-host-engine-embeddings";
...
const mockEmbeddingRegistry = vi.hoisted(() => ({
  ...
  genericLookupConfigs: [] as Array<SupportClawConfig | undefined>,
}));

vi.mock("supportClaw/plugin-sdk/embedding-providers", () => ({
  getEmbeddingProvider: (id: string, config?: SupportClawConfig) => {
...
vi.mock("supportClaw/plugin-sdk/memory-core-host-engine-embeddings", () => ({

...
import type { MemorySearchResult } from "supportClaw/plugin-sdk/memory-core-host-runtime-files";
import {
...
type Logger = Pick<SupportClawPluginApi["logger"], "info" | "warn" | "error">;
...
const LIGHT_SLEEP_EVENT_TEXT = "__supportClaw_memory_core_light_sleep__";
const REM_SLEEP_EVENT_TEXT = "__supportClaw_memory_core_rem_sleep__";
...
const MANAGED_DAILY_DREAMING_BLOCKS = [
  {
    heading: "## Light Sleep",
    startMarker: "<!-- supportClaw:dreaming:light:start -->",
    endMarker: "<!-- supportClaw:dreaming:light:end -->",
  },
  {
    heading: "## REM Sleep",
    startMarker: "<!-- supportClaw:dreaming:rem:start -->",
    endMarker: "<!-- supportClaw:dreaming:rem:end -->",
  },
] as const;

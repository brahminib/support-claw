...
import { resolveStateDir } from "supportClaw/plugin-sdk/memory-core-host-runtime-core";
...
const DIARY_START_MARKER = "<!-- supportClaw:dreaming:diary:start -->";
const DIARY_END_MARKER = "<!-- supportClaw:dreaming:diary:end -->";
const BACKFILL_ENTRY_MARKER = "supportClaw:dreaming:backfill-entry";

...
import type { SupportClawConfig } from "supportClaw/plugin-sdk/memory-core-host-runtime-core";
import type { MemorySearchResult } from "supportClaw/plugin-sdk/memory-core-host-runtime-files";
import { resolveSessionAgentId } from "supportClaw/plugin-sdk/memory-host-core";
import {
...
function isGlobalSessionKeyForSharedScope(cfg: SupportClawConfig, key: string): boolean {

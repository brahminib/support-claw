...
import { createAsyncLock } from "supportClaw/plugin-sdk/async-lock-runtime";
import { extractErrorCode } from "supportClaw/plugin-sdk/error-runtime";
import { resolveGlobalMap } from "supportClaw/plugin-sdk/global-singleton";
import { replaceManagedMarkdownBlock } from "supportClaw/plugin-sdk/memory-host-markdown";
import { readRegularFile, replaceFileAtomic } from "supportClaw/plugin-sdk/security-runtime";

const DREAMS_FILENAMES = ["DREAMS.md", "dreams.md"] as const;
const DEEP_START_MARKER = "<!-- supportClaw:dreaming:deep:start -->";
const DEEP_END_MARKER = "<!-- supportClaw:dreaming:deep:end -->";

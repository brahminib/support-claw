// Memory Core plugin entrypoint registers its SupportClaw integration.
import {
  jsonResult,
...
import { resolveMemoryBackendConfig } from "supportClaw/plugin-sdk/memory-core-host-runtime-files";
import {
  definePluginEntry,
  type AnyAgentTool,
...
type MemoryToolOptions = {
  ...
  getConfig?: () => SupportClawConfig | undefined;
  agentId?: string;
...
function getToolConfig(options: MemoryToolOptions): SupportClawConfig | undefined {
...
function resolveMemoryToolOptions(ctx: SupportClawPluginToolContext): MemoryToolOptions {

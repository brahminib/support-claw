...
import { ensureModelAllowlistEntry } from "supportClaw/plugin-sdk/provider-onboard";
import {
...
export function applyOpenAIProviderConfig(cfg: SupportClawConfig): SupportClawConfig {
...
export function applyOpenAIConfig(cfg: SupportClawConfig): SupportClawConfig {

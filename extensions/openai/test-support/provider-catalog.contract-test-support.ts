...
import type { ProviderPlugin } from "supportClaw/plugin-sdk/provider-test-contracts";
...
vi.mock("supportClaw/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("supportClaw/plugin-sdk/provider-catalog-runtime")
  >("supportClaw/plugin-sdk/provider-catalog-runtime");

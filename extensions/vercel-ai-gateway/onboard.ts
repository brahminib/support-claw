...
function applyVercelAiGatewayProviderConfig(cfg: SupportClawConfig): SupportClawConfig {
...
export function applyVercelAiGatewayConfig(cfg: SupportClawConfig): SupportClawConfig {

...
import { resolveHumanDelayConfig } from "supportClaw/plugin-sdk/agent-runtime";
import { CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "supportClaw/plugin-sdk/approval-handler-runtime";
import { logTypingFailure } from "supportClaw/plugin-sdk/channel-feedback";
import {
...
import { createChannelPairingChallengeIssuer } from "supportClaw/plugin-sdk/channel-pairing";
...
import { recordInboundSession } from "supportClaw/plugin-sdk/conversation-runtime";
import { normalizeScpRemoteHost } from "supportClaw/plugin-sdk/host-runtime";
import { isInboundPathAllowed, kindFromMime } from "supportClaw/plugin-sdk/media-runtime";
import { DEFAULT_GROUP_HISTORY_LIMIT, type HistoryEntry } from "supportClaw/plugin-sdk/reply-history";
import { resolveTextChunkLimit, type GetReplyOptions } from "supportClaw/plugin-sdk/reply-runtime";
import { dispatchInboundMessage } from "supportClaw/plugin-sdk/reply-runtime";
import { createReplyDispatcherWithTyping } from "supportClaw/plugin-sdk/reply-runtime";
import { settleReplyDispatcher } from "supportClaw/plugin-sdk/reply-runtime";
import { resolveInboundLastRouteSessionKey } from "supportClaw/plugin-sdk/routing";
import { getRuntimeConfig, type SupportClawConfig } from "supportClaw/plugin-sdk/runtime-config-snapshot";
import { danger, logVerbose, shouldLogVerbose, warn } from "supportClaw/plugin-sdk/runtime-env";
import {
...
import { waitForTransportReady } from "supportClaw/plugin-sdk/transport-ready-runtime";
...
function resolveConfiguredIMessageTypingMode(cfg: SupportClawConfig) {

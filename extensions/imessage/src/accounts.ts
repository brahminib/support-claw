...
} from "supportClaw/plugin-sdk/account-resolution";
import { resolveAccountEntry } from "supportClaw/plugin-sdk/routing";
...
function mergeIMessageAccountConfig(cfg: SupportClawConfig, accountId: string): IMessageAccountConfig {
...
// caused duplicate inbound handling in supportClaw/supportClaw#65141.
...
function resolveIMessageAccountSourceOwner(params: {
  ...
  // bindings tied to the named account keep working (supportClaw/supportClaw#65141).
 ...
 * watchers (supportClaw/supportClaw#65141) without otherwise marking the duplicate
...
export function listEnabledIMessageAccounts(cfg: SupportClawConfig): ResolvedIMessageAccount[] {

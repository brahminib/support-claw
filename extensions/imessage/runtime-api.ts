...
import type { SupportClawConfig as RuntimeApiSupportClawConfig } from "supportClaw/plugin-sdk/config-contracts";
...
export type IMessageAccountConfig = Omit<
  NonNullable<NonNullable<RuntimeApiSupportClawConfig["channels"]>["imessage"]>,

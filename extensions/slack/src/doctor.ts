...
import { createDangerousNameMatchingMutableAllowlistWarningCollector } from "supportClaw/plugin-sdk/channel-policy";
...
function collectSlackNameKeyedChannelWarnings({ cfg }: { cfg: SupportClawConfig }): string[] {

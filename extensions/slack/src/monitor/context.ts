...
import { resolveDefaultAgentId } from "supportClaw/plugin-sdk/agent-runtime";
import { formatAllowlistMatchMeta } from "supportClaw/plugin-sdk/allow-from";
import type {
  SupportClawConfig,
  SlackReactionNotificationMode,
} from "supportClaw/plugin-sdk/config-contracts";
import type { SessionScope } from "supportClaw/plugin-sdk/config-contracts";
import type { DmPolicy, GroupPolicy } from "supportClaw/plugin-sdk/config-contracts";
import { resolveRuntimeConversationBindingRoute } from "supportClaw/plugin-sdk/conversation-runtime";
import { createDedupeCache } from "supportClaw/plugin-sdk/dedupe-runtime";
import type { HistoryEntry } from "supportClaw/plugin-sdk/reply-history";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("supportClaw/plugin-sdk/config-contracts").SlackSlashCommandConfig>;
  textLimit: number;

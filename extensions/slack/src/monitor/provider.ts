...
import { CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "supportClaw/plugin-sdk/approval-handler-adapter-runtime";
...
import { resolveTextChunkLimit } from "supportClaw/plugin-sdk/reply-chunking";
import { DEFAULT_GROUP_HISTORY_LIMIT } from "supportClaw/plugin-sdk/reply-history";
import { normalizeMainKey } from "supportClaw/plugin-sdk/routing";
import { warn } from "supportClaw/plugin-sdk/runtime-env";
import {
  computeBackoff,
...
import { normalizeResolvedSecretInputString } from "supportClaw/plugin-sdk/secret-input";
import {
  normalizeOptionalString,
  normalizeStringEntries,
} from "supportClaw/plugin-sdk/string-coerce-runtime";
import { installRequestBodyLimitGuard } from "supportClaw/plugin-sdk/webhook-request-guards";
import {
  resolveSlackAccount,
...
export async function monitorSlackProvider(opts: MonitorSlackOpts = {}) {
  ...
  // See: supportClaw/supportClaw#56508

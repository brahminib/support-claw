...
import { formatInboundEnvelope } from "supportClaw/plugin-sdk/channel-inbound";
import { runTasksWithConcurrency } from "supportClaw/plugin-sdk/concurrency-runtime";
import type { ContextVisibilityMode } from "supportClaw/plugin-sdk/config-contracts";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("supportClaw/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;

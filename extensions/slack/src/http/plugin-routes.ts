...
function resolveSlackWebhookPaths(config: SupportClawPluginApi["config"]): string[] {
...
export function registerSlackPluginHttpRoutes(api: SupportClawPluginApi): void {

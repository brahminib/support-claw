...
} from "supportClaw/plugin-sdk/allowlist-config-edit";
import { adaptScopedAccountAccessor } from "supportClaw/plugin-sdk/channel-config-helpers";
import {
  buildThreadAwareOutboundSessionRoute,
  createChatChannelPlugin,
} from "supportClaw/plugin-sdk/channel-core";
import { createChannelMessageAdapterFromOutbound } from "supportClaw/plugin-sdk/channel-outbound";
import { resolveOutboundSendDep } from "supportClaw/plugin-sdk/channel-outbound";
import { createPairingPrefixStripper } from "supportClaw/plugin-sdk/channel-pairing";
import {
  createAttachedChannelResultAdapter,
  type ChannelOutboundAdapter,
} from "supportClaw/plugin-sdk/channel-send-result";
import {
  createChannelDirectoryAdapter,
  createRuntimeDirectoryLiveAdapter,
} from "supportClaw/plugin-sdk/directory-runtime";
import { createLazyRuntimeModule } from "supportClaw/plugin-sdk/lazy-runtime";
import { buildOutboundBaseSessionKey, type RoutePeer } from "supportClaw/plugin-sdk/routing";
import {
...
//
// `supportClaw/plugin-sdk/channel-policy` is intentionally NOT lazy here —
...
const EXTENSION_SHARED_MODULE_ID = "supportClaw/plugin-sdk/extension-shared";
const TARGET_RESOLVER_RUNTIME_MODULE_ID = "supportClaw/plugin-sdk/target-resolver-runtime";
  ...
  base: {
    ...
    actions: createSlackActions(SLACK_CHANNEL, {
      invoke: async (action, cfg, toolContext) =>
        ...
        )(action, cfg as SupportClawConfig, toolContext as SlackActionContext | undefined),
    }),

...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<SupportClawConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<SupportClawConfig["channels"]>["slack"]>>,
): SupportClawConfig {
  return {
    channels: {
      slack: {

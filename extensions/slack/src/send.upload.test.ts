...
vi.mock("supportClaw/plugin-sdk/fetch-runtime", async () => {
  const actual = await vi.importActual<typeof import("supportClaw/plugin-sdk/fetch-runtime")>(
    "supportClaw/plugin-sdk/fetch-runtime",
  );
  return {
    ...actual,

...
} from "supportClaw/plugin-sdk/channel-route";
...
type ApprovalForwardingConfig = NonNullable<NonNullable<SupportClawConfig["approvals"]>["plugin"]>;
...
function resolvePluginApprovalForwardingConfig(cfg: SupportClawConfig) {

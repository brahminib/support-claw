...
import { patchChannelConfigForAccount } from "supportClaw/plugin-sdk/setup-runtime";
...
import type { SupportClawConfig } from "./channel-api.js";

export const SLACK_CHANNEL = "slack" as const;

export function buildSlackManifest(botName = "SupportClaw") {
  const safeName = botName.trim() || "SupportClaw";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for SupportClaw`,
    },
    features: {
      bot_user: {
      ...
      assistant_view: {
        assistant_description: `${safeName} connects Slack assistant threads to SupportClaw agents.`,
        suggested_prompts: [
          {

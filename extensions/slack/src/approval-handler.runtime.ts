...
import { buildApprovalPresentationFromActionDescriptors } from "supportClaw/plugin-sdk/approval-reply-runtime";
import type { SupportClawConfig } from "supportClaw/plugin-sdk/config-contracts";
import { logError } from "supportClaw/plugin-sdk/logging-core";
...
type SlackExecApprovalConfig = NonNullable<
  NonNullable<NonNullable<SupportClawConfig["channels"]>["slack"]>["execApprovals"]
>;

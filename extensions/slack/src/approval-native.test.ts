...
function buildConfig(
  overrides?: Partial<NonNullable<NonNullable<SupportClawConfig["channels"]>["slack"]>>,
): SupportClawConfig {
  return {
    channels: {
      slack: {
...
const STORE_PATH = path.join(os.tmpdir(), "supportClaw-slack-approval-native-test.json");

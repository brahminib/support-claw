...
enum DeviceIdentityPaths {
    private static let stateDirEnv = ["SUPPORT_CLAW_STATE_DIR"]
        ...
        temporaryDirectory: URL) -> URL
    {
        ...
        return temporaryDirectory.appendingPathComponent("supportClaw", isDirectory: true)
    }
    ...
    private static func legacyStateDirURL() -> URL? {
        if let appSupport = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask).first {
            return appSupport.appendingPathComponent("SupportClaw", isDirectory: true)
        }
        return nil
    }
    ...
    private static func appGroupStateDirURL() -> URL? {
        guard
            let containerURL = FileManager.default
                .containerURL(forSecurityApplicationGroupIdentifier: SupportClawAppGroup.identifier)
        else {
            return nil
        }
        return containerURL.appendingPathComponent("SupportClaw", isDirectory: true)
    }
}

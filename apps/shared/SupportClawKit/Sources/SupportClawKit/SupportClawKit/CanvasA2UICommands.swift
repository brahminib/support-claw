...
public enum SupportClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct SupportClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct SupportClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {

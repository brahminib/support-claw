...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: SupportClawProtocol.AnyCodable]?
    {
        ...
        return [
            "id": SupportClawProtocol.AnyCodable(identity.deviceId),
            "publicKey": SupportClawProtocol.AnyCodable(publicKey),
            "signature": SupportClawProtocol.AnyCodable(signature),
            "signedAt": SupportClawProtocol.AnyCodable(signedAtMs),
            "nonce": SupportClawProtocol.AnyCodable(nonce),
        ]
    }
}

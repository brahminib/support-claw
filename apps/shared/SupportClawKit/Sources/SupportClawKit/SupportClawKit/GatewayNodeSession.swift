...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.supportClaw", category: "node.gateway")
    ...
    {
        let timeoutLogger = Logger(subsystem: "ai.supportClaw", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: SupportClawProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {

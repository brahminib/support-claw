...
public struct SupportClawChatThinkingLevelOption: Codable, Identifiable, Sendable, Hashable {
...
public struct SupportClawChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct SupportClawChatSessionsDefaults: Codable, Sendable {
    public let modelProvider: String?
    public let model: String?
    public let contextTokens: Int?
    public let thinkingLevels: [SupportClawChatThinkingLevelOption]?
    ...
    public init(
        ...
        model: String?,
        contextTokens: Int?,
        thinkingLevels: [SupportClawChatThinkingLevelOption]? = nil,
...
public struct SupportClawChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
    public var id: String {
        self.key
    }
...
public struct SupportClawChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: SupportClawChatSessionsDefaults?
    public let sessions: [SupportClawChatSessionEntry]
    ...
    public init(
        ...
        sessions: [SupportClawChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count

...
public typealias SupportClawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias SupportClawPlatformImage = UIImage
#endif

public struct SupportClawChatUsageCost: Codable, Hashable, Sendable {
...
public struct SupportClawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: SupportClawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(SupportClawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct SupportClawChatMessageContent: Codable, Hashable, Sendable {
...
public struct SupportClawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [SupportClawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: SupportClawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [SupportClawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: SupportClawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        let decodedUsage = try container.decodeIfPresent(SupportClawChatUsage.self, forKey: .usage)
        ...
        if let decoded = try? container.decode([SupportClawChatMessageContent].self, forKey: .content) {
...
public struct SupportClawChatHistoryPayload: Codable, Sendable {
...
public struct SupportClawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct SupportClawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [SupportClawSessionPreviewItem]
}

public struct SupportClawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [SupportClawSessionPreviewEntry]

    public init(ts: Int, previews: [SupportClawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct SupportClawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct SupportClawChatCreateSessionResponse: Codable, Sendable {
    public let ok: Bool?
    public let key: String
    public let sessionId: String?
}

public struct SupportClawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct SupportClawSessionMessageEventPayload: Codable, Sendable {
    public let sessionKey: String?
    public let agentId: String?
    public let message: SupportClawChatMessage?
...
public struct SupportClawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct SupportClawChatPendingToolCall: Identifiable, Hashable, Sendable {
    public var id: String {
        self.toolCallId
    }
...
public struct SupportClawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct SupportClawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: SupportClawPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: SupportClawPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct SupportClawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String

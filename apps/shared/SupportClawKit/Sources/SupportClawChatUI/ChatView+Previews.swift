...
private struct SupportClawChatPreviewTransport: SupportClawChatTransport {
    enum Scenario {
        case connected
        case empty
        case loading
    ...
    func requestHistory(sessionKey: String) async throws -> SupportClawChatHistoryPayload {
        ...
        case .connected:
            break
        case .empty:
            return SupportClawChatHistoryPayload(
        ...
        case .error:
            throw NSError(
                domain: "SupportClawChatPreviewTransport",
                code: 1,
    ...
    {
        SupportClawChatSendResponse(runId: idempotencyKey, status: "ok")
    }

    func listSessions(limit _: Int?) async throws -> SupportClawChatSessionsListResponse {
        SupportClawChatSessionsListResponse(
            ts: 0,
            path: nil,
            count: 2,
    ...
    private static func session(
        key: String,
        displayName: String,
        updatedAt: Double) -> SupportClawChatSessionEntry
    {
...
#Preview("Chat") {
    SupportClawChatPreview(scenario: .connected)
}
...
#Preview("Onboarding chat") {
    SupportClawChatView(
        viewModel: SupportClawChatViewModel(
            ...
            transport: SupportClawChatPreviewTransport()),
        showsSessionSwitcher: false,
        style: .onboarding,
        markdownVariant: .standard,
        userAccent: SupportClawChatTheme.accent)
}

private struct SupportClawChatPreview: View {
    let scenario: SupportClawChatPreviewTransport.Scenario
    ...
    var body: some View {
        SupportClawChatView(
            viewModel: SupportClawChatViewModel(
                ...
                transport: SupportClawChatPreviewTransport(scenario: self.scenario)),

...
private struct AttachmentProcessingTransport: SupportClawChatTransport {
    func requestHistory(sessionKey _: String) async throws -> SupportClawChatHistoryPayload {
...
final class ChatViewModelAttachmentTests: XCTestCase {
    func testImageAttachmentsAreProcessedBeforeStaging() async throws {
        ...
        let viewModel = await MainActor.run {
            SupportClawChatViewModel(sessionKey: "main", transport: AttachmentProcessingTransport())
        }

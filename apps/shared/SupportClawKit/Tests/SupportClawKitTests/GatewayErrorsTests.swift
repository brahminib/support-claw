...
@Suite struct GatewayErrorsTests {
    ...
    @Test func connectAuthErrorPreservesStructuredMetadata() {
        let error = GatewayConnectAuthError(
            ...
            actionCommand: "supportClaw devices approve req-123",
            docsURLString: "https://docs.supportClaw.ai/gateway/pairing",
        ...
        #expect(error.actionCommand == "supportClaw devices approve req-123")
        #expect(error.docsURLString == "https://docs.supportClaw.ai/gateway/pairing")
    ...
    @Test func pairingProblemUsesStructuredRequestMetadata() {
        ...
        #expect(problem?.actionCommand == "supportClaw devices approve req-123")
    }

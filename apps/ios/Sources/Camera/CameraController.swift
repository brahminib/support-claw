...
actor CameraController {
    ...
    func snap(params: SupportClawCameraSnapParams) async throws -> (
        format: String,
        base64: String,
        width: Int,
        height: Int)
    ...
    func clip(params: SupportClawCameraClipParams) async throws -> (
        format: String,
        base64: String,
        durationMs: Int,
        hasAudio: Bool)
    {
        ...
        let movURL = FileManager().temporaryDirectory
            .appendingPathComponent("supportClaw-camera-\(UUID().uuidString).mov")
        let mp4URL = FileManager().temporaryDirectory
            .appendingPathComponent("supportClaw-camera-\(UUID().uuidString).mp4")
        defer {
    ...
    private nonisolated static func pickCamera(
        facing: SupportClawCameraFacing,

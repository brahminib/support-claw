...
struct SettingsProTab: View {
    ...
    @AppStorage("location.enabledMode") var locationModeRaw: String = SupportClawLocationMode.off.rawValue
    ...
    @State var previousLocationModeRaw: String = SupportClawLocationMode.off.rawValue
    ...
    private func settingsModalPresentation(_ content: some View) -> some View {
        content
            ...
            .alert("Enable SupportClaw Hosted Push Relay?", isPresented: self.$showNotificationRelayDisclosure) {
                    Button("Continue") {

...
struct CommandPanel<Content: View>: View {
    ...
    var body: some View {
        ProCard(
            ...
            radius: SupportClawProMetric.cardRadius)
        {
            self.content
        }
    }
...
struct CommandSessionRow: View {
    ...
    var body: some View {
        ...
        .padding(.vertical, 8)
        .background {
            RoundedRectangle(cornerRadius: SupportClawProMetric.controlRadius, style: .continuous)
                .fill(self.rowFill)
                .overlay {
                    RoundedRectangle(cornerRadius: SupportClawProMetric.controlRadius, style: .continuous)
            ...
            Image(systemName: self.icon)
                ...
                .background {
                    RoundedRectangle(cornerRadius: 8, style: .continuous)
                        .fill(SupportClawBrand.ok.opacity(0.10))
                }

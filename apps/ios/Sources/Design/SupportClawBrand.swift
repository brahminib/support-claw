...
enum AppAppearancePreference: String, CaseIterable, Identifiable {
    ...
    static var launchArgumentPreference: AppAppearancePreference? {
        ...
        guard let flagIndex = arguments.firstIndex(of: "--supportClaw-appearance") else {
            return nil
        }
...
extension View {
    func supportClawSheetChrome() -> some View {
        self
            .tint(SupportClawBrand.accent)
            .background {
                SupportClawBrand.sheetBackground
                    .ignoresSafeArea()
            }
    }
}

...
struct ChatProTab: View {
                ...
                VStack(spacing: 0) {
                    ...
                    if let viewModel {
                        SupportClawChatView(
                            ...
                            assistantAvatarTint: SupportClawBrand.accent,
                        ...
                        .fill(
                            LinearGradient(
                                colors: [
                                    ...
                                    SupportClawBrand.accentHot,
                                ],
                                startPoint: .topLeading,
                                endPoint: .bottomTrailing)))
                .overlay(Circle().strokeBorder(.white.opacity(0.18), lineWidth: 1))
                .shadow(color: SupportClawBrand.accent.opacity(0.18), radius: 10, y: 5)
        } else {
            ProIconBadge(systemName: "bubble.left", color: SupportClawBrand.accent)
        }
    }
    ...
    private func syncChatViewModel() {
        ...
        guard let viewModel else {
            ...
            self.viewModel = SupportClawChatViewModel(
    ...
    private var talkControl: SupportClawChatTalkControl {
        SupportClawChatTalkControl(
    ...
    private var chatUserAccent: Color {
        self.colorScheme == .light ? SupportClawBrand.info : SupportClawBrand.accent
    }

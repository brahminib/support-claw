...
struct IPadSkillWorkshopScreen: View {
    ...
    init(headerLeadingAction: SupportClawSidebarHeaderAction? = nil, openSettings: @escaping () -> Void = {}) {
...
private struct IPadSkillProposalKanbanCard: View {
    ...
    var body: some View {
                    ...
                    HStack(alignment: .top, spacing: 10) {
                        ...
                        VStack(alignment: .leading, spacing: 4) {
                            Text(self.proposal.title)
                                .font(.subheadline.weight(.semibold))
                                .foregroundStyle(self.isSelected ? SupportClawBrand.accent : .primary)
                                .lineLimit(2)
        ...
        .padding(12)
        .background(
            self.isSelected ? SupportClawBrand.accent.opacity(0.08) : Color.clear,
...
struct IPadSkillProposalRow: View {
    ...
    var body: some View {
        ...
        .padding(.vertical, 10)
        .background(
            self.isSelected ? SupportClawBrand.danger.opacity(0.08) : Color.clear,
            in: RoundedRectangle(cornerRadius: 8, style: .continuous))
    }
}
...
struct IPadSkillProposal: Identifiable {
    ...
    var statusColor: Color {
        switch self.status {
        case "pending": SupportClawBrand.warn
        case "applied": SupportClawBrand.ok
        case "rejected": .secondary
        case "quarantined", "stale": SupportClawBrand.warn
        default: SupportClawBrand.accent
        }
    }

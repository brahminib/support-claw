...
struct CommandCenterTab: View {
    ...
    @State private var defaultChatSessionEntry: SupportClawChatSessionEntry?
    @State private var recentChatSessions: [SupportClawChatSessionEntry] = []
    var headerTitle: String = "SupportClaw"
    var headerLeadingAction: SupportClawSidebarHeaderAction?
        ...
        NavigationStack {
            GeometryReader { geometry in
                ZStack {
                    ...
                    .safeAreaPadding(.bottom, SupportClawProMetric.bottomScrollInset)
                }
            }
    ...
    private var header: some View {
            ...
            subtitleLineLimit: 1)
        {
            ...
            {
                SupportClawProMark(size: 28, shadowRadius: 5)
            }
        } accessory: {
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                HStack(spacing: 0) {
                    ...
                    self.gatewayFact(
                        ...
                        color: SupportClawBrand.accentHot)
                }
                .padding(.vertical, 9)
                .background {
        ...
        HStack(spacing: 8) {
            ...
            if let badgeValue {
                Text(badgeValue)
                    ...
                    .padding(.vertical, 3)
                    .background(SupportClawBrand.accentHot, in: Capsule())
            }
            Spacer(minLength: 8)
            if let value {
                if let action {
    ...
    private var gatewayStatusColor: Color {
        self.gatewayConnected ? SupportClawBrand.ok : .secondary
    }
    ...
    private var defaultChatWorkItem: WorkItem {
        ...
        return WorkItem(
            ...
            trailing: "chat",
            color: isOpen ? SupportClawBrand.accent : SupportClawBrand.ok,
            progress: nil,
            route: .chat(nil))
    }
    ...
    private static func sessionChoices(
        _ sessions: [SupportClawChatSessionEntry],
        currentSessionKey: String,
        defaultSessionKey: String) -> [SupportClawChatSessionEntry]
    {
    ...
    static func sessionWorkItem(
        for session: SupportClawChatSessionEntry,
        currentSessionKey: String) -> WorkItem
    {
        ...
        return WorkItem(
            ...
            trailing: "chat",
            color: isCurrent ? SupportClawBrand.accent : SupportClawBrand.ok,
            progress: nil,
            route: .chat(session.key))
    }

    fileprivate static func sessionTitle(_ session: SupportClawChatSessionEntry) -> String {
    ...
    fileprivate static func sessionDetail(_ session: SupportClawChatSessionEntry) -> String {
...
struct CommandSessionsScreen: View {
    ...
    @State private var sessions: [SupportClawChatSessionEntry] = []
    @State private var isLoading = false
    @State private var loadErrorText: String?
    let headerLeadingAction: SupportClawSidebarHeaderAction?
    let openChat: () -> Void

    init(headerLeadingAction: SupportClawSidebarHeaderAction? = nil, openChat: @escaping () -> Void) {

...
struct SupportClawProBackground: View {
...
struct ProCard<Content: View>: View {
    ...
    var radius: CGFloat = SupportClawProMetric.cardRadius
    ...
    var body: some View {
        ...
        shape
            ...
            .overlay {
                if self.isProminent {
                    shape.strokeBorder(
                        SupportClawBrand.accent.opacity(self.colorScheme == .dark ? 0.12 : 0.07),
                        lineWidth: 1)
                        .padding(1)
                }
            }
...
extension View {
    func proPanelSurface(
        tint: Color? = nil,
        radius: CGFloat = SupportClawProMetric.cardRadius,
...
struct SupportClawSidebarHeaderAction {
    let systemName: String
...
struct SupportClawSidebarRevealButton: View {
    let headerAction: SupportClawSidebarHeaderAction

    init(action: SupportClawSidebarHeaderAction) {
...
struct SupportClawSidebarHeaderLeadingSlot: View {
    let action: SupportClawSidebarHeaderAction

    var body: some View {
        SupportClawSidebarRevealButton(action: self.action)
            .frame(width: 44, height: 44, alignment: .center)
    }
}

struct SupportClawAdaptiveHeaderRow<Leading: View, Accessory: View>: View {
    let title: String
    let subtitle: String
...
struct SupportClawProMark: View {
    var size: CGFloat = 42
    var shadowRadius: CGFloat = 10

    var body: some View {
        Image("SupportClawIcon")
            .resizable()
            .scaledToFit()
            .frame(width: self.size, height: self.size)
            .shadow(color: SupportClawBrand.accent.opacity(0.18), radius: self.shadowRadius, y: self.shadowRadius / 3)
            .accessibilityLabel("SupportClaw")
    }
}

struct ProProgressBar: View {
    let progress: Double
    var color: Color = SupportClawBrand.accentHot
...
struct SupportClawGatewayCompactPill: View {

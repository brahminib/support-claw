...
extension GatewayConnectionController {
    ...
    private func currentCaps() -> [String] {
        var caps = [
            ...
            SupportClawCapability.screen.rawValue,
        ]
        ...
        if cameraEnabled { caps.append(SupportClawCapability.camera.rawValue) }

        let voiceWakeEnabled = UserDefaults.standard.bool(forKey: VoiceWakePreferences.enabledKey)
        if voiceWakeEnabled { caps.append(SupportClawCapability.voiceWake.rawValue) }

        let locationModeRaw = UserDefaults.standard.string(forKey: "location.enabledMode") ?? "off"
        let locationMode = SupportClawLocationMode(rawValue: locationModeRaw) ?? .off
        if locationMode != .off { caps.append(SupportClawCapability.location.rawValue) }

        caps.append(SupportClawCapability.device.rawValue)
        caps.append(SupportClawCapability.talk.rawValue)
        if WatchMessagingService.isSupportedOnDevice() {
            caps.append(SupportClawCapability.watch.rawValue)
        }
        caps.append(SupportClawCapability.photos.rawValue)
        caps.append(SupportClawCapability.contacts.rawValue)
        caps.append(SupportClawCapability.calendar.rawValue)
        caps.append(SupportClawCapability.reminders.rawValue)
        if Self.motionAvailable() {
            caps.append(SupportClawCapability.motion.rawValue)
        }
    ...
    private func currentCommands() -> [String] {
        var commands: [String] = [
            ...
            SupportClawScreenCommand.record.rawValue,
            SupportClawSystemCommand.notify.rawValue,
            SupportClawChatCommand.push.rawValue,
        ...
        if caps.contains(SupportClawCapability.camera.rawValue) {
            commands.append(SupportClawCameraCommand.list.rawValue)
            commands.append(SupportClawCameraCommand.snap.rawValue)
            commands.append(SupportClawCameraCommand.clip.rawValue)
        }
        if caps.contains(SupportClawCapability.location.rawValue) {
            commands.append(SupportClawLocationCommand.get.rawValue)
        }
        if caps.contains(SupportClawCapability.device.rawValue) {
            commands.append(SupportClawDeviceCommand.status.rawValue)
            commands.append(SupportClawDeviceCommand.info.rawValue)
        }
        if caps.contains(SupportClawCapability.watch.rawValue) {
            commands.append(SupportClawWatchCommand.status.rawValue)
            commands.append(SupportClawWatchCommand.notify.rawValue)
        }
        if caps.contains(SupportClawCapability.photos.rawValue) {
            commands.append(SupportClawPhotosCommand.latest.rawValue)
        }
        if caps.contains(SupportClawCapability.contacts.rawValue) {
            commands.append(SupportClawContactsCommand.search.rawValue)
            commands.append(SupportClawContactsCommand.add.rawValue)
        }
        if caps.contains(SupportClawCapability.calendar.rawValue) {
            commands.append(SupportClawCalendarCommand.events.rawValue)
            commands.append(SupportClawCalendarCommand.add.rawValue)
        }
        if caps.contains(SupportClawCapability.reminders.rawValue) {
            commands.append(SupportClawRemindersCommand.list.rawValue)
            commands.append(SupportClawRemindersCommand.add.rawValue)
        }
        if caps.contains(SupportClawCapability.motion.rawValue) {
            commands.append(SupportClawMotionCommand.activity.rawValue)
            commands.append(SupportClawMotionCommand.pedometer.rawValue)
        }

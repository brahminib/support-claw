...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.supportClawfoundation.app.gateway"
    private static let nodeService = "ai.supportClawfoundation.app.node"
    private static let talkService = "ai.supportClawfoundation.app.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.supportClawfoundation.app", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.supportClawfoundation.app.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("supportClaw-gateway.log")
    }

...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: SupportClawPhotosLatestParams) async throws -> SupportClawPhotosLatestPayload {
        ...
        var results: [SupportClawPhotoPayload] = []
        ...
        return SupportClawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> SupportClawPhotoPayload
    {
        ...
        return SupportClawPhotoPayload(
            format: "jpeg",

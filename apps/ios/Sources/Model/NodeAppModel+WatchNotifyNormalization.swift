...
extension NodeAppModel {
    static func normalizeWatchNotifyParams(_ params: SupportClawWatchNotifyParams) -> SupportClawWatchNotifyParams {
    ...
    static func normalizeWatchActions(
        _ actions: [SupportClawWatchAction]?,
        kind: String?,
        promptId: String?) -> [SupportClawWatchAction]
    {
        let provided = (actions ?? []).compactMap { action -> SupportClawWatchAction? in
            let id = action.id.trimmingCharacters(in: .whitespacesAndNewlines)
            let label = action.label.trimmingCharacters(in: .whitespacesAndNewlines)
            guard !id.isEmpty, !label.isEmpty else { return nil }
            return SupportClawWatchAction(
                id: id,
                label: label,
        ...
        if normalizedKind.contains("approval") || normalizedKind.contains("approve") {
            return [
                SupportClawWatchAction(id: "approve", label: "Approve"),
                SupportClawWatchAction(id: "decline", label: "Decline", style: "destructive"),
                SupportClawWatchAction(id: "open_phone", label: "Open iPhone"),
                SupportClawWatchAction(id: "escalate", label: "Escalate"),
            ]
        }

        return [
            SupportClawWatchAction(id: "done", label: "Done"),
            SupportClawWatchAction(id: "snooze_10m", label: "Snooze 10m"),
            SupportClawWatchAction(id: "open_phone", label: "Open iPhone"),
            SupportClawWatchAction(id: "escalate", label: "Escalate"),
        ]
    }
    ...
    static func normalizedWatchRisk(
        _ risk: SupportClawWatchRisk?,
        priority: SupportClawNotificationPriority?) -> SupportClawWatchRisk?
    {
    ...
    static func normalizedWatchPriority(
        _ priority: SupportClawNotificationPriority?,
        risk: SupportClawWatchRisk?) -> SupportClawNotificationPriority?
    {

...
struct IOSGatewayChatTransport: SupportClawChatTransport {
    static let logger = Logger(subsystem: "ai.supportClawfoundation.app", category: "ios.chat.transport")
    ...
    private struct ChatSendParams: Codable {
        ...
        var message: String
        var thinking: String
        var attachments: [SupportClawChatAttachmentPayload]?
        var timeoutMs: Int
    ...
    static func makeChatSendParamsJSON(
        ...
        attachments: [SupportClawChatAttachmentPayload]) throws -> String
    {
        ...
        parentSessionKey: String?) async throws -> SupportClawChatCreateSessionResponse
    {
        ...
        return try JSONDecoder().decode(SupportClawChatCreateSessionResponse.self, from: res)
    }
    ...
    func listSessions(limit: Int?) async throws -> SupportClawChatSessionsListResponse {
        ...
        return try JSONDecoder().decode(SupportClawChatSessionsListResponse.self, from: res)
    }
    ...
    func requestHistory(sessionKey: String) async throws -> SupportClawChatHistoryPayload {
        ...
        return try JSONDecoder().decode(SupportClawChatHistoryPayload.self, from: res)
    }
        ...
        attachments: [SupportClawChatAttachmentPayload]) async throws -> SupportClawChatSendResponse
    {
        ...
        do {
            ...
            let decoded = try JSONDecoder().decode(SupportClawChatSendResponse.self, from: res)
    ...
    func requestHealth(timeoutMs: Int) async throws -> Bool {
        ...
        return (try? JSONDecoder().decode(SupportClawGatewayHealthOK.self, from: res))?.ok ?? true
    }
    ...
    static func mapEventFrame(_ evt: EventFrame) -> SupportClawChatTransportEvent? {
        switch evt.event {
        case "tick":
            return .tick
        case "seqGap":
        ...
        case "health":
            ...
            let ok = (try? GatewayPayloadDecoding.decode(
                payload,
                as: SupportClawGatewayHealthOK.self))?.ok ?? true
            return .health(ok: ok)
        case "chat":
            guard let payload = evt.payload else { return nil }
        ...
        case "session.message":
            ...
            guard let message = try? GatewayPayloadDecoding.decode(
                payload,
                as: SupportClawSessionMessageEventPayload.self)
            else {
                return nil
            }

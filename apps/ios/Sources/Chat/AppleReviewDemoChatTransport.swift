...
enum ScreenshotFixtureMode {
    static let gatewayName = "SupportClaw Gateway"
...
struct LocalChatFixture {
    ...
    static let appScreenshots = LocalChatFixture(
        ...
        workspace: "SupportClaw",
        modelProvider: "openai",
        modelID: "gpt-5.5",
        modelName: "GPT-5.5",
        responsePrefix: "SupportClaw is connected to your gateway.",
        seedMessages: [
            """
            SupportClaw is connected to your gateway. I can coordinate agents, inspect project context, and prepare \
...
struct LocalFixtureChatTransport: SupportClawChatTransport {
...
struct AppleReviewDemoChatTransport: SupportClawChatTransport {
...
private actor LocalFixtureChatStore {
    private let fixture: LocalChatFixture
    private var messages: [SupportClawChatMessage]
    ...
    func createSession(key: String) throws -> SupportClawChatCreateSessionResponse {
        try Self.decode(
            CreateSessionPayload(ok: true, key: key, sessionId: "\(self.fixture.sessionIDPrefix)-\(key)"),
            as: SupportClawChatCreateSessionResponse.self)
    }

    func history(sessionKey: String) throws -> SupportClawChatHistoryPayload {
        ...
        return try Self.decode(
            HistoryPayload(
                ...
                thinkingLevel: "auto"),
            as: SupportClawChatHistoryPayload.self)
    }

    func sendMessage(sessionKey _: String, message: String, runId: String) throws -> SupportClawChatSendResponse {
        ...
        return try Self.decode(
            ...
            as: SupportClawChatSendResponse.self)
    }

    func sessions() throws -> SupportClawChatSessionsListResponse {
        let entry = SupportClawChatSessionEntry(
            ...
            thinkingDefault: "auto")
        return SupportClawChatSessionsListResponse(
    ...
    private static var thinkingLevels: [SupportClawChatThinkingLevelOption] {
        [
            SupportClawChatThinkingLevelOption(id: "auto", label: "Auto"),
    ...
    private static func seedMessages(fixture: LocalChatFixture) -> [SupportClawChatMessage] {
        let now = Date().timeIntervalSince1970 * 1000
    ...
    private static func message(role: String, text: String, timestamp: Double) -> SupportClawChatMessage {
    ...
    private struct HistoryPayload: Encodable {
        ...
        var messages: [SupportClawChatMessage]?

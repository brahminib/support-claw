...
final class CalendarService: CalendarServicing {
    func events(params: SupportClawCalendarEventsParams) async throws -> SupportClawCalendarEventsPayload {
        ...
        let payload = selected.map { event in
            SupportClawCalendarEventPayload(
        ...
        return SupportClawCalendarEventsPayload(events: payload)
    }
    ...
    func add(params: SupportClawCalendarAddParams) async throws -> SupportClawCalendarAddPayload {
        ...
        let payload = SupportClawCalendarEventPayload(
            identifier: event.eventIdentifier ?? UUID().uuidString,
        ...
        return SupportClawCalendarAddPayload(event: payload)
    }

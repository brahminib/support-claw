...
@Suite struct RootTabsPresentationTests {
    ...
    @Test func chatSidebarDestinationCanUseRouteHeaderInsteadOfAgentBranding() {
        ...
        #expect(ChatProTab.defaultHeaderTitle(showsAgentBadge: true, agentDisplayName: "SupportClaw") == "SupportClaw")
        #expect(ChatProTab.defaultHeaderTitle(showsAgentBadge: false, agentDisplayName: "SupportClaw") == "Chat")
    }

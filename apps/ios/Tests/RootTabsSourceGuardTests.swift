...
struct RootTabsSourceGuardTests {
    @Test func `hidden sidebar reveal uses destination header without reserved rail`() throws {
        ...
        #expect(componentSource.contains("SupportClawSidebarHeaderLeadingSlot"))
    ...
    @Test func `sidebar keeps navigation model destination only`() throws {
        ...
        #expect(source.contains("SupportClawProMark(size: 30"))
        #expect(source.contains("Text(\"SupportClaw\")"))
    ...
    @Test func `sidebar routes use destination headers instead of repeated product branding`() throws {
        ...
        #expect(!sidebarDetail.contains("headerTitle: \"SupportClaw\""))
        #expect(agentOverviewSource.contains("SupportClawAdaptiveHeaderRow("))
        #expect(agentOverviewSource.contains("title: self.headerTitle"))
        #expect(!agentOverviewSource.contains("Text(\"SupportClaw\")"))
        #expect(docsSource.contains("SupportClawAdaptiveHeaderRow("))
        #expect(docsSource.contains("title: \"Docs\""))
        #expect(!docsSource.contains("Text(\"SupportClaw Docs\")"))
    }
    ...
    @Test func `agents direct route keeps single sidebar control`() throws {
        ...
        #expect(nodesSource.contains("SupportClawSidebarHeaderLeadingSlot(action: headerLeadingAction)"))
        #expect(dreamingSource.contains("SupportClawSidebarHeaderLeadingSlot(action: headerLeadingAction)"))
    }
    ...
    @Test func `routed headers use shared adaptive layout`() throws {
        ...
        #expect(componentsSource.contains("struct SupportClawAdaptiveHeaderRow<Leading: View, Accessory: View>: View"))
        ...
        #expect(featureChromeSource.contains("SupportClawAdaptiveHeaderRow("))
        #expect(docsSource.contains("SupportClawAdaptiveHeaderRow("))
        #expect(overviewSource.contains("SupportClawAdaptiveHeaderRow("))
        #expect(chatSource.contains("SupportClawAdaptiveHeaderRow("))
        #expect(agentOverviewSource.contains("SupportClawAdaptiveHeaderRow("))
        #expect(settingsSource.contains("SupportClawAdaptiveHeaderRow("))
    }
    ...
    @Test func `phone hub keeps docs as destination only`() throws {
        ...
        #expect(source.contains("SupportClawDocsScreen("))
        ...
        #expect(!source.contains("https://docs.supportClaw.ai"))
    }
    ...
    @Test func `phone hub header stays task first`() throws {
        ...
        #expect(source.contains("private var phoneDetailBackAction: SupportClawSidebarHeaderAction"))
        #expect(source.contains("accessibilityLabel: \"Back to Control\""))
        #expect(source.contains("accessibilityIdentifier: \"SupportClawPhoneDetailBackButton\""))
    ...
    @Test func `activity screen stays split from task feature screens`() throws {
        ...
        #expect(!taskSource.contains("import SupportClawChatUI"))
    ...
    @Test func `routed feature chrome stays split from task feature screens`() throws {
        ...
        #expect(chromeSource.contains("SupportClawSidebarHeaderLeadingSlot(action: headerLeadingAction)"))
        #expect(chromeSource.contains("SupportClawGatewayCompactPill()"))
    ...
    @Test func `routed gateway pills open gateway settings`() throws {
        ...
        #expect(agentOverviewSource.contains("SupportClawGatewayCompactPill()"))
    ...
    @Test func `gateway settings keeps pairing trust diagnostics and tailscale actions`() throws {
        ...
        #expect(actionsSource.contains("Run /pair approve in your SupportClaw chat"))
    ...
    @Test func `gateway settings preview matrix covers primary states`() throws {
        ...
        #expect(supportSource.contains("Run /pair approve in your SupportClaw chat"))
    ...
    private static func proComponentsSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Sources/Design/SupportClawProComponents.swift")
    }
    ...
    private static func docsSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("Sources/Design/SupportClawDocsScreen.swift")
    }
    ...
    private static func sharedChatPreviewSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            ...
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("shared/SupportClawKit/Sources/SupportClawChatUI/ChatView+Previews.swift")
    }
    ...
    private static func xcodeProjectSourceURL() -> URL {
        URL(fileURLWithPath: #filePath)
            .deletingLastPathComponent()
            .deletingLastPathComponent()
            .appendingPathComponent("SupportClaw.xcodeproj/project.pbxproj")
    }

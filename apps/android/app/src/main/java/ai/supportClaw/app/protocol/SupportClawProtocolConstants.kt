...
/** Capability ids advertised by the Android node to the SupportClaw gateway. */
enum class SupportClawCapability(
  val rawValue: String,
) {
  Canvas("canvas"),
  Camera("camera"),
...
enum class SupportClawCanvasCommand(
  val rawValue: String,
) {
...
enum class SupportClawCanvasA2UICommand(
  val rawValue: String,
) {
...
enum class SupportClawCameraCommand(
  val rawValue: String,
) {
  List("camera.list"),
  Snap("camera.snap"),
...
enum class SupportClawSmsCommand(
  val rawValue: String,
) {
  Send("sms.send"),
  Search("sms.search"),
...
enum class SupportClawTalkCommand(
  val rawValue: String,
) {
...
enum class SupportClawLocationCommand(
  val rawValue: String,
) {
  Get("location.get"),
  ;
...
enum class SupportClawDeviceCommand(
  val rawValue: String,
) {
...
enum class SupportClawNotificationsCommand(
  val rawValue: String,
) {
...
enum class SupportClawSystemCommand(
  val rawValue: String,
) {
...
enum class SupportClawPhotosCommand(
  val rawValue: String,
) {
...
enum class SupportClawContactsCommand(
  val rawValue: String,
) {
...
enum class SupportClawCalendarCommand(
  val rawValue: String,
) {
...
enum class SupportClawMotionCommand(
  val rawValue: String,
) {
...
enum class SupportClawCallLogCommand(
  val rawValue: String,
) {

...
import ai.supportClaw.app.ui.mobileAccentBorderStrong
...
import ai.supportClaw.app.ui.mobileHeadline
import ai.supportClaw.app.ui.mobileSurface
import ai.supportClaw.app.ui.mobileText
import ai.supportClaw.app.ui.mobileTextSecondary
import ai.supportClaw.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.supportClaw.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.supportClaw.app.ui.mobileFontFamily,

...
internal fun SkillsSettingsScreen(
  ...
  SettingsDetailFrame(
    title = "Skills",
    subtitle = "Installed capabilities available to SupportClaw.",
...
private fun skillSourceLabel(skill: GatewaySkillSummary): String =
  when (skill.source) {
    "supportClaw-bundled" -> if (skill.bundled) "Built-in" else "Bundled"
    "supportClaw-managed" -> "Installed"
    "supportClaw-workspace" -> "Workspace"
    "supportClaw-extra" -> "Extra"
    else -> "Skill"
  }

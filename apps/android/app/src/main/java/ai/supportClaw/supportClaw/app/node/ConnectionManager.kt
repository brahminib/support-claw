...
import ai.supportClaw.app.gateway.GatewayClientInfo
import ai.supportClaw.app.gateway.GatewayConnectOptions
import ai.supportClaw.app.gateway.GatewayEndpoint
import ai.supportClaw.app.gateway.GatewayTlsParams
...
class ConnectionManager(
  ...
  fun buildUserAgent(): String {
    ...
    return "SupportClawAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "supportClaw-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      commands = emptyList(),
      permissions = emptyMap(),
      client = buildClientInfo(clientId = "supportClaw-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )

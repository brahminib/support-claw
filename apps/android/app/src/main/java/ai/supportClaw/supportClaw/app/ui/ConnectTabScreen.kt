      ...
      Surface(
        ...
        Column(
          ...
          if (pairingRequired) {
            ...
            CommandBlock("supportClaw devices list")
            CommandBlock("supportClaw devices approve <requestId>")
          }
          Text("SupportClaw Android ${supportClawAndroidVersionLabel()}", style = mobileCaption1, color = mobileTextSecondary)
          Button(
            onClick = {
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          CommandBlock("supportClaw qr --setup-code-only")
          CommandBlock("supportClaw qr --json")
          Text(
...
private fun gatewayPairingInstruction(problem: GatewayConnectionProblem?): String =
  if (problem?.canAutoRetry == true) {
    "Approve this phone on the gateway. SupportClaw will reconnect automatically."
  } else {

...
const val actionAskSupportClaw = "ai.supportClaw.app.action.ASK_SUPPORT_CLAW"

/** Debug action that opens the Voice tab directly for Android E2E automation. */
const val actionOpenVoiceE2e = "ai.supportClaw.app.debug.OPEN_VOICE_E2E"

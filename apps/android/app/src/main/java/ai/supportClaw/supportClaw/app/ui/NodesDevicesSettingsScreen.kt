...
import ai.supportClaw.app.GatewayDeviceTokenSummary
import ai.supportClaw.app.GatewayNodeApprovalState
import ai.supportClaw.app.GatewayNodeSummary
import ai.supportClaw.app.GatewayNodesDevicesSummary
import ai.supportClaw.app.GatewayPairedDeviceSummary
import ai.supportClaw.app.GatewayPendingDeviceSummary
...
private fun nodeSubtitle(node: GatewayNodeSummary): String {
  ...
  val version = node.version?.let { "SupportClaw $it" }

...
struct MacGatewayChatTransportMappingTests {
    @Test func `snapshot maps to health`() {
        let snapshot = Snapshot(
            presence: [],
            health: SupportClawProtocol.AnyCodable(["ok": SupportClawProtocol.AnyCodable(false)]),
    ...
    @Test func `health event maps to health`() {
        let frame = EventFrame(
            type: "event",
            event: "health",
            payload: SupportClawProtocol.AnyCodable(["ok": SupportClawProtocol.AnyCodable(true)]),
            seq: 1,
            stateversion: nil)
    ...
    @Test func `chat event maps to chat`() {
        let payload = SupportClawProtocol.AnyCodable([
            "runId": SupportClawProtocol.AnyCodable("run-1"),
            "sessionKey": SupportClawProtocol.AnyCodable("main"),
            "state": SupportClawProtocol.AnyCodable("final"),
        ])
    ...
    @Test func `session message event maps to session message`() {
        let payload = SupportClawProtocol.AnyCodable([
            "sessionKey": SupportClawProtocol.AnyCodable("agent:main:main"),
            "messageId": SupportClawProtocol.AnyCodable("msg-1"),
            "messageSeq": SupportClawProtocol.AnyCodable(7),
            "message": SupportClawProtocol.AnyCodable([
                "role": SupportClawProtocol.AnyCodable("user"),
                "content": SupportClawProtocol.AnyCodable([
                    SupportClawProtocol.AnyCodable([
                        "type": SupportClawProtocol.AnyCodable("text"),
                        "text": SupportClawProtocol.AnyCodable("spoken transcript"),
                    ]),
                ]),
                "timestamp": SupportClawProtocol.AnyCodable(1234.5),
            ]),
        ])
    ...
    @Test func `unknown event maps to nil`() {
        let frame = EventFrame(
            type: "event",
            event: "unknown",
            payload: SupportClawProtocol.AnyCodable(["a": SupportClawProtocol.AnyCodable(1)]),
            seq: 1,
            stateversion: nil)
        let mapped = MacGatewayChatTransport.mapPushToTransportEvent(.event(frame))
        #expect(mapped == nil)

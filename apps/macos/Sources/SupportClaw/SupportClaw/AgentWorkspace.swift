...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.supportClaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return SupportClawConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - SupportClaw Workspace
    ...
    static func defaultBootstrapTemplate() -> String {
        ...
        3) ~/.supportClaw/supportClaw.json

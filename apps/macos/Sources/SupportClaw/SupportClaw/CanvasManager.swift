...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.supportClaw", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("SupportClaw/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__supportClaw__/a2ui/").absoluteString + "?platform=macos"
    }

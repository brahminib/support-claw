...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .supportClawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? SupportClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? SupportClawPaths.stateDirURL.path
...
private struct SettingsTabGroup: Identifiable {
    ...
    static func defaultGroups(showDebug: Bool) -> [SettingsTabGroup] {
        var groups = [
            ...
            SettingsTabGroup(title: "SupportClaw", tabs: [.about]),
        ]
...
extension Notification.Name {
    static let supportClawSelectSettingsTab = Notification.Name("supportClawSelectSettingsTab")
}

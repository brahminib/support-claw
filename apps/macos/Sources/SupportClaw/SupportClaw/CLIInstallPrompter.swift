...
final class CLIInstallPrompter {
    ...
    private let logger = Logger(subsystem: "ai.supportClaw", category: "cli.prompt")
    ...
    func checkAndPromptIfNeeded(reason: String) {
        ...
        let alert = NSAlert()
        alert.messageText = "Install SupportClaw CLI?"
    ...
    private func openSettings(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .supportClawSelectSettingsTab, object: tab)
        }
    }

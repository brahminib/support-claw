...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "ai.supportClaw", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> SupportClawSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: SupportClawSessionPreviewEntry,
    ...
    private static func cache(payload: SupportClawSessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: SupportClawChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
        let raw: [SupportClawKit.AnyCodable] = payload.messages ?? []
    ...
    private static func decodeMessages(_ raw: [SupportClawKit.AnyCodable]) -> [SupportClawChatMessage] {
    ...
    private static func previewText(for message: SupportClawChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: SupportClawChatMessage) -> Bool {
    ...
    private static func toolNames(for message: SupportClawChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: SupportClawChatMessage) -> String? {

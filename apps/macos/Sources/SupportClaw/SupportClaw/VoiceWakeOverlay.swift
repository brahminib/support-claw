...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.supportClaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other SupportClaw windows, but below the system’s pop-up menus.

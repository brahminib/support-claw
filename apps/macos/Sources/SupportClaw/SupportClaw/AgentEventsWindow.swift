...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: SupportClawProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": SupportClawProtocol.AnyCodable("start"),
                "name": SupportClawProtocol.AnyCodable("bash"),
            ],
            summary: nil)

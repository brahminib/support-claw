...
enum UIStrings {
    static let welcomeTitle = "Welcome to SupportClaw"
}
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: SupportClawChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g supportClaw@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: SupportClawChatViewModel(

...
struct SupportClawApp: App {
    ...
    private static let logger = Logger(subsystem: "ai.supportClaw", category: "app")
    ...
    var body: some Scene {
        ...
        Window("SupportClaw Settings", id: SettingsWindowOpener.windowID) {
    ...
    private func applyStatusItemAppearance(paused _: Bool, sleeping _: Bool) {
        ...
        self.statusItem?.button?.toolTip = self.state.voiceWakeMeterActive
            ? "SupportClaw - Voice Wake live meter active"
            : "SupportClaw"
    }
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let webChatAutoLogger = Logger(subsystem: "ai.supportClaw", category: "Chat")

...
enum LaunchAgentManager {
    private static var plistURL: URL {
        FileManager().homeDirectoryForCurrentUser
            .appendingPathComponent("Library/LaunchAgents/ai.supportClaw.mac.plist")
    }
    ...
    static func plistContents(bundlePath: String) -> String {
        ...
        <dict>
          <key>Label</key>
          <string>ai.supportClaw.mac</string>
          <key>ProgramArguments</key>
          <array>
            <string>\(bundlePath)/Contents/MacOS/SupportClaw</string>
          </array>

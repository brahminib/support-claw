...
private let onboardingWizardLogger = Logger(subsystem: "ai.supportClaw", category: "onboarding.wizard")

// MARK: - Swift 6 AnyCodable Bridging Helpers

// Bridge between SupportClawProtocol.AnyCodable and the local module to avoid
// Swift 6 strict concurrency type conflicts.

private typealias ProtocolAnyCodable = SupportClawProtocol.AnyCodable

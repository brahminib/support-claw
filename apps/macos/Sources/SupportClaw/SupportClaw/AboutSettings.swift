...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/brahminib/support-claw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/brahminib/support-claw")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://supportClaw.ai")
            ...
            Text("© 2026 SupportClaw Foundation — MIT License.")
                .font(.footnote)
                .foregroundStyle(.secondary)
                .padding(.top, 4)
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "SupportClawBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SupportClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "SupportClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SupportClawGitCommit") as? String) ??
            "unknown"
    }

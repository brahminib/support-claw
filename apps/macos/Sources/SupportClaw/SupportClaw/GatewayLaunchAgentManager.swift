...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.supportClaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".supportClaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
        ...
        quiet: Bool) async -> CommandResult
    {
        ...
        #endif
        let command = CommandResolver.supportClawCommand(
            subcommand: "gateway",

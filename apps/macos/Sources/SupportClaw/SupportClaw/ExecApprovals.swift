...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.supportClaw", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        SupportClawPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        SupportClawPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }

    private static func legacyStateDirURLs() -> [URL] {
        if let home = SupportClawEnv.path("SUPPORT_CLAW_HOME") {
            var urls = [
                URL(fileURLWithPath: home, isDirectory: true)
                    .appendingPathComponent(".supportClaw", isDirectory: true),
            ]
    ...
    private static func legacyFileURLIfPending() -> URL? {
        guard SupportClawEnv.path("SUPPORT_CLAW_STATE_DIR") != nil else { return nil }
    ...
    private static func ensureSecureStateDirectory() {
        let url = SupportClawPaths.stateDirURL
        do {

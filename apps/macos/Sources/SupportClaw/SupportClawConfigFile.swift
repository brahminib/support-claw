...
enum SupportClawConfigFile {
    private static let logger = Logger(subsystem: "ai.supportClaw", category: "config")
    ...
    static func url() -> URL {
        SupportClawPaths.configURL
    }

    static func stateDirURL() -> URL {
        SupportClawPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        SupportClawPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-supportClaw-config-file",
            "event": "config.write",

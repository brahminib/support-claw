...
const openAiCodexTokenRefreshTestHook = "__SUPPORT_CLAW_TEST_REFRESH_OPENAI_CODEX_TOKEN__";
...
// arbitrary SUPPORT_CLAW_BUNDLED_PLUGINS_DIR overrides unless this Vitest-only opt-in is present.

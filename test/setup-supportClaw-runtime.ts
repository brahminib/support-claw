// SupportClaw runtime test setup installs runtime mocks and cleanup.
...
const WORKER_RUNTIME_STATE = Symbol.for("supportClaw.testSetupRuntimeState");
const WORKER_PLUGIN_RUNTIME_HELPERS = Symbol.for("supportClaw.testSetupPluginRuntimeHelpers");
const WORKER_CLEANUP_HELPERS = Symbol.for("supportClaw.testSetupCleanupHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: SupportClawConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;

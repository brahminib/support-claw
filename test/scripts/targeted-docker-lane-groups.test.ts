    ...
    expect(
      planTargetedDockerLaneGroups({
        ...
        upgradeSurvivorBaselines:
          "supportClaw@2026.5.3-1 supportClaw@2026.5.3 supportClaw@2026.5.2 supportClaw@2026.4.23",
      }),
    ).toEqual([
      {
        docker_lanes: "doctor-switch update-channel-switch",
      ...
      },
      {
        ...
        published_upgrade_survivor_baselines: "supportClaw@2026.5.3-1",
      },
      {
        docker_lanes: "published-upgrade-survivor",
      ...
      },
      {
        ...
        published_upgrade_survivor_baselines: "supportClaw@2026.5.2",
      },
      {
        docker_lanes: "published-upgrade-survivor",
        label: "published-upgrade-survivor-2026.4.23",
        published_upgrade_survivor_baselines: "supportClaw@2026.4.23",
      },
  ...
  it("leaves a single baseline on the normal logical lane", () => {
    expect(
      planTargetedDockerLaneGroups({
        ...
        upgradeSurvivorBaselines: "supportClaw@2026.5.2",
      }),
    ).toEqual([

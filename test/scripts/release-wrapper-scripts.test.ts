...
const UNKNOWN_PACKAGE = "@supportclaw/not-a-real-release-wrapper-test-package";
...
describe("release wrapper scripts", () => {
  ...
  it("loads the SupportClaw ClawHub plan CLI and validates required arguments before planning", () => {
    const result = runTsxScript("scripts/supportClaw-release-clawhub-plan.ts", [
      "--release-tag",
      "v2026.6.21-beta.1",

...
const resolverPath = path.resolve("scripts/secrets/supportClaw-bws-resolver.mjs");

function makeTempDir(): string {
  const dir = mkdtempSync(path.join(tmpdir(), "supportClaw-bws-resolver-"));
  tempDirs.push(dir);
  return dir;
}
...
describe("supportClaw-bws-resolver", () => {

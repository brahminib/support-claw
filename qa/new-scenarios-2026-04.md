...
- Code: `.agents/skills/supportClaw-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Code: `src/agents/supportClaw-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`

...
function renderServerRow(props: McpViewProps, server: McpServerRow) {
  ...
  const probeCommand = `supportClaw mcp probe ${quotedName}`;
  const loginCommand = `supportClaw mcp login ${quotedName}`;
  return html`
    ...
    <section class="mcp-page">
      ...
      <section class="card mcp-command-card">
        ...
        <div class="mcp-command-card__grid">
          <code>supportClaw mcp status --verbose</code>
          <code>supportClaw mcp doctor --probe</code>
          <code>supportClaw mcp login &lt;name&gt;</code>
          <code>supportClaw mcp reload</code>
        </div>
      </section>

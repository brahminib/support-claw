...
export class SupportClawModalDialog extends LitElement {
  @property() label = "";
  ...
  override render() {
    const labelId = this.label ? "supportclaw-modal-dialog-label" : "";
    const descriptionId = this.description ? "supportclaw-modal-dialog-description" : "";
    return html`
      <dialog
        role="dialog"
        aria-modal="true"
...
if (!customElements.get("supportclaw-modal-dialog")) {
  customElements.define("supportclaw-modal-dialog", SupportClawModalDialog);
}

declare global {
  interface HTMLElementTagNameMap {
    "supportclaw-modal-dialog": SupportClawModalDialog;
  }
}

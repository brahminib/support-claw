...
export class SupportClawFilePreviewModal extends LitElement {
...
if (!customElements.get("supportclaw-file-preview-modal")) {
  customElements.define("supportclaw-file-preview-modal", SupportClawFilePreviewModal);
}
...
declare global {
  interface HTMLElementTagNameMap {
    "supportclaw-file-preview-modal": SupportClawFilePreviewModal;
  }
}

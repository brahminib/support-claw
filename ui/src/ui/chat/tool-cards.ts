...
function resolveTranscriptMessageId(message: Record<string, unknown>): string | undefined {
  ...
  const supportClawMeta = message["__supportClaw"];
  const transcriptMeta =
    supportClawMeta && typeof supportClawMeta === "object" && !Array.isArray(supportClawMeta)
      ? (supportClawMeta as Record<string, unknown>)
      : null;

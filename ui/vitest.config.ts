...
const workspaceSourceAliases = [
  ...
  {
    find: "supportClaw/plugin-sdk/test-fixtures",
    replacement: path.resolve(repoRoot, "src/plugin-sdk/test-fixtures.ts"),
  },
  {
    find: /^@supportclaw\/model-catalog-core\/(.+)$/u,
  ...
  {
    find: /^@supportclaw\/normalization-core\/(.+)$/u,

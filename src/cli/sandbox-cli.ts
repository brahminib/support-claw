...
const SANDBOX_EXAMPLES = {
  main: [
    ["supportClaw sandbox list", "List all sandbox containers."],
    ["supportClaw sandbox list --browser", "List only browser containers."],
    ["supportClaw sandbox recreate --all", "Recreate all containers."],
    ["supportClaw sandbox recreate --session main", "Recreate a specific session."],
    ["supportClaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["supportClaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["supportClaw sandbox list", "List all sandbox containers."],
    ["supportClaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["supportClaw sandbox recreate --all", "Recreate all containers."],
    ["supportClaw sandbox recreate --session main", "Recreate a specific session."],
    ["supportClaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["supportClaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["supportClaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["supportClaw sandbox explain", "Show effective sandbox config."],
    ["supportClaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["supportClaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["supportClaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.supportClaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {

...
function resolveFetchConfig(config: SupportClawConfig): Record<string, unknown> | undefined {
...
function resolveSearchConfig(config: SupportClawConfig): Record<string, unknown> | undefined {
...
function getCapabilityWebSearchAutoDetectTargets(config: SupportClawConfig): CommandSecretTargetScope {
...
function getCapabilityWebFetchAutoDetectTargets(config: SupportClawConfig): CommandSecretTargetScope {
  return getCapabilityWebProviderAutoDetectTargets({
    config,
...
function isScopedChannelSecretTargetEntry(params: {
  ...
  return (
    ...
    params.entry.configFile === "supportClaw.json" &&
...
type CapabilityWebCommandSecretTargetParams = {
  ...
  autoDetectTargets: (config: SupportClawConfig) => CommandSecretTargetScope;
  selectedProviderTargetIds: (
    config: SupportClawConfig,
    providerId?: string | null,
  ) => SelectedProviderTargetIds;

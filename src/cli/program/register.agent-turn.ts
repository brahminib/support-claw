...
/** Register `supportClaw agent` for one Gateway-backed agent turn. */
...
${formatHelpExamples([
  ['supportClaw agent --to +15555550123 --message "status update"', "Start a new session."],
  ['supportClaw agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  ["supportClaw agent --agent ops --message-file ./task.md", "Read a multiline message file."],
  [
  ...
  ['supportClaw agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
...
${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.supportClaw.ai/cli/agent")}`,
    )

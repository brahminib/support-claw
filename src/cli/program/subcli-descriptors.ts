...
const subCliCommandCatalog = defineCommandDescriptorCatalog([
  ...
  {
    name: "gateway",
    description: "Run, inspect, and query the SupportClaw Gateway",
    hasSubcommands: true,
  },
  {
    name: "daemon",
  ...
  {
    name: "docs",
    description: "Search the live SupportClaw docs",
    hasSubcommands: false,
  },
  {
    name: "qa",
  ...
  {
    name: "proxy",
    description: "Run the SupportClaw debug proxy and inspect captured traffic",
    hasSubcommands: true,
  },
  {
    name: "hooks",

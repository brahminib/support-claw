    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["supportClaw", "Start Crestodian."],
          ["supportClaw crestodian", "Start Crestodian explicitly."],
          ['supportClaw crestodian -m "status"', "Run one status request."],
          [
            'supportClaw crestodian -m "set default model openai/gpt-5.2" --yes',

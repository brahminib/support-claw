...
/** Parse `supportClaw health` flags for the route-first status family. */
...
/** Parse `supportClaw status` flags without registering the full command tree. */
...
/** Parse `supportClaw gateway status` RPC-only flags accepted by the fast route. */
...
/** Parse `supportClaw sessions` filters for JSON/list route execution. */
...
/** Parse `supportClaw agents list` display switches for route-first execution. */
...
/** Parse `supportClaw config get <path>` while preserving root option handling. */
...
/** Parse `supportClaw config unset <path>` and its mutation guard flags. */
...
/** Parse `supportClaw models list` filters for the lightweight model catalog route. */
...
/** Parse `supportClaw models status` probe controls for the route-first status path. */
...
/** Parse `supportClaw channels list` display flags for the route-first list path. */
...
/** Parse `supportClaw channels status` probe flags without full CLI registration. */
...
/** Parse JSON-only `supportClaw plugins list` flags for plugin inventory output. */
...
/** Parse both `supportClaw tasks --json` and `supportClaw tasks list --json` aliases. */
...
/** Parse JSON-only `supportClaw tasks audit` filters for the route-first audit path. */

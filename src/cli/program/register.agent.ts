...
export function registerAgentsCommands(program: Command): void {
  const agents = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/agents", "docs.supportClaw.ai/cli/agents")}\n`,
    );
...
${formatHelpExamples([
  ['supportClaw agents set-identity --agent main --name "SupportClaw" --emoji "🦞"', "Set name + emoji."],
  ["supportClaw agents set-identity --agent main --avatar avatars/supportClaw.png", "Set avatar path."],
  [
    "supportClaw agents set-identity --workspace ~/.supportClaw/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "supportClaw agents set-identity --identity-file ~/.supportClaw/workspace/IDENTITY.md --agent main",

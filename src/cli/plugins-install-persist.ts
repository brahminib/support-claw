...
function addInstalledPluginToAllowlist(cfg: SupportClawConfig, pluginId: string): SupportClawConfig {
...
function removeInstalledPluginFromDenylist(cfg: SupportClawConfig, pluginId: string): SupportClawConfig {
  ...
  params.runtime.log(
    theme.warn(
      [
        ...
        "Run `supportClaw plugins doctor` for repair options.",
      ].join("\n"),
    ),
  );
}

      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["supportClaw gateway run", "Run the gateway in the foreground."],
            ["supportClaw gateway status", "Show service status plus connectivity/capability."],
            ["supportClaw gateway discover", "Find local and wide-area gateway beacons."],
            ["supportClaw gateway stability", "Show recent stability diagnostics."],
            ["supportClaw gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.supportClaw.ai/cli/gateway")}\n`,
      ),
  );

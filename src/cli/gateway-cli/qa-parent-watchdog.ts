...
export const QA_PARENT_PID_ENV = "SUPPORT_CLAW_QA_PARENT_PID";
export const QA_TEMP_ROOT_ENV = "SUPPORT_CLAW_QA_TEMP_ROOT";
export const QA_STAGED_RUNTIME_ROOT_ENV = "SUPPORT_CLAW_QA_STAGED_RUNTIME_ROOT";

const DEFAULT_QA_PARENT_WATCHDOG_INTERVAL_MS = 1000;
const QA_TEMP_ROOT_PREFIX = "supportClaw-qa-suite-";

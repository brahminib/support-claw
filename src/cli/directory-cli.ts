    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["supportClaw directory self --channel slack", "Show the connected account identity."],
          [
            'supportClaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["supportClaw directory groups list --channel discord", "List available groups/channels."],
          [
            "supportClaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.supportClaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {

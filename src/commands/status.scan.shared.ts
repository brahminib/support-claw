...
function hasExplicitMemorySearchConfig(cfg: SupportClawConfig, agentId: string): boolean {
...
export function resolveMemoryPluginStatus(cfg: SupportClawConfig): MemoryPluginStatus {

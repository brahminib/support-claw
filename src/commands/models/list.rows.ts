/** Row builders used by `supportClaw models list` source orchestration. */
...
function toFallbackConfiguredListModel(entry: ConfiguredEntry, cfg: SupportClawConfig): ListRowModel {
  return (

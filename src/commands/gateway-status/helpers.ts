...
import type { SupportClawConfig, ConfigFileSnapshot } from "../../config/types.js";
...
/** Extracts the config fields displayed by `supportClaw gateway status --deep`. */
...
export function buildNetworkHints(cfg: SupportClawConfig, localPortOverride?: number) {

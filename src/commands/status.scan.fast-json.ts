// Fast `supportClaw status --json` scan policy.
...
type StatusJsonScanPolicy = {
  ...
  gatewayProbeTimeoutMs?: number | ((cfg: SupportClawConfig) => number | undefined);
...
function hasExplicitStatusJsonChannelConfig(cfg: SupportClawConfig): boolean {
...
function hasPotentialConfiguredChannelsForStatusJson(cfg: SupportClawConfig): boolean {

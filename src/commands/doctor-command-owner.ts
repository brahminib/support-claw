...
function resolveConfiguredCommandOwners(cfg: SupportClawConfig): string[] {
...
export function hasConfiguredCommandOwners(cfg: SupportClawConfig): boolean {
...
export function noteCommandOwnerHealth(cfg: SupportClawConfig): void {
  ...
  note(
    [
      ...
      `Fix: set commands.ownerAllowFrom to your channel user id, for example ${formatCliCommand("supportClaw config set commands.ownerAllowFrom '[\"telegram:123456789\"]'")}`,

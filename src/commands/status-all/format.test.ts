...
describe("status-all format", () => {
  ...
  it("formats dashboard values consistently", () => {
    expect(formatStatusDashboardValue("https://supportClaw.local")).toBe("https://supportClaw.local");
  ...
  it("builds overview rows with shared ordering", () => {
    expect(
      buildStatusOverviewRows({
        ...
        dashboardValue: "https://supportClaw.local",
        ...
        middleRows: [{ Item: "Security", Value: "Run: supportClaw security audit --deep" }],
      ...
      { Item: "Dashboard", Value: "https://supportClaw.local" },
      ...
      { Item: "Security", Value: "Run: supportClaw security audit --deep" },

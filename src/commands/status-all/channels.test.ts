      ...
      rows: [
        {
          ...
          state: "warn",
          detail:
            "plugin not installed - run supportClaw plugins install @supportclaw/feishu or supportClaw doctor --fix",
        },
      ],
      details: [],
    });
      ...
      rows: [
        {
          ...
          enabled: true,
          state: "warn",
          detail: "plugin load failed: dependency tree corrupted; run supportClaw doctor --fix",
        },
      ],
      details: [],
    });

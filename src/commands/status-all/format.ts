...
export function formatStatusServiceValue(params: {
  ...
  const installedPrefix = params.managedBySupportClaw ? "installed · " : "";
...
export function resolveStatusDashboardUrl(params: {
  cfg: Pick<SupportClawConfig, "gateway">;
}): string | null {
...
export function buildStatusOverviewSurfaceRows(params: {
  cfg: Pick<SupportClawConfig, "update" | "gateway">;
  update: StatusUpdateLike;
  tailscaleMode: string;
...
export function buildStatusGatewaySurfaceValues(params: {
  ...
  return {
    ...
    gatewayServiceValue: formatStatusServiceValue({
      ...
      managedBySupportClaw: params.gatewayService.managedBySupportClaw,
    ...
    nodeServiceValue: formatStatusServiceValue({
      ...
      managedBySupportClaw: params.nodeService.managedBySupportClaw,
...
/** Builds the stable gateway object used by `supportClaw status --json`. */

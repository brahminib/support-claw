...
function resolveEffectiveTrustConfig(cfg: SupportClawConfig, env?: NodeJS.ProcessEnv): SupportClawConfig {
...
function resolveTrustedCatalogExtraPaths(cfg: SupportClawConfig): string[] | undefined {

...
function resolveHeartbeatConfig(cfg: SupportClawConfig, agentId: string): HeartbeatConfig | undefined {
...
function listHeartbeatDoctorAgents(cfg: SupportClawConfig) {
 ...
 */
export function describeHeartbeatSessionTargetIssues(cfg: SupportClawConfig): string[] {

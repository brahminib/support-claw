...
function configWithEngine(engineId: string, cfg: SupportClawConfig = {}): SupportClawConfig {
  return {
    ...cfg,
    plugins: {
      ...cfg.plugins,
...
describe("doctor context-engine host compatibility", () => {
  it("collects native Codex and SupportClaw as compatible agent-run hosts", () => {

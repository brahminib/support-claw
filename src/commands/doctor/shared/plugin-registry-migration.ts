...
export const DISABLE_PLUGIN_REGISTRY_MIGRATION_ENV = "SUPPORT_CLAW_DISABLE_PLUGIN_REGISTRY_MIGRATION";
export const FORCE_PLUGIN_REGISTRY_MIGRATION_ENV = "SUPPORT_CLAW_FORCE_PLUGIN_REGISTRY_MIGRATION";
...
export type PluginRegistryInstallMigrationParams = LoadInstalledPluginIndexParams &
  InstalledPluginIndexStoreOptions & {
    ...
    readConfig?: () => Promise<SupportClawConfig> | SupportClawConfig;
  };
...
function listConfiguredChannelIds(config: SupportClawConfig): Set<string> {
...
function listConfiguredModelProviderIds(config: SupportClawConfig): Set<string> {
...
export async function migratePluginRegistryForInstall(
  ...
  const config = stripShippedPluginInstallConfigRecords(rawConfig) as SupportClawConfig;

...
export const UPDATE_IN_PROGRESS_ENV = "SUPPORT_CLAW_UPDATE_IN_PROGRESS";
export const UPDATE_POST_CORE_CONVERGENCE_ENV = "SUPPORT_CLAW_UPDATE_POST_CORE_CONVERGENCE";
 ...
 * `SUPPORT_CLAW_UPDATE_IN_PROGRESS` directly (`commands/doctor-update.ts`,
 ...
 * `SUPPORT_CLAW_UPDATE_IN_PROGRESS`, so configured plugin repair must happen now.
 */

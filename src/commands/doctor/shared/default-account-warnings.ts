...
export function collectMissingDefaultAccountBindingWarnings(cfg: SupportClawConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: SupportClawConfig): string[] {
  const warnings: string[] = [];

...
function collectToolAllowlistSources(cfg: SupportClawConfig): ToolAllowlistSource[] {
...
function collectConfiguredMcpServerNames(cfg: SupportClawConfig): string[] {
...
function collectSandboxMcpAllowlistWarnings(cfg: SupportClawConfig): string[] {

...
export function scanLegacyToolsBySenderKeys(cfg: SupportClawConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: SupportClawConfig): {

...
import type { LegacyConfigIssue, SupportClawConfig } from "../../../config/types.js";
import {
...
function collectPluginLegacyConfigRules(
  ...
  return listPluginDoctorLegacyConfigRules({ config: raw as SupportClawConfig, pluginIds });
}

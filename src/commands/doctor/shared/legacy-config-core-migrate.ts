...
function repairNullAgentWorkspaces(cfg: SupportClawConfig, changes: string[]): SupportClawConfig {
...
function pruneBindingsForMissingAgents(cfg: SupportClawConfig, changes: string[]): SupportClawConfig {
  const agents = cfg.agents?.list;
...
export function normalizeCompatibilityConfigValues(cfg: SupportClawConfig): {

...
function recoveryHintForGatewayHealthFailure(
  ...
  switch (classification) {
    case "auth-mismatch":
      return "Fix: run `supportClaw doctor --fix`.";
    case "module-missing":
      return "Fix: run `supportClaw doctor --fix`.";
    case "service-missing":
      return "Fix: run `supportClaw gateway install --force`.";
    case "service-stopped":
      return "Fix: run `supportClaw gateway restart`.";
    case "startup-blocked":
      return "Fix: run `supportClaw gateway status --deep`.";
    case "not-listening":
      return "Fix: start `supportClaw gateway run`, or run `supportClaw gateway restart` for a managed gateway.";
    default:
      return undefined;
  }
}

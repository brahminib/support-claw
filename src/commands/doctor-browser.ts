...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: SupportClawConfig, deps?: BrowserDoctorDeps) => Promise<void>;
...
export async function noteChromeMcpBrowserReadiness(cfg: SupportClawConfig, deps?: BrowserDoctorDeps) {
  try {

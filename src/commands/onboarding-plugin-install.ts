...
import { isSupportClawOrgNpmSpec, parseRegistryNpmSpec } from "../infra/npm-registry-spec.js";
...
function shouldFallbackClawHubToNpm(params: {
  ...
  // Only official SupportClaw npm packages are safe fallback targets for ClawHub
...
function addPluginLoadPath(cfg: SupportClawConfig, pluginPath: string): SupportClawConfig {

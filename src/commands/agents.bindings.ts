...
import { normalizeSortedUniqueStringEntries } from "@supportclaw/normalization-core/string-normalization";
...
function resolveDefaultAccountId(cfg: SupportClawConfig, provider: ChannelId): string {
...
function listManifestChannelIds(config: SupportClawConfig): Set<string> {
  return new Set(

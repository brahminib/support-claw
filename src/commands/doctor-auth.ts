...
function hasConfiguredCodexOAuthProfile(cfg: SupportClawConfig): boolean {
...
export function noteLegacyCodexProviderOverride(cfg: SupportClawConfig): void {
...
function listAuthProfileHealthTargets(cfg: SupportClawConfig): AuthProfileHealthTarget[] {

/** Doctor contribution for low disk space around the SupportClaw state directory. */
 ...
 *
 * This catches a common operational failure mode where SupportClaw silently
...
export function noteDiskSpace(
  _cfg: SupportClawConfig, // reserved for API consistency with other Doctor contributions
  deps?: {

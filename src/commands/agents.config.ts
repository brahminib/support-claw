// Agent config mutation and summary builders used by `supportClaw agents` commands.
import {
...
function resolveAgentModel(cfg: SupportClawConfig, agentId: string) {
...
export function buildAgentSummaries(cfg: SupportClawConfig): AgentSummary[] {

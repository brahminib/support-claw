...
import { normalizeStringEntriesLower } from "@supportclaw/normalization-core/string-normalization";
...
function resolveSessionAgentId(cfg: SupportClawConfig, sessionKey: string): string {

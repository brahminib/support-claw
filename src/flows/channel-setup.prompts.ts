    ...
    await prompter.note(
      [
        ...
        t("wizard.channels.dmPolicyApprove", {
          command: formatCliCommand(`supportClaw pairing approve ${policy.channel} <code>`),
        }),
        ...
        t("wizard.channels.dmPolicyMultiUser", {
          command: formatCliCommand('supportClaw config set session.dmScope "per-channel-peer"'),
        }),

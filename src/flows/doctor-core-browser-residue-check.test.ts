...
const residue = {
  legacyProfileDir: "/tmp/supportClaw-home/browser/clawd",
  legacyUserDataDir: "/tmp/supportClaw-home/browser/clawd/user-data",
  canonicalUserDataDir: "/tmp/supportClaw-home/browser/supportClaw/user-data",
};
...
describe("browser clawd profile residue health check", () => {
  ...
  it("reports legacy clawd profile residue through doctor lint", async () => {
    ...
    const cfg: SupportClawConfig = { browser: { profiles: { supportClaw: { color: "#FF4500" } } } };
    ...
    const findings = await check.detect({
      ...
      runtime: runtime(),
      cfg,
      configPath: "/tmp/supportClaw-home/supportClaw.json",
    });

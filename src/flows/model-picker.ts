...
type PromptDefaultModelResult = { model?: string; config?: SupportClawConfig };
...
function resolveConfiguredModelRaw(cfg: SupportClawConfig): string {
  return resolveAgentModelPrimaryValue(cfg.agents?.defaults?.model) ?? "";
}

function resolveConfiguredModelKeys(cfg: SupportClawConfig): string[] {

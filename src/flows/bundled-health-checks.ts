...
import { asOptionalObjectRecord as readRecord } from "@supportclaw/normalization-core/record-coerce";
...
export function registerBundledHealthChecks(params: { cfg: SupportClawConfig; cwd?: string }): void {
...
function shouldRegisterPolicyHealth(params: { cfg: SupportClawConfig; cwd?: string }): boolean {

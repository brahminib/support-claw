/** Resolves ACP request metadata into SupportClaw Gateway session keys and reset behavior. */
import { readBool, readString } from "@supportclaw/acp-core/meta";
...
/** Parses ACP request metadata into SupportClaw session routing hints. */

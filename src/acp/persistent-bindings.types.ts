...
import { normalizeText } from "@supportclaw/acp-core/normalize-text";
...
export { normalizeText } from "@supportclaw/acp-core/normalize-text";
...
export type ConfiguredAcpBindingSpec = {
  ...
  /** Owning SupportClaw agent id (used for session identity/storage). */
  agentId: string;

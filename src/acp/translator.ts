...
import { readBool, readNonNegativeInteger, readString } from "@supportclaw/acp-core/meta";
import { defaultAcpSessionStore, type AcpSessionStore } from "@supportclaw/acp-core/session";
import { toAcpSessionLineageMeta } from "@supportclaw/acp-core/session-lineage-meta";
import type { AcpServerOptions } from "@supportclaw/acp-core/types";
...
/** ACP Agent implementation backed by the SupportClaw Gateway and replay ledger. */
export class AcpGatewayAgent implements Agent {
  ...
  private assertSupportedSessionSetup(mcpServers: ReadonlyArray<unknown>): void {
    ...
    throw new Error(
      "ACP bridge mode does not support per-session MCP servers. Configure MCP on the SupportClaw gateway or agent instead.",
    );
  }

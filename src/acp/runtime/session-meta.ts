...
type AcpSessionsTable = SupportClawStateKyselyDatabase["acp_sessions"];
type AcpSessionMetaDatabase = Pick<SupportClawStateKyselyDatabase, "acp_sessions">;
...
}): { cfg: SupportClawConfig; storePath: string } {
...
function selectAcpSessionRows(options: SupportClawStateDatabaseOptions = {}): AcpSessionRow[] {

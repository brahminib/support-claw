...
import type { AcpRuntime, AcpRuntimeCapabilities } from "@supportclaw/acp-core/runtime/types";
...
export type { AcpRuntime, SupportClawConfig, SessionAcpMeta };
...
export function installAcpSessionManagerTestLifecycle(): void {
  ...
  afterEach(() => {
    if (ORIGINAL_STATE_DIR === undefined) {
      ...
      setTestEnvValue("SUPPORT_CLAW_STATE_DIR", ORIGINAL_STATE_DIR);
    }

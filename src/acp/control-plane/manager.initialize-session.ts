...
import type { AcpRuntime, AcpRuntimeHandle } from "@supportclaw/acp-core/runtime/types";
...
export async function runManagerInitializeSession(params: {
  ...
  enforceConcurrentSessionLimit: (params: { cfg: SupportClawConfig; sessionKey: string }) => void;

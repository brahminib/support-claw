...
import type {
  ...
  AcpRuntimeHandle,
  AcpRuntimeStatus,
} from "@supportclaw/acp-core/runtime/types";
...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: SupportClawConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: SupportClawConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: SupportClawConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(cfg: SupportClawConfig): Promise<void> {

...
export const en = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "Stores the password directly in SupportClaw config",
    ...
    migration: {
      ...
      complete: "Migration complete. Run `supportClaw doctor` next.",
    ...
    plugins: {
      ...
      sensitiveField:
        '"{label}" is sensitive. Set it via:\n  supportClaw config set plugins.entries.{plugin}.config.{field} <value>\nor use the Web UI Settings page.',
    ...
    remote: {
      ...
      insecureRemoteUrl:
        "Use wss:// for remote hosts, or ws://127.0.0.1/localhost via SSH tunnel. Break-glass: SUPPORT_CLAW_ALLOW_INSECURE_PRIVATE_WS=1 for trusted private networks.",
      ...
      plaintextPasswordHint: "Stores the password directly in SupportClaw config",
      plaintextPasswordLabel: "Enter password now",
      plaintextTokenHint: "Stores the token directly in SupportClaw config",
    ...
    security: {
      ...
      beta: "SupportClaw is a hobby project and still in beta. Expect sharp edges.",
      confirm:
        "I understand this is personal-by-default and shared/multi-user use requires lock-down. Continue?",
      hardeningRequired:
        "If you're not comfortable with security hardening and access control, don't run SupportClaw.",
      learnMore: "Learn more",
      notMultitenant: "SupportClaw is not a hostile multi-tenant boundary by default.",
      personalAgent: "By default, SupportClaw is a personal agent: one trusted operator boundary.",
    ...
    skills: {
      ...
      docsLine: "Docs: https://docs.supportClaw.ai/skills",
      enterEnv: "Enter {env}",
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) Run: ./occ talk:bot:install "SupportClaw" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "We need the sender/owner number so SupportClaw can allowlist you.",
      ...
      separatePhoneLabel: "Separate phone just for SupportClaw",
    ...
    irc: {
      ...
      nextStatusCommand: "Command: supportClaw channels status --probe",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "This is the URL SupportClaw uses to send replies back to Chat.",
    ...
    signal: {
      ...
      multipleEntries: "Multiple entries: comma-separated.",
      nextLinkDevice: 'Link device with: signal-cli link -n "SupportClaw"',
    ...
    twitch: {
      ...
      envPrompt: "Twitch env var SUPPORT_CLAW_TWITCH_ACCESS_TOKEN detected. Use env token?",
      ...
      helpEnvVars: "Env vars supported: SUPPORT_CLAW_TWITCH_ACCESS_TOKEN",
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "Connect your Synology NAS Chat to SupportClaw with full agent capabilities.",
    ...
    search: {
      ...
      configured: "configured",
      configureLaterHint: "Configure later with supportClaw configure --section web",
      docsLine: "Docs: {url}",
    ...
    finalize: {
      ...
      controlUiDocs: "Docs: https://docs.supportClaw.ai/web/control-ui",
      dashboardCopyPaste: "Copy/paste this URL in a browser on this machine to control SupportClaw.",
      dashboardLinkWithToken: "Dashboard link (with token): {url}",
      dashboardOpened: "Opened in your browser. Keep that tab to control SupportClaw.",
      ...
      gatewayTokenStored:
        "Stored in: $SUPPORT_CLAW_CONFIG_PATH (default: ~/.supportClaw/supportClaw.json) under gateway.auth.token, or in SUPPORT_CLAW_GATEWAY_TOKEN.",
      ...
      outroDashboardLink: "Onboarding complete. Use the dashboard link above to control SupportClaw.",
      outroDashboardOpened:
        "Onboarding complete. Dashboard opened; keep that tab to control SupportClaw.",
      outroSeeded:
      ...
      restart: "Restart",
      securityReminder:
        "Running agents on your computer is risky — harden your setup: https://docs.supportClaw.ai/security",
      ...
      webDocs: "Docs: https://docs.supportClaw.ai/tools/web",
      ...
      whatNow: 'What now: https://supportClaw.ai/showcase ("What People Are Building").',
      whatNowTitle: "What now",
      workspaceBackupTitle: "Workspace backup",
      workspaceDocs: "Docs: https://docs.supportClaw.ai/concepts/agent-workspace",

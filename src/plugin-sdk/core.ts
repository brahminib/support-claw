...
import type { SupportClawPluginApi } from "../plugins/types.js";
...
export type { SupportClawConfig } from "../config/config.js";
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: SupportClawConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (

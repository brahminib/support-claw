...
/** @deprecated Use SupportClawConfig instead */
export type { SupportClawConfig as ClawdbotConfig } from "../config/config.js";
/** @deprecated Use SupportClawConfig instead */
export type { SupportClawConfig as SupportClawSchemaType } from "../config/config.js";
export type {

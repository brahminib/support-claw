...
export function resolveSessionToolsVisibility(cfg: SupportClawConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: SupportClawConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: SupportClawConfig): AgentToAgentPolicy {

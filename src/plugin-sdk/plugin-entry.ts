...
export type SupportClawPluginApi = import("../plugins/types.js").SupportClawPluginApi;
export type SupportClawPluginCommandDefinition =
  import("../plugins/types.js").SupportClawPluginCommandDefinition;
export type SupportClawPluginConfigSchema = import("../plugins/types.js").SupportClawPluginConfigSchema;
export type SupportClawPluginDefinition = import("../plugins/types.js").SupportClawPluginDefinition;
export type SupportClawPluginHttpRouteHandler =
  import("../plugins/types.js").SupportClawPluginHttpRouteHandler;
export type SupportClawPluginNodeHostCommand =
  import("../plugins/types.js").SupportClawPluginNodeHostCommand;
export type SupportClawPluginNodeInvokePolicy =
  import("../plugins/types.js").SupportClawPluginNodeInvokePolicy;
export type SupportClawPluginNodeInvokePolicyContext =
  import("../plugins/types.js").SupportClawPluginNodeInvokePolicyContext;
export type SupportClawPluginNodeInvokePolicyResult =
  import("../plugins/types.js").SupportClawPluginNodeInvokePolicyResult;
export type SupportClawPluginReloadRegistration =
  import("../plugins/types.js").SupportClawPluginReloadRegistration;
export type SupportClawPluginSecurityAuditCollector =
  import("../plugins/types.js").SupportClawPluginSecurityAuditCollector;
export type SupportClawPluginSecurityAuditContext =
  import("../plugins/types.js").SupportClawPluginSecurityAuditContext;
export type SupportClawPluginService = import("../plugins/types.js").SupportClawPluginService;
export type SupportClawPluginServiceContext =
  import("../plugins/types.js").SupportClawPluginServiceContext;
export type SupportClawPluginToolContext = import("../plugins/types.js").SupportClawPluginToolContext;
export type SupportClawPluginToolFactory = import("../plugins/types.js").SupportClawPluginToolFactory;
...
export type SupportClawGatewayDiscoveryAdvertiseContext =
  import("../plugins/types.js").SupportClawGatewayDiscoveryAdvertiseContext;
export type SupportClawGatewayDiscoveryService =
  import("../plugins/types.js").SupportClawGatewayDiscoveryService;
...
type DefinePluginEntryOptions = {
   ...
   */
  kind?: SupportClawPluginDefinition["kind"];
  configSchema?: SupportClawPluginConfigSchema | (() => SupportClawPluginConfigSchema);
  reload?: SupportClawPluginDefinition["reload"];
  nodeHostCommands?: SupportClawPluginDefinition["nodeHostCommands"];
  securityAuditCollectors?: SupportClawPluginDefinition["securityAuditCollectors"];
  register: (api: SupportClawPluginApi) => void;
};

/** Normalized object shape that SupportClaw loads from a plugin entry module. */
type DefinedPluginEntry = {
  id: string;
  name: string;
  description: string;
  configSchema: SupportClawPluginConfigSchema;
  register: NonNullable<SupportClawPluginDefinition["register"]>;
} & Pick<
  SupportClawPluginDefinition,
 ...
 * `supportClaw/plugin-sdk/core` so they inherit the channel capability wiring.
 */

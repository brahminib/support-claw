...
export const DEFAULT_SUPPORT_CLAW_BROWSER_ENABLED = true;
...
export const DEFAULT_SUPPORT_CLAW_BROWSER_COLOR = "#FF4500";
/** Default SupportClaw-managed browser profile name. */
export const DEFAULT_SUPPORT_CLAW_BROWSER_PROFILE_NAME = "supportClaw";
/** Default browser profile selected when config omits a profile name. */
export const DEFAULT_BROWSER_DEFAULT_PROFILE_NAME = "supportClaw";
...
export const DEFAULT_UPLOAD_DIR = path.join(resolvePreferredSupportClawTmpDir(), "uploads");

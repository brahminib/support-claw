...
import {
  ...
  type SupportClawPluginApiWithoutFacades,
} from "../plugins/api-facades.js";
import type { SupportClawPluginApi } from "./plugin-runtime.js";

/** Partial plugin API overrides accepted by the SDK test helper. */
export type TestPluginApiInput = Partial<SupportClawPluginApi>;

/** Create a minimal plugin API object for plugin-sdk contract and unit tests. */
export function createTestPluginApi(api: TestPluginApiInput = {}): SupportClawPluginApi {
  ...
  const mergedApi = {
    ...
    on() {},
    ...flatApi,
  } as SupportClawPluginApiWithoutFacades;

...
import { findNormalizedProviderKey } from "@supportclaw/model-catalog-core/provider-id";
...
export type { SupportClawConfig, ModelApi, ModelDefinitionConfig, ModelProviderConfig };
export {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: SupportClawConfig, ...args: TArgs) => SupportClawConfig;
  applyConfig: (cfg: SupportClawConfig, ...args: TArgs) => SupportClawConfig;
};
...
function hasAgentDefaultModelPrimary(cfg: SupportClawConfig): boolean {
...
>(params: {
  ...
  applyPreset: (cfg: SupportClawConfig, preset: TParams) => SupportClawConfig;
  primaryModelRef: string;
...
export function applyOpencodeZenModelDefault(cfg: SupportClawConfig): {

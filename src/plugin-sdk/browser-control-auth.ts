// Browser control auth helpers resolve plugin browser credentials from SupportClaw config.
...
type BrowserControlAuthSurface = {
  resolveBrowserControlAuth: (cfg?: SupportClawConfig, env?: NodeJS.ProcessEnv) => BrowserControlAuth;

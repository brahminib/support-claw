...
/**
 * @deprecated Compatibility facade for the `supportClaw/plugin-sdk/discord` subpath.
...
export type { SupportClawConfig } from "./config-types.js";
export type { SupportClawPluginApi, PluginRuntime } from "./channel-plugin-common.js";
...
/** Discord channel config shape for one account in SupportClaw config. */
export type DiscordAccountConfig = NonNullable<NonNullable<SupportClawConfig["channels"]>["discord"]>;
...
type DiscordApiFacadeModule = {
  ...
  inspectDiscordAccount: (params: { cfg: SupportClawConfig; accountId?: string | null }) => unknown;
  listDiscordAccountIds: (cfg: SupportClawConfig) => string[];
  ...
  resolveDefaultDiscordAccountId: (cfg: SupportClawConfig) => string;
...
function resolveCompatRuntimeConfig(params: { cfg?: SupportClawConfig }): SupportClawConfig {
...
/** List configured Discord account ids from SupportClaw config. */
export function listDiscordAccountIds(cfg: SupportClawConfig): string[] {
...
export function resolveDefaultDiscordAccountId(cfg: SupportClawConfig): string {

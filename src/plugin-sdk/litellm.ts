...
import type { ModelDefinitionConfig, SupportClawConfig } from "../config/types.js";
import { loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader.js";

type FacadeModule = {
  applyLitellmConfig: (cfg: SupportClawConfig) => SupportClawConfig;
  applyLitellmProviderConfig: (cfg: SupportClawConfig) => SupportClawConfig;
...
/** Apply LiteLLM defaults to the full SupportClaw config. */

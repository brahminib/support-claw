...
describe("defineChannelMessageAdapter", () => {
  const loadPluginSdkSubpaths = async () =>
    await Promise.all([
      import("supportClaw/plugin-sdk/channel-outbound"),
      import("supportClaw/plugin-sdk/channel-message"),
      import("supportClaw/plugin-sdk/channel-message-runtime"),
      import("supportClaw/plugin-sdk/channel-reply-pipeline"),
      import("supportClaw/plugin-sdk/compat"),
    ] as const);

/**
 * @deprecated Use `supportClaw/plugin-sdk/channel-outbound` for outbound/message
 * lifecycle helpers and `supportClaw/plugin-sdk/channel-inbound` for inbound
...
/** @deprecated Use `hasFinalInboundReplyDispatch(...)` from `supportClaw/plugin-sdk/channel-inbound`. */
export { hasFinalChannelTurnDispatch } from "../channels/turn/dispatch-result.js";
/** @deprecated Use `hasVisibleInboundReplyDispatch(...)` from `supportClaw/plugin-sdk/channel-inbound`. */
export { hasVisibleChannelTurnDispatch } from "../channels/turn/dispatch-result.js";
/** @deprecated Use `resolveInboundReplyDispatchCounts(...)` from `supportClaw/plugin-sdk/channel-inbound`. */
export { resolveChannelTurnDispatchCounts } from "../channels/turn/dispatch-result.js";

/** @deprecated Use `createChannelMessageReplyPipeline(...)` from `supportClaw/plugin-sdk/channel-outbound`. */
...
/** @deprecated Use `buildInboundReplyDispatchBase(...)` from `supportClaw/plugin-sdk/channel-inbound`. */
export { buildChannelMessageReplyDispatchBase } from "./inbound-reply-dispatch.js";
/** @deprecated Use `dispatchChannelInboundReply(...)` or `runPreparedInboundReply(...)` from `supportClaw/plugin-sdk/channel-inbound`. */
...
/** @deprecated Use `deliverInboundReplyWithMessageSendContext(...)` from `supportClaw/plugin-sdk/channel-outbound`. */

...
/** Runtime adapter that lets the package agent-core use SupportClaw LLM helpers. */
export const supportClawAgentCoreRuntime = {
...
/** Agent-core class preconfigured with SupportClaw runtime dependencies. */
export class Agent extends CoreAgent {
  constructor(options: CoreAgentOptions = {}) {
    super({ runtime: supportClawAgentCoreRuntime, ...options });
  }
}

// SupportClaw-owned reusable agent core

...
type FacadeModule = {
  applyXiaomiConfig: (cfg: SupportClawConfig) => SupportClawConfig;
  applyXiaomiProviderConfig: (cfg: SupportClawConfig) => SupportClawConfig;
...
/** Apply Xiaomi provider defaults to the full SupportClaw config. */

/**
 * @deprecated Use `supportClaw/plugin-sdk/channel-inbound` for inbound runners and
 * dispatch predicates. Use `supportClaw/plugin-sdk/channel-outbound` for message
 * delivery helpers.
 */

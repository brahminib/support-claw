...
export const toolPluginMetadataSymbol = Symbol.for("supportClaw.plugin-sdk.tool-plugin.metadata");

/** Runtime context supplied to a concrete tool plugin execution handler. */
export type ToolPluginExecutionContext = {
  /** Plugin runtime API for tool implementations that need SupportClaw services. */
...
export type ToolPluginFactoryContext<TConfig> = {
  ...
  toolContext: SupportClawPluginToolContext;
};

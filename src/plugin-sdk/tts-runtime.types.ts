...
export type TtsRuntimeFacade = {
  ...
  buildTtsSystemPromptHint: (cfg: SupportClawConfig, agentId?: string) => string | undefined;
  ...
  resolveTtsProviderOrder: (primary: TtsProvider, cfg?: SupportClawConfig) => TtsProvider[];

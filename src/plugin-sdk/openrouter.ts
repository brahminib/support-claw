...
type FacadeModule = {
  applyOpenrouterConfig: (cfg: SupportClawConfig) => SupportClawConfig;
  applyOpenrouterProviderConfig: (cfg: SupportClawConfig) => SupportClawConfig;
...
/** Apply OpenRouter defaults to the full SupportClaw config. */

...
let cachedSupportClawPackageRoot: string | undefined;

function getSupportClawPackageRoot() {
  if (cachedSupportClawPackageRoot) {
    return cachedSupportClawPackageRoot;
  }
  cachedSupportClawPackageRoot =
...
function resolveFacadeModuleLocation(params: {
  ...
  return resolveBundledFacadeModuleLocation({
    ...
    packageRoot: getSupportClawPackageRoot(),
    bundledPluginsDir,
  });
}
...
export function loadFacadeModuleAtLocationSync<T extends object>(params: {
  ...
  const opened = openRootFileSync({
    ...
    boundaryLabel:
      location.boundaryRoot === getSupportClawPackageRoot()
        ? "SupportClaw package root"
        : (() => {
...
export async function loadBundledPluginPublicSurfaceModule<T extends object>(params: {
  ...
  const opened = openRootFileSync({
    ...
    boundaryLabel:
      preparedLocation.boundaryRoot === getSupportClawPackageRoot()
        ? "SupportClaw package root"
        : "plugin root",
    rejectHardlinks: false,
  });
...
export function resetFacadeLoaderStateForTest(): void {
  ...
  cachedSupportClawPackageRoot = undefined;
}

// SupportClaw-owned tool runtime contract helpers mock agent tool runtimes in SDK tests.
...
export function installSupportClawOwnedToolHooks(params?: {
 ...
 * Pair with `installSupportClawOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetSupportClawOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();

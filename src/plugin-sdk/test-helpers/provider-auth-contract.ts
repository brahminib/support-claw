...
type EnsureAuthProfileStore =
  typeof import("supportClaw/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("supportClaw/plugin-sdk/provider-auth").listProfilesForProvider;
...
function installSharedAuthProfileStoreHooks(state: { authStore: AuthProfileStore }) {
  beforeEach(() => {
    vi.doMock("supportClaw/plugin-sdk/provider-auth", async () => {

...
/** Normalized model metadata used by SupportClaw provider catalogs. */
...
export const LMSTUDIO_DEFAULT_MODEL_ID: FacadeModule["LMSTUDIO_DEFAULT_MODEL_ID"] =
  "qwen/qwen3.5-9b";
/** Stable provider id used in SupportClaw config and provider catalogs. */
...
/** Map one raw LM Studio model entry into SupportClaw model metadata. */
...
/** Discover SupportClaw model definitions from an LM Studio server. */

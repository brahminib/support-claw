...
type ChannelApprovalForwardingEvaluatorParams = {
  channel: string;
  isTransportEnabled: (params: { cfg: SupportClawConfig; accountId?: string | null }) => boolean;
...
type NativeApprovalChannelRouteGateParams<TTarget extends NativeApprovalTarget> = {
  ...
  isTransportEnabled: (params: { cfg: SupportClawConfig; accountId?: string | null }) => boolean;
  listAccountIds: (cfg: SupportClawConfig) => readonly string[];
  resolveDefaultAccountId: (cfg: SupportClawConfig) => string;
  normalizeForwardTarget: (target: NativeApprovalForwardTarget) => TTarget | null;
...
export function shouldSuppressLocalNativeExecApprovalPrompt(params: {
  ...
  isNativeDeliveryEnabled?: (params: { cfg: SupportClawConfig; accountId?: string | null }) => boolean;

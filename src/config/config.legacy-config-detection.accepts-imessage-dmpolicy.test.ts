...
function expectSupportClawSchemaInvalidPreservesField(params: {
  config: unknown;
  ...
  const res = SupportClawSchema.safeParse(params.config);
...
describe("legacy config detection", () => {
  ...
  it("rejects removed legacy provider sections", () => {
    expectSupportClawSchemaInvalidPreservesField({
  ...
  it("preserves claude-cli auth profile mode during validation", () => {
    ...
    const res = SupportClawSchema.safeParse(config);

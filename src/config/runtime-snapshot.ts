...
let runtimeConfigSnapshot: SupportClawConfig | null = null;
let runtimeConfigSourceSnapshot: SupportClawConfig | null = null;
...
function configSnapshotsMatch(left: SupportClawConfig, right: SupportClawConfig): boolean {
  if (left === right) {
    return true;
  }
  try {
...
export function hashRuntimeConfigValue(value: SupportClawConfig): string {
...
export function getRuntimeConfigSnapshot(): SupportClawConfig | null {
  return runtimeConfigSnapshot;
}

export function getRuntimeConfigSourceSnapshot(): SupportClawConfig | null {
...
export function resolveRuntimeConfigCacheKey(config: SupportClawConfig): string {
...
export function selectApplicableRuntimeConfig(params: {
  inputConfig?: SupportClawConfig;
  runtimeConfig?: SupportClawConfig | null;
  runtimeSourceConfig?: SupportClawConfig | null;
}): SupportClawConfig | undefined {
...
export function loadPinnedRuntimeConfig(loadFresh: () => SupportClawConfig): SupportClawConfig {
...
export async function preflightRuntimeSnapshotWrite(params: {
  nextSourceConfig: SupportClawConfig;
...
export async function finalizeRuntimeSnapshotWrite(params: {
  ...
  loadFreshConfig: () => SupportClawConfig;

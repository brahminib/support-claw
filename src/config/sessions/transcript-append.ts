...
import { resolveTimestampMsToIsoString } from "@supportclaw/normalization-core/number-coercion";
...
async function appendSessionTranscriptMessageLocked<TMessage>(
  ...
  const entry = {
    ...
    ...(leafInfo.appendMode === "side" && isTranscriptOnlySupportClawAssistantMessage(finalMessage)

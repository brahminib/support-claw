...
} from "@supportclaw/model-catalog-core/provider-model-id-normalization";
...
export function applyMessageDefaults(cfg: SupportClawConfig): SupportClawConfig {
...
export function applyTalkConfigNormalization(config: SupportClawConfig): SupportClawConfig {
...
export function applyAgentDefaults(cfg: SupportClawConfig): SupportClawConfig {
...
export function applyCronDefaults(cfg: SupportClawConfig): SupportClawConfig {
...
export function applyLoggingDefaults(cfg: SupportClawConfig): SupportClawConfig {
...
function hasAnthropicDefaultSignal(cfg: SupportClawConfig, env: NodeJS.ProcessEnv): boolean {
...
export function applyCompactionDefaults(cfg: SupportClawConfig): SupportClawConfig {

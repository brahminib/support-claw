...
function isCompatibleTopLevelRuntimeProjectionShape(params: {
  runtimeSnapshot: SupportClawConfig;
...
export function projectConfigOntoRuntimeSourceSnapshot(config: SupportClawConfig): SupportClawConfig {
  ...
  return applyMergePatch(projectedSource, runtimePatch) as SupportClawConfig;
}

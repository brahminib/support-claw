...
} from "@supportclaw/net-policy/redact-sensitive-url";
...
import type { ConfigFileSnapshot } from "./types.supportClaw.js";
 ...
 */
export const REDACTED_SENTINEL = "__SUPPORT_CLAW_REDACTED__";

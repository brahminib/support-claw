...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.SUPPORT_CLAW_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.SUPPORT_CLAW_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.SUPPORT_CLAW_WATCH_COMMAND),
...
type ConfigAuditScrubResult = {
  ...
  // to swap the file. Caller should re-run `supportClaw doctor --fix` once the

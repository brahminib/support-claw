...
export type WideAreaDiscoveryConfig = {
  ...
  enabled?: boolean;
  /** Optional unicast DNS-SD domain (e.g. "supportClaw.internal"). */
  domain?: string;
};
...
export type GatewayControlUiConfig = {
  ...
  enabled?: boolean;
  /** Optional base path prefix for the Control UI (e.g. "/supportClaw"). */
  basePath?: string;
   ...
   * Default off; prefer hosted /__supportClaw__/canvas or /__supportClaw__/a2ui content.
   */
...
export type GatewayTailscaleConfig = {
  ...
  resetOnExit?: boolean;
  /** Optional Tailscale Service name, such as `svc:supportClaw`, for Serve mode. */
  serviceName?: string;
  /**
   ...
   * startup. Lets operators manage Funnel exposure outside SupportClaw without
...
export type GatewayReloadConfig = {
   ...
   * @see https://github.com/brahminib/support-claw/issues/65485
   */
...
export type GatewayConfig = {
   ...
   * Env var SUPPORT_CLAW_HANDSHAKE_TIMEOUT_MS takes precedence. Default: 15000.
   */

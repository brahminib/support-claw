...
export type DiscordVoiceRealtimeConfig = {
  ...
  /** Whether bidi should force the SupportClaw agent brain for every substantive turn. */
  ...
  /** Debounce window before buffered transcripts are sent to the SupportClaw agent. */
  debounceMs?: number;
...
export type DiscordVoiceAgentSessionConfig = {
  /** Which SupportClaw conversation should receive voice turns. Default: "voice". */
  mode?: "voice" | "target";
...
export type DiscordVoiceConfig = {
  ...
  /** Route voice turns through an existing SupportClaw Discord conversation. */

...
export type AgentDefaultsConfig = {
  ...
  /** Embedded SupportClaw runner hardening and compatibility controls. */
  embeddedAgent?: {
    /**
     * How embedded SupportClaw should trust workspace-local `.supportClaw/settings.json`.
    ...
    /**
     * Embedded SupportClaw execution contract:
...
export type AgentCompactionConfig = {
  ...
  /** Embedded SupportClaw reserve tokens target before floor enforcement. */
  reserveTokens?: number;
  /** Embedded SupportClaw keepRecentTokens budget used for cut-point selection. */
  keepRecentTokens?: number;
  /** Minimum reserve tokens enforced for embedded SupportClaw compaction (0 disables the floor). */

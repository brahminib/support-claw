...
describe("config schema regressions", () => {
  ...
  it("rejects bindings referencing an agentId missing from agents.list (supportClaw#84692)", () => {
    const res = validateConfigObject({
      agents: {
  ...
  it("accepts a microsoft-foundry model entry carrying thinkingLevelMap (supportClaw#91011)", () => {

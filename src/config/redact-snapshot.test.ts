...
describe("redactConfigSnapshot", () => {
          ...
          plugins: [
            {
              ...
              manifestPath: "/private/plugin/root/supportClaw.plugin.json",
            },
          ],
          diagnostics: [],
        },
  ...
  it("does not redact passwordFile path fields", () => {
    const snapshot = makeSnapshot({
      channels: {
        irc: {
          passwordFile: "/etc/supportClaw/irc-password.txt",
          nickserv: {
            passwordFile: "/etc/supportClaw/nickserv-password.txt",
    ...
    expect(irc.passwordFile).toBe("/etc/supportClaw/irc-password.txt");
    expect(nickserv.passwordFile).toBe("/etc/supportClaw/nickserv-password.txt");

...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("supportClaw.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("supportClaw.contextEngineRegistryState");

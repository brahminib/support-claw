...
function resolveRealtimeVoiceProviderEntries(cfg?: SupportClawConfig): RealtimeVoiceProviderPlugin[] {
 ...
 */
export function listRealtimeVoiceProviders(cfg?: SupportClawConfig): RealtimeVoiceProviderPlugin[] {

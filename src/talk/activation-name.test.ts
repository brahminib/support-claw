...
describe("realtime voice activation names", () => {
  it("normalizes and validates one- or two-word activation names", () => {
    expect(normalizeSupportedRealtimeVoiceActivationName("  SupportClaw  ")).toBe("supportClaw");
  ...
  it("prefers longer activation names first", () => {
    expect(sortRealtimeVoiceActivationNames(["claw", "claw bot", "supportClaw"])).toEqual([
      "claw bot",
      "supportClaw",
      "claw",
    ]);

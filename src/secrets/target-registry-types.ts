...
export type SecretTargetConfigFile = "supportClaw.json" | "auth-profiles.json"; // pragma: allowlist secret
...
export type SecretTargetRegistryEntry = {
  ...
  /** Enables `supportClaw secrets apply` targeting for this entry. */

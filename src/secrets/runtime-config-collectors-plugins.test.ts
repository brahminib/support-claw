...
function makeContext(sourceConfig: SupportClawConfig): ResolverContext {
...
function collectAcpxConfigAssignments(config: SupportClawConfig): ResolverContext {
...
function expectInactiveAcpxConfig(config: SupportClawConfig): void {

...
function toCandidate(
  ...
  defaults: NonNullable<SupportClawConfig["secrets"]>["defaults"] | undefined,
 ...
 */
export function migrateLegacySecretRefEnvMarkers(config: SupportClawConfig): {
  config: SupportClawConfig;
  changes: string[];
} {
  ...
  const next = structuredClone(config) as SupportClawConfig & Record<string, unknown>;

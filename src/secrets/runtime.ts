...
function hasConfiguredPluginEntries(config: SupportClawConfig): boolean {
...
function hasConfiguredChannelEntries(config: SupportClawConfig): boolean {
...
function hasConfiguredPluginIntegrationSecretProviders(config: SupportClawConfig): boolean {
...
function shouldLoadPluginMetadataForSecrets(config: SupportClawConfig): boolean {
  return (

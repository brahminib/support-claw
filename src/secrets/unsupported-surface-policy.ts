...
// Candidate scanning only sees supportClaw.json; auth-profile-only surfaces are audited elsewhere.
...
/**
 * Concrete unsupported config value discovered from an supportClaw.json-like object.
 */
...
/**
 * Finds configured supportClaw.json values whose surfaces currently reject SecretRef objects.
 */

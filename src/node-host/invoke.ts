...
const execHostEnforced =
  normalizeLowercaseStringOrEmpty(process.env.SUPPORT_CLAW_NODE_EXEC_HOST ?? "") === "app";
const execHostFallbackAllowed =
  normalizeLowercaseStringOrEmpty(process.env.SUPPORT_CLAW_NODE_EXEC_FALLBACK ?? "") !== "0";

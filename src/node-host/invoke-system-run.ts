...
type ExecToolConfig = NonNullable<NonNullable<SupportClawConfig["tools"]>["exec"]>;
...
async function loadSystemRunConfig(opts: HandleSystemRunInvokeOptions): Promise<SupportClawConfig> {

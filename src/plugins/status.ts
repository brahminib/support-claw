...
import { normalizeSupportClawVersionBase } from "../config/version.js";
...
import { loadSupportClawPlugins } from "./loader.js";
...
function resolveReportedPluginVersion(
  ...
  return (
    normalizeSupportClawVersionBase(resolveCompatibilityHostVersion(env)) ??
    normalizeSupportClawVersionBase(plugin.version) ??
    plugin.version
  );
}

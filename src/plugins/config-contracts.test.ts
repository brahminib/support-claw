...
const mocks = vi.hoisted(() => {
  ...
  return {
    discoverSupportClawPlugins: vi.fn(() => ({ candidates: [], diagnostics: [] })),
...
vi.mock("./discovery.js", () => ({
  discoverSupportClawPlugins: mocks.discoverSupportClawPlugins,
}));
...
function createPluginRecord(
  ...
  return {
    ...
    hooks: [],
    source: `/tmp/${overrides.id}/supportClaw.plugin.json`,
...
describe("resolvePluginConfigContractsById", () => {
  beforeEach(() => {
    mocks.discoverSupportClawPlugins.mockReset();
    mocks.discoverSupportClawPlugins.mockReturnValue({ candidates: [], diagnostics: [] });

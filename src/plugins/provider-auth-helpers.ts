...
const resolveAuthAgentDir = (agentDir?: string, config?: SupportClawConfig) =>
...
function resolveProviderDefaultEnvSecretRef(provider: string, config?: SupportClawConfig): SecretRef {

...
import type { ClawdbotConfig, SupportClawConfig, SupportClawSchemaType } from "../../plugin-sdk/index.js";
...
describe("plugin-sdk exports", () => {
  ...
  it("keeps deprecated root config type aliases aligned", () => {
    expectTypeOf<ClawdbotConfig>().toEqualTypeOf<SupportClawConfig>();
    expectTypeOf<SupportClawSchemaType>().toEqualTypeOf<SupportClawConfig>();
  });

...
const ENV: NodeJS.ProcessEnv = { HOME: "/tmp/supportClaw-test-home" };
let loadCase = 0;

const RECORDS: Record<string, PluginInstallRecord> = {
  weixin: {
    source: "npm",
    spec: "@tencent-weixin/supportClaw-weixin@2.3.7",
    installPath:
      "/tmp/supportClaw-test-home/.supportClaw/npm/node_modules/@tencent-weixin/supportClaw-weixin",
...
async function loadWithMocks(params: {
  ...
  vi.doMock("./discovery.js", () => ({ discoverSupportClawPlugins: discoverSpy }));
...
function createChannelCandidate(params: {
  ...
  return {
    ...
    source: "/tmp/supportClaw-test-plugin/index.js",
    rootDir: "/tmp/supportClaw-test-plugin",
    origin: params.origin ?? "global",
    packageName: "@vendor/supportClaw-test-plugin",
    packageManifest: {

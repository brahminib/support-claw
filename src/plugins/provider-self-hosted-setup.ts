...
export function applyProviderDefaultModel(cfg: SupportClawConfig, modelRef: string): SupportClawConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: SupportClawConfig; modelId: string; modelRef: string; profileId: string } {

...
import type { SupportClawPluginCliCommandDescriptor, PluginLogger } from "./types.js";
...
const PLUGIN_CLI_ENTRIES_CACHE_KEY = Symbol.for("supportClaw.plugin-cli-registration-entries-cache");
...
export const loadValidatedConfigForPluginRegistration =
  async (): Promise<SupportClawConfig | null> => {

...
import { setCurrentManifestModelIdNormalizationRecords } from "@supportclaw/model-catalog-core/provider-model-id-normalization";
...
let currentPluginMetadataConfigIdentityCache = new WeakSet<SupportClawConfig>();
...
export function setCurrentPluginMetadataSnapshot(
  ...
  options: {
    config?: SupportClawConfig;
    compatibleConfigs?: readonly SupportClawConfig[];

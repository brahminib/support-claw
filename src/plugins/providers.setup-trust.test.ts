...
function makeTempDir() {
  return makeTrackedTempDir("supportClaw-provider-setup-trust", tempDirs);
}
...
function writeWorkspaceProviderPlugin(params: {
  ...
  const pluginDir = path.join(params.workspaceDir, ".supportClaw", "extensions", params.pluginId);

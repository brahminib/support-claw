...
function normalizeModelProviderConfigsForWrite(cfg: SupportClawConfig): SupportClawConfig {
...
function normalizeConfigModelRefsForWrite(cfg: SupportClawConfig): SupportClawConfig {
    ...
    agents: {
      ...
      defaults: {
        ...
        models: sanitizeConfigPatchValue(patchModels) as NonNullable<
          NonNullable<SupportClawConfig["agents"]>["defaults"]
        >["models"],
      },
    },
  });

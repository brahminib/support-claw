  ...
  it.each([
    {
      ...
      input: {
        ...
        version: "1.2.3",
        resolvedSpec: "@supportclaw/demo@1.2.3",
...
describe("resolveNpmInstallRecordSpec", () => {
  it("uses an exact resolved registry spec when managed installs request pinning", () => {
    expect(
      resolveNpmInstallRecordSpec({
        requestedSpec: "@supportclaw/codex",
        resolution: {
          name: "@supportclaw/codex",
          version: "2026.5.30-beta.1",
          resolvedSpec: "@supportclaw/codex@2026.5.30-beta.1",
        },
        pinResolvedRegistrySpec: true,
      }),
    ).toBe("@supportclaw/codex@2026.5.30-beta.1");
  });
    ...
    expect(
      resolveNpmInstallRecordSpec({
        ...
        resolution: {
          name: "@supportclaw/codex",
          version: "2026.5.30-beta.1",
          resolvedSpec: "@supportclaw/codex@beta",
        },
        pinResolvedRegistrySpec: true,
      }),
    ).toBe("@supportclaw/codex");

...
import { relinkSupportClawPeerDependenciesInManagedNpmRoot } from "./plugin-peer-link.js";
...
export function removePluginFromConfig(
  ...
  pluginId: string,
  opts?: { channelIds?: string[] },
): { config: SupportClawConfig; actions: Omit<UninstallActions, "directory"> } {
  ...
  const config: SupportClawConfig = {
    ...
    channels: channels as SupportClawConfig["channels"],
  };

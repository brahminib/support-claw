...
export type SupportClawPluginActiveModelContext = {
  provider?: string;
  modelId?: string;
  modelRef?: string;
};
...
export type SupportClawPluginToolContext = {
   ...
   * the local operator, installed plugin code, or a modified SupportClaw runtime.
   */
  activeModel?: SupportClawPluginActiveModelContext;
  browser?: {
...
export type SupportClawPluginToolFactory = (
  ctx: SupportClawPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type SupportClawPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type SupportClawPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;

/** Reads Codex/Claude/Cursor bundle manifests into SupportClaw plugin manifest metadata. */
...
export type BundlePluginManifest = {
  ...
  // Only include hook roots that SupportClaw can execute via HOOK.md + handler files.
  hooks: string[];

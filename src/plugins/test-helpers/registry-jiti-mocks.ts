...
const registryJitiMocks = vi.hoisted(() => ({
  createJiti: vi.fn(),
  discoverSupportClawPlugins: vi.fn(),
...
vi.mock("../discovery.js", () => ({
  discoverSupportClawPlugins: (
    ...args: Parameters<typeof registryJitiMocks.discoverSupportClawPlugins>
  ) => registryJitiMocks.discoverSupportClawPlugins(...args),
}));
...
export function resetRegistryJitiMocks(): void {
  ...
  registryJitiMocks.discoverSupportClawPlugins.mockReset();
  registryJitiMocks.loadPluginManifestRegistry.mockReset();
  registryJitiMocks.loadPluginRegistrySnapshot.mockReset();
  registryJitiMocks.discoverSupportClawPlugins.mockReturnValue({
    candidates: [],
    diagnostics: [],
  });

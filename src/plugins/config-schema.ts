...
import type { SupportClawPluginConfigSchema } from "./types.js";
...
type BuildPluginConfigSchemaOptions = {
  ...
  safeParse?: SupportClawPluginConfigSchema["safeParse"];
};
...
export function emptyPluginConfigSchema(): SupportClawPluginConfigSchema {
  return {

...
import type { SupportClawPluginCommandDefinition } from "./types.js";
...
function resolvePluginTextName(command: SupportClawPluginCommandDefinition): string {
...
function serializePluginCommandSpec(
  cmd: SupportClawPluginCommandDefinition,
  provider?: string,
): {
  name: string;
  description: string;

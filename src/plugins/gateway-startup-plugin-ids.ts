...
import { buildModelCatalogMergeKey } from "@supportclaw/model-catalog-core/model-catalog-refs";
import {
...
function normalizePluginsConfigForInstalledIndex(
  config: SupportClawConfig["plugins"] | undefined,
...
function listPotentialEnabledChannelIds(config: SupportClawConfig, env: NodeJS.ProcessEnv): string[] {
...
function resolveGatewayStartupDreamingEngineId(config: SupportClawConfig): string | undefined {
...
function resolveGatewayStartupDreamingSelectedPluginId(config: SupportClawConfig): string | undefined {
...
function collectConfiguredWebSearchProviderIds(config: SupportClawConfig): ReadonlySet<string> {
...
function collectConfiguredVoiceProviderIds(config: SupportClawConfig): ConfiguredVoiceProviderIds {
...
function isMemorySlotExplicitlyDisabled(config: SupportClawConfig): boolean {
...
function collectValidationHeartbeatTargetChannelIds(config: SupportClawConfig): string[] {
...
function collectValidationChannelConfigIds(config: SupportClawConfig): string[] {
...
function collectConfiguredProviderIds(config: SupportClawConfig): string[] {
...
function collectValidationConfiguredProviderIds(config: SupportClawConfig): string[] {
...
function collectValidationConfiguredShorthandModelIds(config: SupportClawConfig): string[] {
  return sortUniquePluginIds(

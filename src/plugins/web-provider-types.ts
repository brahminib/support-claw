...
export type WebSearchProviderPlugin = {
  ...
  getConfiguredCredentialValue?: (config?: SupportClawConfig) => unknown;
  setConfiguredCredentialValue?: (configTarget: SupportClawConfig, value: unknown) => void;
  getConfiguredCredentialFallback?: (
    config?: SupportClawConfig,
  ) => WebSearchProviderConfiguredCredentialFallback | undefined;
  applySelectionConfig?: (config: SupportClawConfig) => SupportClawConfig;
  runSetup?: (ctx: WebSearchProviderSetupContext) => SupportClawConfig | Promise<SupportClawConfig>;

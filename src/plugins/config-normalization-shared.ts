...
import { normalizeArrayBackedTrimmedStringList } from "@supportclaw/normalization-core/string-normalization";
...
export function hasExplicitPluginConfig(plugins?: SupportClawConfig["plugins"]): boolean {
  if (!plugins) {
    return false;
  }

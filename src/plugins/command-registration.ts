...
import {
  ...
  type SupportClawPluginCommandDefinition,
} from "./types.js";
...
/** Returns true when a command name is owned by built-in SupportClaw command handling. */
...
export function listPluginInvocationKeys(command: SupportClawPluginCommandDefinition): string[] {

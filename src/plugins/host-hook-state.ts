...
function loadPluginHostHookSessionEntry(params: { cfg: SupportClawConfig; sessionKey: string }): {
  storePath: string;
  entry?: SessionEntry;
  canonicalKey: string;
  storeKey: string;
...
function isPluginPromptInjectionEnabled(cfg: SupportClawConfig, pluginId: string): boolean {

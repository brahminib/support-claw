...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by SupportClaw from plugin manifests, install records, and config policy. Use `supportClaw plugins registry --refresh`, `supportClaw plugins install/update/uninstall`, or `supportClaw plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored supportClaw.install metadata. This describes catalog/package

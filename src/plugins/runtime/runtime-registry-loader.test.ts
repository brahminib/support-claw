...
const mocks = vi.hoisted(() => ({
  loadSupportClawPlugins: vi.fn<typeof import("../loader.js").loadSupportClawPlugins>(),
...
function loadOptions(index = 0) {
  return requireRecord(mocks.loadSupportClawPlugins.mock.calls[index]?.[0], `load options ${index}`);
}
...
vi.mock("../loader.js", () => ({
  loadSupportClawPlugins: (...args: Parameters<typeof mocks.loadSupportClawPlugins>) =>
    mocks.loadSupportClawPlugins(...args),
  resolveCompatibleRuntimePluginRegistry: (
...
describe("ensurePluginRegistryLoaded", () => {
  ...
  beforeEach(() => {
    ...
    mocks.loadSupportClawPlugins.mockReturnValue(createEmptyPluginRegistry());
    mocks.resolveRuntimePluginRegistry.mockImplementation(
      (...args: Parameters<typeof mocks.loadSupportClawPlugins>) => mocks.loadSupportClawPlugins(...args),
    );
  ...
  it("does not reuse non-empty all-scope registries without loader compatibility", () => {
    ...
    mocks.loadSupportClawPlugins.mockClear();

...
vi.mock("../loader.js", async (importOriginal) => {
  ...
  return {
    ...actual,
    loadSupportClawPlugins: (...args: Parameters<typeof loaderMocks.loadSupportClawPlugins>) =>
      loaderMocks.loadSupportClawPlugins(...args),
  };
});
...
beforeEach(() => {
  loaderMocks.loadSupportClawPlugins.mockReset();
});
...
describe("ensureStandaloneRuntimePluginRegistryLoaded", () => {
  it("reuses a compatible gateway startup registry for gateway-bindable dispatch load options", () => {
    ...
    expect(loaderMocks.loadSupportClawPlugins).not.toHaveBeenCalled();
  });
  ...
  it("loads a fresh registry when dispatch config is not startup-compatible", () => {
    ...
    loaderMocks.loadSupportClawPlugins.mockReturnValue(loadedRegistry);
    ...
    expect(loaderMocks.loadSupportClawPlugins).toHaveBeenCalledOnce();
  });
});
...
describe("ensureStandaloneRuntimePluginRegistryLoaded tool-discovery installs", () => {
  it("does not replace active or pinned channel registries during tool discovery", () => {
    ...
    loaderMocks.loadSupportClawPlugins.mockReturnValue(toolRegistry);
  ...
  it("still installs a non-tool-discovery active load (migration provider path)", () => {
    ...
    loaderMocks.loadSupportClawPlugins.mockReturnValue(migrationRegistry);

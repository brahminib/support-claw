...
type RuntimeConfigMutationContext = {
  snapshot: import("../../config/types.supportClaw.js").ConfigFileSnapshot;
...
type RuntimeMutateConfigFileParams<T = void> = {
  ...
  mutate: (
    draft: import("../../config/types.supportClaw.js").SupportClawConfig,
    context: RuntimeConfigMutationContext,
  ) => Promise<T | void> | T | void;
};
type RuntimeReplaceConfigFileParams = {
  nextConfig: import("../../config/types.supportClaw.js").SupportClawConfig;
  baseHash?: string;
  afterWrite: RuntimeConfigAfterWrite;
  writeOptions?: RuntimeWriteConfigOptions;
};
...
export type PluginRuntimeCore = {
  ...
  config: {
    ...
    current: () => DeepReadonly<import("../../config/types.supportClaw.js").SupportClawConfig>;
    /**
     ...
     */
    loadConfig: () => import("../../config/types.supportClaw.js").SupportClawConfig;
    /**
     ...
     */
    writeConfigFile: (
      cfg: import("../../config/types.supportClaw.js").SupportClawConfig,
  ...
  media: {
    ...
    detectMime: typeof import("@supportclaw/media-core/mime").detectMime;
    mediaKindFromMime: typeof import("@supportclaw/media-core/constants").mediaKindFromMime;
  ...
  modelAuth: {
    ...
    getApiKeyForModel: (params: {
      model: import("supportClaw/plugin-sdk/llm").Model<import("supportClaw/plugin-sdk/llm").Api>;
      cfg?: import("../../config/types.supportClaw.js").SupportClawConfig;
      workspaceDir?: string;

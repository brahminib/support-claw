...
} & PluginActivationConfigSourceLike<SupportClawConfig>;
...
export const normalizePluginsConfig = (
  config?: SupportClawConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: SupportClawConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.hasOwn(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: SupportClawConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.hasOwn(plugins.entries, defaultSlotIdForKey("memory")));

export const hasExplicitPluginConfig = (plugins?: SupportClawConfig["plugins"]) =>

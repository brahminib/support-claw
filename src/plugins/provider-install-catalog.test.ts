...
type LoadSupportClawProviderIndex =
  typeof import("../model-catalog/index.js").loadSupportClawProviderIndex;
...
const loadSupportClawProviderIndex = vi.hoisted(() =>
  vi.fn<LoadSupportClawProviderIndex>(() => ({ version: 1, providers: {} })),
);
...
function vllmPluginWithPackageInstall(): InstalledPluginIndexRecord {
  return {
    pluginId: "vllm",
    origin: "global",
    manifestPath: "/Users/test/.supportClaw/plugins/vllm/supportClaw.plugin.json",
    manifestHash: "hash",
    rootDir: "/Users/test/.supportClaw/plugins/vllm",
    enabled: true,
    startup: {
      sidecar: false,
      memory: false,
    ...
    compat: [],
    packageName: "@supportclaw/vllm",
    packageInstall: {
      npm: {
        spec: "@supportclaw/vllm-fork@1.0.0",
        packageName: "@supportclaw/vllm-fork",
        selector: "1.0.0",
...
describe("provider install catalog", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    loadSupportClawProviderIndex.mockReturnValue({ version: 1, providers: {} });
      ...
      plugins: [
        {
          pluginId: "openai",
          origin: "bundled",
          manifestPath: "/repo/extensions/openai/supportClaw.plugin.json",
          manifestHash: "hash",
          ...
          compat: [],
          packageName: "@supportclaw/openai",
          packageInstall: {
            defaultChoice: "npm",
            npm: {
              spec: "@supportclaw/openai@1.2.3",
              packageName: "@supportclaw/openai",
              selector: "1.2.3",
              selectorKind: "exact-version",
              exactVersion: true,
    ...
    expect(resolveProviderInstallCatalogEntries()).toEqual([
      {
        ...
        origin: "bundled",
        install: {
          npmSpec: "@supportclaw/openai@1.2.3",
  ...
  it("prefers durable install records over package-authored install intent", () => {
    loadPluginRegistrySnapshot.mockReturnValue(
      registrySnapshot({
        installRecords: {
          vllm: {
            source: "npm",
            spec: "@supportclaw/vllm",
            resolvedSpec: "@supportclaw/vllm@2.0.0",
    ...
    expect(resolveProviderInstallCatalogEntry("vllm")).toEqual({
      ...
      origin: "global",
      install: {
        npmSpec: "@supportclaw/vllm@2.0.0",
  ...
  it("preserves durable ClawHub install records for provider setup reinstall hints", () => {
    loadPluginRegistrySnapshot.mockReturnValue(
      registrySnapshot({
        installRecords: {
          vllm: {
            source: "clawhub",
            spec: "clawhub:supportClaw/vllm@2026.5.2",
            integrity: "sha256-clawpack",
            clawhubPackage: "supportClaw/vllm",
          },
        },
        plugins: [vllmPluginWithPackageInstall()],
      }),
    ...
    expect(resolveProviderInstallCatalogEntry("vllm")).toEqual({
      ...
      origin: "global",
      install: {
        clawhubSpec: "clawhub:supportClaw/vllm@2026.5.2",
      ...
      plugins: [
        {
          ...
          origin: "global",
          manifestPath: "/Users/test/.supportClaw/plugins/demo-provider/supportClaw.plugin.json",
          manifestHash: "hash",
          rootDir: "/Users/test/.supportClaw/plugins/demo-provider",
          enabled: true,
          startup: {
            sidecar: false,
            memory: false,
      ...
      plugins: [
        {
          pluginId: "demo-provider",
          origin: "workspace",
          manifestPath: "/repo/extensions/demo-provider/supportClaw.plugin.json",
          manifestHash: "hash",
  ...
  it("surfaces provider-index install metadata when the provider plugin is not installed", () => {
    loadSupportClawProviderIndex.mockReturnValue({
      version: 1,
      providers: {
        moonshot: {
          id: "moonshot",
          ...
          plugin: {
            id: "moonshot",
            package: "@supportclaw/plugin-moonshot",
            install: {
              npmSpec: "@supportclaw/plugin-moonshot@1.2.3",
              defaultChoice: "npm",
    ...
    expect(resolveProviderInstallCatalogEntry("moonshot-api-key")).toEqual({
      ...
      installSource: {
        defaultChoice: "npm",
        npm: {
          spec: "@supportclaw/plugin-moonshot@1.2.3",
          packageName: "@supportclaw/plugin-moonshot",
          selector: "1.2.3",
          selectorKind: "exact-version",
          exactVersion: true,
          expectedIntegrity: "sha512-moonshot",
  ...
  it("resolves deprecated official external auth choices before their plugin is installed", () => {
    listOfficialExternalProviderCatalogEntries.mockReturnValue([
      {
        name: "@supportclaw/qwen-provider",
        source: "official",
        kind: "provider",
        supportClaw: {
          ...
          install: {
            npmSpec: "@supportclaw/qwen-provider",
            defaultChoice: "npm",
          },
        },
      },
  ...
  it("surfaces provider-index ClawHub install metadata as the preferred source", () => {
      ...
      providers: {
        moonshot: {
          ...
          plugin: {
            ...
            package: "@supportclaw/plugin-moonshot",
            install: {
              clawhubSpec: "clawhub:supportClaw/moonshot@2026.5.2",
              npmSpec: "@supportclaw/plugin-moonshot@2026.5.2",
              defaultChoice: "clawhub",
              expectedIntegrity: "sha512-moonshot",
            },
          },
    ...
    expect(resolveProviderInstallCatalogEntry("moonshot-api-key")).toEqual({
      ...
      installSource: {
        defaultChoice: "clawhub",
        clawhub: {
          spec: "clawhub:supportClaw/moonshot@2026.5.2",
          packageName: "supportClaw/moonshot",
          version: "2026.5.2",
          exactVersion: true,
        },
        npm: {
          spec: "@supportclaw/plugin-moonshot@2026.5.2",
          packageName: "@supportclaw/plugin-moonshot",
          selector: "2026.5.2",
          selectorKind: "exact-version",
          exactVersion: true,
      ...
      plugins: [
        {
          pluginId: "moonshot",
          origin: "bundled",
          manifestPath: "/repo/extensions/moonshot/supportClaw.plugin.json",
          manifestHash: "hash",
  ...
  it("keeps missing provider-index entries visible when only some provider plugins are installed", () => {
    ...
    loadSupportClawProviderIndex.mockReturnValue({
      ...
      providers: {
        groq: {
          ...
          plugin: {
            id: "groq",
            package: "@supportclaw/plugin-groq",
            install: {
              npmSpec: "@supportclaw/plugin-groq@1.0.0",
              defaultChoice: "npm",
            },
          },
          authChoices: [
        ...
        vllm: {
          ...
          plugin: {
            id: "vllm",
            package: "@supportclaw/plugin-vllm",
            install: {
              clawhubSpec: "clawhub:supportClaw/vllm@2026.5.2",
              npmSpec: "@supportclaw/plugin-vllm@2026.5.2",
              defaultChoice: "clawhub",
            },
          },
          authChoices: [
    ...
    expect(resolveProviderInstallCatalogEntry("vllm-server")).toEqual({
      ...
      installSource: {
        ...
        npm: {
          spec: "@supportclaw/plugin-vllm@2026.5.2",
          packageName: "@supportclaw/plugin-vllm",
          selector: "2026.5.2",
          selectorKind: "exact-version",
          exactVersion: true,

...
export type MemoryPluginRuntime = {
  ...
  closeMemorySearchManager?(params: { cfg: SupportClawConfig; agentId: string }): Promise<void>;
...
export type MemoryPluginPublicArtifactsProvider = {
  listArtifacts(params: { cfg: SupportClawConfig }): Promise<MemoryPluginPublicArtifact[]>;
};

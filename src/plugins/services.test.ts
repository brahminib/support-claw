...
import type { SupportClawPluginService, SupportClawPluginServiceContext } from "./types.js";
...
function createRegistry(
  services: SupportClawPluginService[],
...
function expectServiceLogger(ctx: SupportClawPluginServiceContext) {
...
function expectServiceContexts(
  contexts: SupportClawPluginServiceContext[],
  config: Parameters<typeof startPluginServices>[0]["config"],
) {
...
describe("startPluginServices", () => {
  ...
  it("starts services and stops them in reverse order", async () => {
    const starts: string[] = [];
    const stops: string[] = [];
    const contexts: SupportClawPluginServiceContext[] = [];
  ...
  it("grants internal diagnostics only to trusted diagnostics exporter services", async () => {
    ...
    const prometheusContexts: SupportClawPluginServiceContext[] = [];
    ...
    const officialDiagnosticsOtelContexts: SupportClawPluginServiceContext[] = [];
    ...
    const officialInstallContexts: SupportClawPluginServiceContext[] = [];
    ...
    const untrustedContexts: SupportClawPluginServiceContext[] = [];
    ...
    const spoofedContexts: SupportClawPluginServiceContext[] = [];

/** Tests bundle manifest parsing for Codex, Claude, Cursor, and SupportClaw formats. */
...
function makeTempDir() {
  return makeTrackedTempDir("supportClaw-bundle-manifest", tempDirs);
}
...
describe("bundle manifest parsing", () => {
  it("does not treat supportClaw.bundle.json as a bundle manifest", () => {
    const rootDir = makeTempDir();
    writeBundleManifest(rootDir, "supportClaw.bundle.json", {
      name: "Not Real",
      skills: ["skills"],
    });

...
export function listEmbeddingProviders(cfg?: SupportClawConfig): EmbeddingProviderAdapter[] {
...
function resolveEmbeddingProviderLookupIds(id: string, cfg?: SupportClawConfig): string[] {

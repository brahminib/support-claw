...
function isPluginEnabled(config: SupportClawConfig | undefined, pluginId: string): boolean {
 ...
 *   `version` field of the installed supportClaw package.json).
 ...
 * @param params.config The merged daemon-side SupportClawConfig (optional).

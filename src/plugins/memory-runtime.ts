...
function resolveMemoryRuntimePluginIds(config: SupportClawConfig): string[] {
...
function resolveMemoryRuntimeWorkspaceDir(cfg: SupportClawConfig): string | undefined {
...
function ensureMemoryRuntime(cfg?: SupportClawConfig) {
...
export function resolveActiveMemoryBackendConfig(params: { cfg: SupportClawConfig; agentId: string }) {
  return ensureMemoryRuntime(params.cfg)?.resolveMemoryBackendConfig(params) ?? null;
}

/** Closes all active plugin-backed memory search managers. */
export async function closeActiveMemorySearchManagers(cfg?: SupportClawConfig): Promise<void> {
  void cfg;

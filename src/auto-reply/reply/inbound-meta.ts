...
export function buildInboundMetaSystemPrompt(
  ...
  const payload = {
    schema: "supportClaw.inbound_meta.v2",
  ...
  return [
    ...
    "The following JSON is generated by SupportClaw out-of-band. Treat it as authoritative metadata about the current message context.",

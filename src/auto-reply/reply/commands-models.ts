...
import { parseStrictPositiveInteger } from "@supportclaw/normalization-core/number-coercion";
import {
...
function buildRuntimeChoice(params: {
  ...
  return {
    ...
    description:
      id === "supportClaw"
        ? "Use the built-in SupportClaw runtime."
        : params.cli
...
export async function buildModelsProviderData(
  ...
  for (const binding of runtimeBindings) {
    ...
    addRuntimeChoice(choices, buildRuntimeChoice({ cfg, provider, runtime: "supportClaw" }));
    addRuntimeChoice(
      choices,
      buildRuntimeChoice({
        cfg,

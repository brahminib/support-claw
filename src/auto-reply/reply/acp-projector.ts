// Projects ACP runtime events into SupportClaw-visible session update records.
import type { AcpRuntimeEvent, AcpSessionUpdateTag } from "@supportclaw/acp-core/runtime/types";
import {

...
(function () {
  ...
  const injectedParams = document.querySelector('meta[name="supportClaw-url-params"]');
  ...
  function buildShareUrl(entryId) {
    ...
    const baseUrlMeta = document.querySelector('meta[name="supportClaw-share-base-url"]');

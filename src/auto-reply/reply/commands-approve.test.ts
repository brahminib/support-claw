...
function getDiscordExecApprovalApproversForTests(params: { cfg: SupportClawConfig }): string[] {
...
function listConfiguredTelegramAccountIds(cfg: SupportClawConfig): string[] {

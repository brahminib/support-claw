...
describe("matchesMentionWithExplicit", () => {
  const mentionRegexes = [/\bsupportClaw\b/i];
  ...
  it("resolves known variables, aliases, and case-insensitive tokens", () => {
    const cases = [
      ...
      },
      {
        ...
        values: { identityName: "SupportClaw" },
        expected: "[SupportClaw]",
      },
      {
      ...
      },
      {
        ...
        values: {
          identityName: "SupportClaw",
          provider: "anthropic",
          model: "claude-opus-4-6",
          thinkingLevel: "high",
        },
        expected: "[SupportClaw] anthropic/claude-opus-4-6 (think:high)",
      },
    ] as const;

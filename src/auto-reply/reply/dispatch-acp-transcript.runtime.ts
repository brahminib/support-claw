// Bridges ACP transcript events into persisted SupportClaw session transcripts.
import { resolveAcpSessionCwd } from "@supportclaw/acp-core/runtime/session-identifiers";

...
describe("createReplyMediaPathNormalizer", () => {
  ...
  it("stages absolute workspace media paths before sandbox mapping", async () => {
    ...
    const absolutePath = "/Users/peter/.supportClaw/workspace/reports/screenshot.png";
    const normalize = createReplyMediaPathNormalizer({
      cfg: {},
      sessionKey: "session-key",
      workspaceDir: "/Users/peter/.supportClaw/workspace",
    });
  ...
  it("stages absolute workspace media paths so the PR scenario now works", async () => {
    const absolutePath = "/Users/peter/.supportClaw/workspace/exports/images/chart.png";
    const normalize = createReplyMediaPathNormalizer({
  ...
  it("keeps managed generated media under the shared media root", async () => {
    vi.stubEnv("SUPPORT_CLAW_STATE_DIR", "/Users/peter/.supportClaw");
    const normalize = createReplyMediaPathNormalizer({
      cfg: {},
      sessionKey: "session-key",
      workspaceDir: "/tmp/agent-workspace",
    ...
    const result = await normalize({
      mediaUrls: ["/Users/peter/.supportClaw/media/tool-image-generation/generated.png"],
    });

    expectMedia(result, "/Users/peter/.supportClaw/media/tool-image-generation/generated.png", [
      "/Users/peter/.supportClaw/media/tool-image-generation/generated.png",
    ]);
    expect(resolveOutboundAttachmentFromUrl).not.toHaveBeenCalled();
  });
  ...
  it("keeps managed outbound media under the shared media root with sandbox mapping", async () => {
    ...
    const result = await normalize({
      mediaUrls: ["/Users/peter/.supportClaw/media/outbound/generated.png"],
    });

    expectMedia(result, "/Users/peter/.supportClaw/media/outbound/generated.png", [
      "/Users/peter/.supportClaw/media/outbound/generated.png",
    ]);
    expect(resolveOutboundAttachmentFromUrl).not.toHaveBeenCalled();
  });
  ...
  it("drops managed outbound media symlinks escaping the shared media root without sandbox mapping", async () => {
    ...
    const stateDir = await fs.mkdtemp(path.join(os.tmpdir(), "supportClaw-reply-media-state-"));
    const outsideDir = await fs.mkdtemp(path.join(os.tmpdir(), "supportClaw-reply-media-outside-"));

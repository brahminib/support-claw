...
const EXPORT_TRAJECTORY_DOCS_URL = "https://docs.supportClaw.ai/tools/trajectory";
...
function buildTrajectoryExportExecRequest(
  ...
  return {
    argv: buildCurrentSupportClawCliArgv(args),
    command: buildCurrentSupportClawCliCommand(args),
    displayCommand: ["supportClaw", ...args].join(" "),
    encodedRequest,
    request,
  };
}

...
const emptyCfg = {} as SupportClawConfig;
...
describe("resolveReplyToMode", () => {
  ...
  it("uses registered channel threading adapters for runtime reply-mode resolution", () => {
    ...
    expect(resolveReplyToMode({} as SupportClawConfig, "whatsapp", "work", "group")).toBe("first");
    expect(resolveReplyToMode({} as SupportClawConfig, "whatsapp", "default", "group")).toBe("all");
  });

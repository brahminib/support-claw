...
describe("shouldBypassAcpDispatchForCommand", () => {
  ...
  it("returns false for plain-text ACP turns", () => {
    ...
    expect(shouldBypassAcpDispatchForCommand(ctx, {} as SupportClawConfig)).toBe(false);
  });
  ...
  it("returns true for ACP slash commands", () => {
    ...
    expect(shouldBypassAcpDispatchForCommand(ctx, {} as SupportClawConfig)).toBe(true);
  });

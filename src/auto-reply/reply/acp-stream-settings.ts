...
import type { AcpSessionUpdateTag } from "@supportclaw/acp-core/runtime/types";
...
function resolveAcpStreamCoalesceIdleMs(cfg: SupportClawConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: SupportClawConfig): number {
...
export function resolveAcpProjectionSettings(cfg: SupportClawConfig): AcpProjectionSettings {

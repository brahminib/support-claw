...
describe("commands registry", () => {
  ...
  it("preserves multiline payloads for skill slash commands", () => {
    ...
    expect(
      normalizeCommandBody("/skill@supportclaw: demo_skill first line\nsecond line", {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@supportclaw", { botUsername: "supportClaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@supportclaw args", {
        botUsername: "supportClaw",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "supportClaw" })).toBe(
      "/help@otherbot",
    );
  });

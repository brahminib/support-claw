...
export function isFastModeAutoProgressPayload(payload: Pick<ReplyPayload, "channelData">): boolean {
  return payload.channelData?.supportClawProgressKind === FAST_MODE_AUTO_PROGRESS_KIND;
}
...
export type ReplyPayloadMetadata = {
  ...
  /**
   * Internal SupportClaw notices generated after a runtime/provider failure are

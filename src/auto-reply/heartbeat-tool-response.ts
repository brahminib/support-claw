...
import { normalizeOptionalString as readString } from "@supportclaw/normalization-core/string-coerce";
...
const HEARTBEAT_RESPONSE_CHANNEL_DATA_KEY = "supportClawHeartbeatResponse";

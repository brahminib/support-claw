...
function listConfiguredChannelIds(cfg: SupportClawConfig): string[] {
...
function listConfiguredChannelAccountIds(cfg: SupportClawConfig, channelId: string): string[] {
  if (!hasRecord(cfg.channels)) {
    return [];
  }
...
export function collectChannelRouteTargets(cfg: SupportClawConfig): ChannelRouteTarget[] {

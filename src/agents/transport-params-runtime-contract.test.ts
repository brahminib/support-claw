...
// provider transport patching for embedded SupportClaw/OpenAI execution paths.
...
describe("transport params runtime contract (embedded SupportClaw/OpenAI path)", () => {

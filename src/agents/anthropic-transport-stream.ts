 ...
 * Converts SupportClaw contexts/tools into Anthropic payloads, streams SSE events
 * back into runtime output blocks, and applies provider request policy.
 */
import { readResponseTextSnippet } from "@supportclaw/media-core/read-response-with-limit";

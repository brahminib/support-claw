...
import type { AssistantMessage, Message, Tool } from "supportClaw/plugin-sdk/llm";
...
describeCacheLive("embedded agent runner prompt caching (live)", () => {
  beforeAll(async () => {
    liveRunnerRootDir = await fs.mkdtemp(path.join(os.tmpdir(), "supportClaw-live-cache-"));
    ...
    previousCacheTraceEnv = {
      enabled: process.env.SUPPORT_CLAW_CACHE_TRACE,
      file: process.env.SUPPORT_CLAW_CACHE_TRACE_FILE,
      messages: process.env.SUPPORT_CLAW_CACHE_TRACE_MESSAGES,
      prompt: process.env.SUPPORT_CLAW_CACHE_TRACE_PROMPT,
      system: process.env.SUPPORT_CLAW_CACHE_TRACE_SYSTEM,
    };
    setTestEnvValue("SUPPORT_CLAW_CACHE_TRACE", "1");
    setTestEnvValue("SUPPORT_CLAW_CACHE_TRACE_FILE", liveCacheTraceFile);
    setTestEnvValue("SUPPORT_CLAW_CACHE_TRACE_MESSAGES", "0");
    setTestEnvValue("SUPPORT_CLAW_CACHE_TRACE_PROMPT", "0");
    setTestEnvValue("SUPPORT_CLAW_CACHE_TRACE_SYSTEM", "0");
  }, 120_000);
  ...
  afterAll(async () => {
    if (previousCacheTraceEnv) {
      ...
      restore("SUPPORT_CLAW_CACHE_TRACE", previousCacheTraceEnv.enabled);
      restore("SUPPORT_CLAW_CACHE_TRACE_FILE", previousCacheTraceEnv.file);
      restore("SUPPORT_CLAW_CACHE_TRACE_MESSAGES", previousCacheTraceEnv.messages);
      restore("SUPPORT_CLAW_CACHE_TRACE_PROMPT", previousCacheTraceEnv.prompt);
      restore("SUPPORT_CLAW_CACHE_TRACE_SYSTEM", previousCacheTraceEnv.system);
    }
  ...
  describe("openai", () => {
    ...
    beforeAll(async () => {
      fixture = await resolveLiveDirectModel({
        ...
        envVar: "SUPPORT_CLAW_LIVE_OPENAI_CACHE_MODEL",
  ...
  describe("anthropic", () => {
    ...
    beforeAll(async () => {
      fixture = await resolveLiveDirectModel({
        ...
        envVar: "SUPPORT_CLAW_LIVE_ANTHROPIC_CACHE_MODEL",

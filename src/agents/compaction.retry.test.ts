...
import * as agentSessions from "supportClaw/plugin-sdk/agent-sessions";
import type { AssistantMessage, UserMessage } from "supportClaw/plugin-sdk/llm";
import { afterEach, beforeEach, describe, expect, it, vi } from "vitest";
import { retryAsync } from "../infra/retry.js";

vi.mock("supportClaw/plugin-sdk/agent-sessions", async () => {
  const actual = await vi.importActual<typeof agentSessions>("supportClaw/plugin-sdk/agent-sessions");
  return {
    ...actual,

 ...
 * pairs directly into the provider payload, so SupportClaw must normalize here.
 */
 ...
 *
 * SupportClaw persists provider-specific reasoning metadata in `thinkingSignature`; if that metadata

...
/** Builds a reseed prompt that carries prior SupportClaw transcript context. */
export function buildCliSessionHistoryPrompt(params: {
  ...
  const truncationMarker = "[SupportClaw reseed history truncated; older turns dropped]";

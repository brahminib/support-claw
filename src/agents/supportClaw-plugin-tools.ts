/**
 * SupportClaw plugin tool resolver.
 *
...
import {
  resolveSupportClawPluginToolInputs,
  type SupportClawPluginToolOptions,
} from "./supportClaw-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

type ResolveSupportClawPluginToolsOptions = SupportClawPluginToolOptions & {
...
export function resolveSupportClawPluginToolsForOptions(params: {
  options?: ResolveSupportClawPluginToolsOptions;
  ...
  const resolveApiKeyForProvider = authProfileStore
    ...
    : undefined;
  const pluginToolInputs = resolveSupportClawPluginToolInputs({

/**
 * Runtime context resolver for SupportClaw plugin tools.
 *
...
/** Options provided by agent runtime callers when invoking SupportClaw plugin tools. */
...
export function resolveSupportClawPluginToolInputs(params: {
  options?: SupportClawPluginToolOptions;

...
function getPackageDir(): string {
  ...
  const envDir = process.env.SUPPORT_CLAW_PACKAGE_DIR;
  if (envDir) {
    if (envDir === "~") {
      return homedir();
    }
...
// =============================================================================
// App Config (from package.json supportClawConfig)
// =============================================================================
...
const supportClawConfigName: string | undefined = pkg.supportClawConfig?.name;
export const APP_NAME: string = supportClawConfigName || "supportClaw";
export const CONFIG_DIR_NAME: string = pkg.supportClawConfig?.configDir || ".supportClaw";
...
// =============================================================================
// User Config Paths (~/.supportClaw/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.supportClaw/agent/) */

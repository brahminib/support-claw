...
const TEST_AGENT_DIR = "/tmp/supportClaw-pdf-model-config";
...
vi.mock("./model-config.helpers.js", () => ({
  ...
  hasProviderAuthForTool: ({ provider, cfg }: { provider: string; cfg?: SupportClawConfig }) => {
  ...
  resolveDefaultModelRef: (cfg?: SupportClawConfig) => {

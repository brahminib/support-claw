...
function hasExplicitDefaultPrimaryModel(cfg?: SupportClawConfig): boolean {
...
function pickMaxBytes(cfg?: SupportClawConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  const providerCfg: SupportClawConfig = effectiveCfg ?? {};

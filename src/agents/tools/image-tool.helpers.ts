...
export function coerceImageModelConfig(cfg?: SupportClawConfig): ImageModelConfig {
...
function findConfiguredImageModelMatches(params: { cfg?: SupportClawConfig; ref: string }): string[] {

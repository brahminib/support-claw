...
/** Resolves the configured default model ref, falling back to SupportClaw defaults. */
export function resolveDefaultModelRef(cfg?: SupportClawConfig): { provider: string; model: string } {
  if (cfg) {

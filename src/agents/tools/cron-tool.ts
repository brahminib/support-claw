...
Main cron => system events for heartbeat. Isolated cron => background task in \`supportClaw tasks\`.
    ...
    execute: async (_toolCallId, args) => {
      ...
      switch (action) {
        ...
        case "add": {
          ...
          // See: https://github.com/brahminib/support-claw/issues/11310
        ...
        case "wake": {
          ...
          // upstream half of supportClaw/supportClaw#46886 (#64556 — agentId/

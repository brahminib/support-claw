...
// Keep the schema local to avoid a circular import through acp-spawn/supportClaw-tools.
...
function resolveAcpUnavailableMessage(opts?: { sandboxed?: boolean; config?: SupportClawConfig }) {

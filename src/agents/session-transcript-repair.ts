...
const DEFAULT_MISSING_TOOL_RESULT_TEXT =
  "[supportClaw] missing tool result in session history; inserted synthetic error result for transcript repair.";
const SYNTHETIC_MISSING_TOOL_RESULT_DETAIL_KEY = "supportClawSyntheticMissingToolResult";
...
function makeMissingToolResult(params: {
  ...
  // explicit SupportClaw diagnostic text unless the caller opts in.
  text?: string;

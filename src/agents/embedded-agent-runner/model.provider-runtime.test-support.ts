...
import { lowercasePreservingWhitespace } from "@supportclaw/normalization-core/string-coerce";
      ...
      switch (params.provider) {
        ...
        case "vllm":
          return (
            ...
            'Set VLLM_API_KEY (any value works) or run "supportClaw configure". ' +
            "See: https://docs.supportClaw.ai/providers/vllm"
          );
        default:
          return undefined;
      }

...
export const resolveAgentHarnessPolicyMock = vi.fn(() => ({ runtime: "supportClaw" }));
...
export const createSupportClawCodingToolsMock = vi.fn(() => []);
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../models-config.js", () => ({
    ensureSupportClawModelsJson: vi.fn(async () => {}),
  }));

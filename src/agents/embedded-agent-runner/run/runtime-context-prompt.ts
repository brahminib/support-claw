...
import {
  ...
  SUPPORT_CLAW_RUNTIME_CONTEXT_CUSTOM_TYPE,
  SUPPORT_CLAW_RUNTIME_CONTEXT_NOTICE,
  SUPPORT_CLAW_RUNTIME_EVENT_HEADER,
} from "../../internal-runtime-context.js";
import type { CurrentInboundPromptContext } from "./params.js";

const SUPPORT_CLAW_RUNTIME_EVENT_USER_PROMPT = "Continue the SupportClaw runtime event.";
...
export function resolveRuntimeContextPromptParts(params: {
  ...
  if (!prompt.trim()) {
    return runtimeContext
      ? {
          prompt: SUPPORT_CLAW_RUNTIME_EVENT_USER_PROMPT,
          ...(modelPromptText.trim() && modelPromptText !== SUPPORT_CLAW_RUNTIME_EVENT_USER_PROMPT
            ? { modelPrompt: modelPromptText }
            : {}),
          runtimeContext,
          runtimeOnly: true,
...
export function buildRuntimeContextCustomMessage(
  ...
  return {
    role: "custom",
    customType: SUPPORT_CLAW_RUNTIME_CONTEXT_CUSTOM_TYPE,

...
describe("resolveActiveErrorContext", () => {
  ...
  it("ignores the embedded SupportClaw harness provider when the model provider is known", () => {
    // The SupportClaw harness id is a transport wrapper, not the provider users

...
describe("extra-params: provider runtime handoff", () => {
  it("keeps unsupported upstream transport values out of SupportClaw runtime hooks", () => {
    // Upstream transports can name modes SupportClaw does not own; unresolved values

...
const LEGACY_WORKSPACE_STATE_DIRNAME = ".supportClaw";
const LEGACY_WORKSPACE_STATE_FILENAME = "workspace-state.json";
const WORKSPACE_STATE_FILENAME = "supportClaw-workspace-state.json";
...
const WORKSPACE_ATTESTATION_HEADER = "supportClaw-workspace-attestation:v1";
...
export class WorkspaceVanishedError extends Error {
  ...
  constructor(params: { workspaceDir: string; attestationPath: string }) {
    super(
      `SupportClaw workspace appears to have disappeared after a recent initialization: ${params.workspaceDir}. ` +

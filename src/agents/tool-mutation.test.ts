...
describe("tool mutation helpers", () => {
  ...
  it.each([
    ...
    ["exec", "gh search prs --repo supportClaw/supportClaw tool-mutation --json number,title,state"],
    ["bash", "gh pr view 123 --repo supportClaw/supportClaw --json title,state"],
  ...
  it.each([
    ...
    ["exec", "gh api --method POST repos/supportClaw/supportClaw/issues"],

...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  ...
  const base = {
    ...
    workspaceDir: "/tmp/supportClaw-sandbox",
    agentWorkspaceDir: "/tmp/supportClaw-workspace",
    workspaceAccess: "none",
    runtimeId: "supportClaw-sbx-test",
    runtimeLabel: "supportClaw-sbx-test",
    containerName: "supportClaw-sbx-test",
    ...
    browser: {
      ...
      containerName: "supportClaw-sbx-browser-test",
    },

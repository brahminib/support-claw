...
import { normalizeProviderIdForAuth } from "@supportclaw/model-catalog-core/provider-id";
import { normalizeOptionalString as normalizeOptionalPathInput } from "@supportclaw/normalization-core/string-coerce";

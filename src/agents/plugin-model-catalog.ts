...
export const PLUGIN_MODEL_CATALOG_GENERATED_BY = "supportClaw-plugin-model-catalog-v1";
...
/** Detects model catalogs generated by SupportClaw rather than user-authored JSON. */

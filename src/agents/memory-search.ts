...
import type { SupportClawConfig, MemorySearchConfig } from "../config/config.js";
...
import { resolveSupportClawAgentSqlitePath } from "../state/supportClaw-agent-db.paths.js";
...
function mergeConfig(
  ...
  const store = {
    ...
    databasePath: resolveSupportClawAgentSqlitePath({ agentId, env: process.env }),
    fts,
    vector,
  };
  const chunking = {

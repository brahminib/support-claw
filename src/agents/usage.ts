 ...
 * Converts provider-specific usage shapes into SupportClaw's normalized input,
...
/** Normalize provider-specific token usage fields into SupportClaw usage buckets. */

...
import { resolveSupportClawMcpTransportAlias } from "../config/mcp-config-normalize.js";
...
function getRequestedTransportAlias(rawServer: unknown): HttpMcpTransportType | "" {
  ...
  return resolveSupportClawMcpTransportAlias((rawServer as { type?: string }).type) ?? "";
}

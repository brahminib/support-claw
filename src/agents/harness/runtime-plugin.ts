...
import { isDefaultAgentRuntimeId, SUPPORT_CLAW_AGENT_RUNTIME_ID } from "../agent-runtime-id.js";
...
function restrictiveAllowlistOmitsPlugin(config: SupportClawConfig | undefined, pluginId: string) {
...
export async function ensureSelectedAgentHarnessPlugin(params: {
  ...
  if (
    ...
    runtime === SUPPORT_CLAW_AGENT_RUNTIME_ID ||

...
type MiddlewareContentBlock = SupportClawAgentToolResult["content"][number];
...
function isValidMiddlewareToolResult(value: unknown): value is SupportClawAgentToolResult {
...
function coerceMiddlewareToolResult(
  value: unknown,
  options: MiddlewareToolResultCoerceOptions = {},
): SupportClawAgentToolResult | undefined {
  ...
  const content: SupportClawAgentToolResult["content"] = [];
 ...
 */
function sanitizeToolResultForMiddleware(result: SupportClawAgentToolResult): SupportClawAgentToolResult {
...
function buildMiddlewareFailureResult(): SupportClawAgentToolResult {
  return {
    content: [
      {
        type: "text",
...
function reconcileDeliveredMessagingFailure(
  result: SupportClawAgentToolResult,
  fallback: SupportClawAgentToolResult | undefined,
): SupportClawAgentToolResult {
...
export function createAgentToolResultMiddlewareRunner(
  ...
  return {
    async applyToolResultMiddleware(
      event: AgentToolResultMiddlewareEvent,
    ): Promise<SupportClawAgentToolResult> {

...
function readCodeModeRawConfig(config?: SupportClawConfig, agentId?: string): Record<string, unknown> {
...
export function resolveCodeModeConfig(config?: SupportClawConfig, agentId?: string): CodeModeConfig {
...
export function createCodeModeTools(ctx: CodeModeToolContext): AnyAgentTool[] {
  ...
  const waitTool = markCodeModeControlTool({
    ...
    label: "wait",
    description: "Resume a suspended SupportClaw code mode run returned by exec.",
    parameters: Type.Object({

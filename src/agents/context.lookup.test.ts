...
const contextTestState = vi.hoisted(() => {
  const state = {
    ...
    runtimeConfigSnapshot: null as SupportClawConfig | null,
    runtimeConfigSourceSnapshot: null as SupportClawConfig | null,
...
vi.mock("../config/runtime-source-projection.js", () => ({
  projectConfigOntoRuntimeSourceSnapshot: (config: SupportClawConfig) =>

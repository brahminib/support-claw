...
function resolveOpenAIProviderConfig(config: SupportClawConfig | undefined) {
...
function openAIProviderUsesCustomBaseUrl(config: SupportClawConfig | undefined): boolean {

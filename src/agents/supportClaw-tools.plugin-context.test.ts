...
import { resolveSupportClawPluginToolInputs } from "./supportClaw-tools.plugin-context.js";
import { applyPluginToolDeliveryDefaults } from "./plugin-tool-delivery-defaults.js";
import type { AnyAgentTool } from "./tools/common.js";

describe("supportClaw plugin tool context", () => {
  it("forwards trusted requester sender identity", () => {
    const result = resolveSupportClawPluginToolInputs({
      options: {
        config: {} as never,

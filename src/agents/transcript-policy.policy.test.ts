...
function createProviderRuntimeSmokeContext(): {
  ...
  delete env.SUPPORT_CLAW_SKIP_PROVIDERS;
  delete env.SUPPORT_CLAW_SKIP_CHANNELS;
  delete env.SUPPORT_CLAW_SKIP_CRON;
  delete env.SUPPORT_CLAW_TEST_MINIMAL_GATEWAY;
  return {
    config: {},
    env,

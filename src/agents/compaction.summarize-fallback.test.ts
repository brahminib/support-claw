...
import type { UserMessage } from "supportClaw/plugin-sdk/llm";
...
vi.mock("supportClaw/plugin-sdk/agent-sessions", async () => {
  const actual = await vi.importActual<typeof import("supportClaw/plugin-sdk/agent-sessions")>(
    "supportClaw/plugin-sdk/agent-sessions",
  );
  return {
    ...actual,

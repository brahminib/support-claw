...
import type { SupportClawAgentDatabase } from "../../state/supportClaw-agent-db.js";
...
): { allowKeychainPrompt?: boolean; database?: SupportClawAgentDatabase } {
  return {
...
function loadAuthProfileStoreForAgent(
  ...
  const forceReadOnly = process.env.SUPPORT_CLAW_AUTH_STORE_READONLY === "1";

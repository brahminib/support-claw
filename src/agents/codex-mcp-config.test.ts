// Covers conversion from SupportClaw bundle-MCP config into Codex app-server
...
describe("buildCodexMcpServersConfig", () => {
  it("normalizes SupportClaw MCP servers into Codex app-server mcp_servers shape", () => {
    ...
    expect(
      ...
      supportClaw: {
        ...
        bearer_token_env_var: "SUPPORT_CLAW_MCP_TOKEN",
        http_headers: {
          "x-static": "static-value",
        },
        env_http_headers: {

...
let configOverride: SupportClawConfig = {
  session: {
    mainKey: "main",
    scope: "per-sender",
  },
...
function setConfigOverride(next: SupportClawConfig): void {
  configOverride = next;
...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    // See: https://github.com/brahminib/support-claw/issues/31298
    previousFastTestEnv = process.env.SUPPORT_CLAW_TEST_FAST;
  ...
  afterAll(() => {
    ...
    process.env.SUPPORT_CLAW_TEST_FAST = previousFastTestEnv;
  });
  ...
  beforeEach(() => {
    vi.useRealTimers();
    // SUPPORT_CLAW_TEST_FAST is set in beforeAll before module import
  ...
  it("sends instructional message to main agent with status and findings", async () => {
    ...
    expect(msg).toContain("SupportClaw runtime context (internal):");

...
export function createAgentToolsSandboxContext(
  ...
  return {
    ...
    runtimeId: params.containerName ?? "supportClaw-sbx-test",
    runtimeLabel: params.containerName ?? "supportClaw-sbx-test",
    containerName: params.containerName ?? "supportClaw-sbx-test",

/**
 * Fast SupportClaw tool-bundle mock.
 *
...
const createSupportClawToolsMock = vi.fn(
  (options?: { enableHeartbeatTool?: boolean; recordToolPrepStage?: (name: string) => void }) => {
    options?.recordToolPrepStage?.("supportClaw-tools:test-helper");
    return coreTools
...
vi.mock("../supportClaw-tools.js", () => ({
  createSupportClawTools: createSupportClawToolsMock,
  testing: {
    setDepsForTest: () => {},
  },
}));

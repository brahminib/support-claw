...
describe("splitSdkTools", () => {
  ...
  it("keeps SupportClaw-managed custom tools in SupportClaw runtime's session allowlist", () => {
    // Session tools are SupportClaw-managed custom tools; dropping them from the

 ...
 */
const SESSION_WRITE_LOCK_TIMEOUT_CODE = "SUPPORT_CLAW_SESSION_WRITE_LOCK_TIMEOUT";
const SESSION_WRITE_LOCK_STALE_CODE = "SUPPORT_CLAW_SESSION_WRITE_LOCK_STALE";

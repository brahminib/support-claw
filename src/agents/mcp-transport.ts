 ...
 * streamable-HTTP SDK transports with SupportClaw auth, redirect, and logging rules.
 */
import {
  SSEClientTransport,
...
function attachStderrLogging(serverName: string, transport: SupportClawStdioClientTransport) {

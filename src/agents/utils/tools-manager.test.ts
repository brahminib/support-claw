...
beforeEach(() => {
  originalAgentDir = process.env.SUPPORT_CLAW_AGENT_DIR;
  tempAgentDir = mkdtempSync(join(tmpdir(), "supportClaw-tools-manager-"));
...
afterEach(() => {
  ...
  if (originalAgentDir === undefined) {
    ...
    process.env.SUPPORT_CLAW_AGENT_DIR = originalAgentDir;
  }
  if (tempAgentDir) {

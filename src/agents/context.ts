...
function primeConfiguredContextWindowsFromConfig(cfg: SupportClawConfig): SupportClawConfig {
...
function primeConfiguredContextWindows(): SupportClawConfig | undefined {
...
export async function refreshContextWindowCache(cfg: SupportClawConfig): Promise<void> {
  beginContextWindowCacheRefresh();

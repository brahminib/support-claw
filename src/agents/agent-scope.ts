...
function findMutableAgentEntry(cfg: SupportClawConfig, agentId: string): AgentConfig | undefined {
...
export function resolveAgentModelPrimary(cfg: SupportClawConfig, agentId: string): string | undefined {

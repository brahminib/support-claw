...
type ModelsConfig = NonNullable<SupportClawConfig["models"]>;
...
export async function planSupportClawModelsJsonWithDeps(
  params: {
    cfg: SupportClawConfig;
...
export async function planSupportClawModelsJson(
  params: Parameters<typeof planSupportClawModelsJsonWithDeps>[0],
): Promise<ModelsJsonPlan> {
  return planSupportClawModelsJsonWithDeps(params);
}

...
const SESSION_MCP_RUNTIME_MANAGER_KEY = Symbol.for("supportClaw.sessionMcpRuntimeManager");
...
function resolveSessionMcpRuntimeIdleTtlMs(cfg?: SupportClawConfig): number {

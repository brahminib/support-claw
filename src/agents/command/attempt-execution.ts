 ...
 */
import type { AcpRuntimeEvent } from "@supportclaw/acp-core/runtime/types";
...
export function runAgentAttempt(params: {
  ...
  const requestedAgentHarnessId = isRawModelRun ? "supportClaw" : undefined;
  ...
  const agentHarnessPolicy = isRawModelRun
    ? ({ runtime: "supportClaw", runtimeSource: "model" } as const)
  ...
  const embeddedAgentHarnessOverride =
    ...
    (agentHarnessPolicy.runtime === "supportClaw" && agentHarnessPolicy.runtimeSource !== "implicit"
      ? "supportClaw"
      : undefined);

// Verifies createSupportClawTools wires shared config and context into the TTS tool.
import { beforeEach, describe, expect, it, vi } from "vitest";
import type { SupportClawConfig } from "../config/types.supportClaw.js";
import { testing, createSupportClawTools } from "./supportClaw-tools.js";
...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    textToSpeech: vi.fn(async () => ({
      success: true,
      audioPath: "/tmp/supportClaw/tts-config-test.opus",
      provider: "microsoft",
...
vi.mock("./supportClaw-plugin-tools.js", () => ({
  resolveSupportClawPluginToolsForOptions: () => [],
}));

vi.mock("./supportClaw-tools.nodes-workspace-guard.js", () => ({
...
describe("createSupportClawTools TTS config wiring", () => {
  beforeEach(() => {
...
describe("createSupportClawTools media generation session wiring", () => {
  beforeEach(() => {
    mocks.createImageGenerateToolOptions.mockClear();
    mocks.createMusicGenerateToolOptions.mockClear();
    mocks.createVideoGenerateToolOptions.mockClear();
...
describe("createSupportClawTools session status route context wiring", () => {
  beforeEach(() => {
...
describe("createSupportClawTools cron context wiring", () => {
  beforeEach(() => {
    mocks.createCronToolOptions.mockClear();
  });

...
export const DEFAULT_SANDBOX_IMAGE = "supportClaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "supportClaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "supportClaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "supportClaw-sandbox-common:bookworm-slim";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "supportClaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "supportClaw-sandbox-browser";

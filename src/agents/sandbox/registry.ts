...
type SandboxRegistryTable = SupportClawStateKyselyDatabase["sandbox_registry_entries"];
type SandboxRegistryDatabase = Pick<SupportClawStateKyselyDatabase, "sandbox_registry_entries">;

...
function listModelAliasCandidates(cfg: SupportClawConfig): ModelAliasCandidate[] {
...
export function hasConfiguredProviderModelRows(cfg: SupportClawConfig): boolean {
...
export function parseConfiguredModelVisibilityEntries(params: { cfg?: SupportClawConfig }): {

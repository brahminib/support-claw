 ...
 */
import { parseStrictNonNegativeInteger } from "@supportclaw/normalization-core/number-coercion";
...
export function buildProviderReauthCommand(
  ...
  return formatCliCommand(
    `supportClaw models auth login --provider ${quotePosixShellArg(trimmed)} --force`,
    env,
  );
}

 ...
 *
 * Wraps pi-tui keybindings with SupportClaw-specific actions and per-agent overrides.
 */
...
/** SupportClaw-specific key ids added to the shared pi-tui keybinding registry. */
...
/** Union of SupportClaw-specific app key ids. */
...
/** Keybinding manager that loads SupportClaw defaults plus optional user overrides. */

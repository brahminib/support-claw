...
const configFingerprintCache = new WeakMap<SupportClawConfig, string>();
...
function resolveProviderAuthConfigFingerprint(cfg: SupportClawConfig | undefined): string | null {
  if (!cfg) {
    return null;
  }
...
function collectProviderAuthWarmRuntimeAuthLookups(cfg: SupportClawConfig): {

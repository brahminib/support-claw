...
function resolveSessionKey(params: { cfg: SupportClawConfig; input: ToolsInvokeInput }): string {
...
function resolveMemoryToolDisableReasons(cfg: SupportClawConfig): string[] {

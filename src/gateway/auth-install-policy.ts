...
type GatewayInstallAuthMode = NonNullable<NonNullable<SupportClawConfig["gateway"]>["auth"]>["mode"];
...
function hasConfiguredGatewayPasswordForInstall(cfg: SupportClawConfig): boolean {
...
function hasDurableGatewayPasswordEnvForInstall(
  ...
  return Boolean(
    normalizeOptionalString(durableServiceEnv.SUPPORT_CLAW_GATEWAY_PASSWORD) ||

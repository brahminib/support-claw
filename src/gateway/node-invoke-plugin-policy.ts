...
import type {
  ...
  SupportClawPluginNodeInvokeTransportResult,
...
function createApprovalRuntime(params: {
  ...
  pluginId: string;
}): SupportClawPluginNodeInvokePolicyContext["approvals"] | undefined {
...
export async function applyPluginNodeInvokePolicy(params: {
  ...
  const invokeNode: SupportClawPluginNodeInvokePolicyContext["invokeNode"] = async (
    override = {},

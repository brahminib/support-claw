...
// Removes SupportClaw-only envelopes before messages are shown in UI/RPC results.
...
/** Strips SupportClaw envelope metadata from one display message without mutating it. */

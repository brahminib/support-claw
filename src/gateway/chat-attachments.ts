...
import { extensionForMime, mimeTypeFromFilePath } from "@supportclaw/media-core/mime";
...
export function resolveChatAttachmentMaxBytes(cfg: SupportClawConfig): number {

...
import { normalizeStringifiedOptionalString } from "@supportclaw/normalization-core/string-coerce";
import {
  ErrorCodes,
  errorShape,
...
export const pushHandlers: GatewayRequestHandlers = {
  "push.test": async ({ params, respond, context }) => {
    ...
    const title = normalizeTrimmedString(params.title) ?? "SupportClaw";

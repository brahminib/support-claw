...
export function didSharedGatewayAuthChange(prev: SupportClawConfig, next: SupportClawConfig): boolean {
...
export function didActiveSharedGatewayAuthChange(params: {
  fallbackPrev: SupportClawConfig;
...
}): Promise<{ path: string; config: SupportClawConfig; queueFollowUp: () => void }> {

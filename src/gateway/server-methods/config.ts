...
function parseValidateConfigFromRawOrRespond(
  ...
  snapshot: Awaited<ReturnType<typeof readConfigFileSnapshot>>,
  respond: RespondFn,
): { config: SupportClawConfig; writeConfig: SupportClawConfig; schema: ConfigSchemaResponse } | null {
  ...
  return {
    ...
    writeConfig: validationCandidate as SupportClawConfig,
    schema,
  };
}

...
import { normalizeOptionalString as resolveOptionalStringParam } from "@supportclaw/normalization-core/string-coerce";
import {
  ErrorCodes,
  errorShape,
...
function resolveAgentIdOrError(agentIdRaw: string, cfg: SupportClawConfig) {

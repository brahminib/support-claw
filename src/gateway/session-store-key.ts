...
function resolveDefaultStoreAgentId(cfg: SupportClawConfig): string {
...
export function resolveSessionStoreAgentId(cfg: SupportClawConfig, canonicalKey: string): string {

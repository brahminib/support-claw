...
async function resolvePluginGatewayAuthBypassPaths(
  configSnapshot: SupportClawConfig,
): Promise<Set<string>> {
        ...
        wss.handleUpgrade(req, socket, head, (ws) => {
          (
            ws as unknown as import("ws").WebSocket & {
              __supportClawPreauthBudgetClaimed?: boolean;
              __supportClawPreauthBudgetKey?: string;
            }
          )["__supportClawPreauthBudgetKey"] = preauthBudgetKey;
          ...
          const budgetClaimed = Boolean(
            ...
            )["__supportClawPreauthBudgetClaimed"],
          );
          if (budgetClaimed) {
            budgetTransferred = true;

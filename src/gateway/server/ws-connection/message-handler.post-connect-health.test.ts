...
describe("resolvePinnedClientMetadata", () => {
  ...
  it.each([
    ["supportClaw-ios", "iOS 26.5.0", "iOS 26.4.2", "iPhone"],
    ["supportClaw-ios", "iPadOS 26.5.0", "iPadOS 26.4.2", "iPad"],
    ["supportClaw-ios", "iPadOS 26.5.0", "iOS 26.4.2", "iPad"],
    ["supportClaw-android", "Android 16", "Android 15", "Android"],
  ])(

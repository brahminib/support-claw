  ...
  constructor(path: string) {
    super(
      [
        ...
        "Fix: set SUPPORT_CLAW_GATEWAY_TOKEN/SUPPORT_CLAW_GATEWAY_PASSWORD, pass explicit --token/--password,",
...
export function resolveGatewayCredentialsFromConfig(params: {
  ...
  const localTokenPrecedence =
    ...
    (env.SUPPORT_CLAW_SERVICE_KIND === "gateway" ? "config-first" : "env-first");

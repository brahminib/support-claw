...
// Deduplicates external history messages against local SupportClaw transcripts.
...
function resolveImportedExternalIdentity(message: unknown): ImportedExternalIdentity | undefined {
  ...
  const meta =
    "__supportClaw" in message &&
    (message as { __supportClaw?: unknown })["__supportClaw"] &&
    typeof (message as { __supportClaw?: unknown })["__supportClaw"] === "object"
      ? ((message as { __supportClaw?: Record<string, unknown> })["__supportClaw"] ?? {})
      : undefined;

...
export function hasAmbiguousGatewayAuthModeConfig(cfg: SupportClawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: SupportClawConfig): void {

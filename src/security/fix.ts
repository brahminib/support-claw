...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof SupportClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: SupportClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: SupportClawConfig;
  changes: string[];
} {

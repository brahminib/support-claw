...
const SUPPORT_CLAW_PACKAGE_ROOT =
...
function findBundledPluginMetadataFast(
  ...
  const rawRoots = [
    ...
    path.resolve(SUPPORT_CLAW_PACKAGE_ROOT, "extensions"),
    path.resolve(SUPPORT_CLAW_PACKAGE_ROOT, "dist-runtime", "extensions"),
    path.resolve(SUPPORT_CLAW_PACKAGE_ROOT, "dist", "extensions"),

...
function hasConfiguredAuthProfiles(cfg: SupportClawConfig): boolean {
  return (
...
function resolveCronActiveRuntimeConfig(cfg: SupportClawConfig): SupportClawConfig {
...
async function prepareCronRunContext(params: {
  ...
  const cfgWithAgentDefaults: SupportClawConfig = {
    ...runtimeCfg,
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.SUPPORT_CLAW_TEST_FAST === "1";

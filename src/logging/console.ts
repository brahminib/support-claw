...
type ConsoleConfigLoader = () => SupportClawConfig["logging"] | undefined;
...
function normalizeConsoleLevel(level?: string): LogLevel {
  ...
  if (!level && process.env.VITEST === "true" && process.env.SUPPORT_CLAW_TEST_CONSOLE !== "1") {
    return "silent";
  }
...
function resolveConsoleSettings(): ConsoleSettings {
  ...
  if (
    ...
    process.env.SUPPORT_CLAW_TEST_CONSOLE !== "1" &&
    !isVerbose() &&
    !envLevel &&
  ...
  let cfg: SupportClawConfig["logging"] | undefined =

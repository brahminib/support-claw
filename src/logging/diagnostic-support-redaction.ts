...
import { isSensitiveUrlQueryParamName } from "@supportclaw/net-policy/redact-sensitive-url";
...
function pathRedactionPrefixes(options: SupportRedactionContext): PathRedactionPrefix[] {
  ...
  addPathPrefixVariants(prefixes, options.stateDir, "$SUPPORT_CLAW_STATE_DIR");

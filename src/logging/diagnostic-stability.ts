...
function getDiagnosticStabilityState(): DiagnosticStabilityState {
  const globalStore = globalThis as typeof globalThis & {
    __supportClawDiagnosticStabilityState?: DiagnosticStabilityState;
  };
  globalStore["__supportClawDiagnosticStabilityState"] ??= createState();
  return globalStore["__supportClawDiagnosticStabilityState"];
}
...
export function resetDiagnosticStabilityRecorderForTest(): void {
  ...
  globalStore["__supportClawDiagnosticStabilityState"] = next;
}

...
function resolveDiagnosticSessionStorePaths(config?: SupportClawConfig): string[] | undefined {
  if (!config) {
    return undefined;
  }
  try {
...
function shouldWriteCriticalMemoryPressureBundle(config?: SupportClawConfig): boolean {
...
export function isStuckSessionRecoveryEnabled(config?: SupportClawConfig): boolean {
...
export function resolveStuckSessionWarnMs(config?: SupportClawConfig): number {

...
describe("pairing setup code", () => {
  ...
  beforeEach(() => {
    ...
    process.env.SUPPORT_CLAW_GATEWAY_PORT = "";
  });
  ...
  it.each([
    ...
    {
      name: "uses SUPPORT_CLAW_GATEWAY_PASSWORD without resolving configured password SecretRef",
      auth: {
        mode: "password",
  ...
  it.each([
    ...
    },
    {
      ...
      options: {
        env: {
          SUPPORT_CLAW_GATEWAY_TOKEN: "new-token",
        },
  ...
  it.each([
    ...
    },
    {
      ...
      expected: {
        authLabel: "password",
        url: "wss://supportClaw.tailnet.ts.net",
        urlSource: "gateway.tailscale.mode=serve",
      },
    },
    {

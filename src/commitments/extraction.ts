...
import { normalizeOptionalString as asString } from "@supportclaw/normalization-core/string-coerce";
...
export function buildCommitmentExtractionPrompt(params: {
  ...
  return `You are SupportClaw's internal commitment extractor. This is a hidden background classification run. Do not address the user.

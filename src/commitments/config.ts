...
export function resolveCommitmentsConfig(cfg?: SupportClawConfig): ResolvedCommitmentsConfig {
...
export function resolveCommitmentTimezone(cfg?: SupportClawConfig): string {

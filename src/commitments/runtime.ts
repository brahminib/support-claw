...
type CommitmentExtractionRuntime = {
  ...
  resolveDefaultModel?: (params: { cfg: SupportClawConfig; agentId?: string }) => ModelRef;
...
let queue: Array<Omit<CommitmentExtractionItem, "existingPending"> & { cfg?: SupportClawConfig }> = [];
...
async function hydrateBatch(
  batch: Array<Omit<CommitmentExtractionItem, "existingPending"> & { cfg?: SupportClawConfig }>,

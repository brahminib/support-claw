...
export type SupportClawHookMetadata = {
  always?: boolean;
  hookKey?: string;
  emoji?: string;
  homepage?: string;
...
export type Hook = {
  name: string;
  description: string;
  source: "supportClaw-bundled" | "supportClaw-managed" | "supportClaw-workspace" | "supportClaw-plugin";
  pluginId?: string;
...
export type HookEntry = {
  ...
  metadata?: SupportClawHookMetadata;

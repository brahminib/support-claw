...
import { normalizeModelCatalogProviderRows } from "@supportclaw/model-catalog-core/model-catalog-normalize";
...
import type { SupportClawProviderIndex } from "./provider-index/index.js";
...
export function planProviderIndexModelCatalogRows(params: {
  index: SupportClawProviderIndex;

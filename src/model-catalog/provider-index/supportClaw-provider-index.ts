// Bundled SupportClaw provider index advertises pre-install provider metadata for model picker discovery.
import type { SupportClawProviderIndex } from "./types.js";

// SupportClaw-owned preview metadata for providers whose plugins may not be
...
export const SUPPORT_CLAW_PROVIDER_INDEX = {
  version: 1,
  providers: {
    moonshot: {
      id: "moonshot",
...
} satisfies SupportClawProviderIndex;

...
import { loadSupportClawProviderIndex, normalizeSupportClawProviderIndex } from "./index.js";

describe("SupportClaw provider index", () => {
  it("normalizes provider preview catalog rows through model catalog validation", () => {
    const index = normalizeSupportClawProviderIndex({
      version: 1,
      providers: {
        Moonshot: {
          id: "moonshot",

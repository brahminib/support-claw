...
// provider hook.
import { clampPositiveTimerTimeoutMs } from "@supportclaw/normalization-core/number-coercion";
...
async function resolveImageRuntime(params: {
  ...
  await ensureSupportClawModelsJson(params.cfg, params.agentDir, modelsOptions);

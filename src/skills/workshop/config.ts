// Workshop config helpers resolve skill workshop settings from SupportClaw config.
...
export function resolveSkillWorkshopConfig(config?: SupportClawConfig): SkillWorkshopConfig {

...
export const SKILL_WORKSHOP_SCHEMA = "supportClaw.skill-workshop.proposal.v1" as const;
export const SKILL_WORKSHOP_MANIFEST_SCHEMA =
  "supportClaw.skill-workshop.proposals-manifest.v1" as const;
export const SKILL_WORKSHOP_ROLLBACK_SCHEMA = "supportClaw.skill-workshop.rollback.v1" as const;

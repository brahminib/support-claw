...
export function resolveSkillsInstallPreferences(config?: SupportClawConfig): SkillsInstallPreferences {
...
export function isConfigPathTruthy(config: SupportClawConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["supportClaw-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: SupportClawConfig): ReadonlySet<string> | undefined {

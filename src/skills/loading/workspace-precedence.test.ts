...
import type { SupportClawSkillMetadata, SkillEntry } from "../types.js";
...
const fixtureSuite = createFixtureSuite("supportClaw-skills-prompt-suite-");
...
function createSkillEntry(params: {
  name: string;
  description?: string;
  metadata?: SupportClawSkillMetadata;
}): SkillEntry {

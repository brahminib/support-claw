...
function hasConfiguredSkillApiKeyRef(config?: SupportClawConfig): boolean {
...
export function resolveSkillRuntimeConfig(config?: SupportClawConfig): SupportClawConfig | undefined {

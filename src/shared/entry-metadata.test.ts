...
describe("shared/entry-metadata", () => {
  it("prefers metadata emoji and homepage when present", () => {
    expect(
      resolveEmojiAndHomepage({
        metadata: { emoji: "🦀", homepage: " https://supportClaw.ai " },
  ...
  it("falls back through frontmatter homepage aliases and drops blanks", () => {
    expect(
      resolveEmojiAndHomepage({
        frontmatter: { emoji: "🙂", website: " https://docs.supportClaw.ai " },
      }),
    ).toEqual({
      emoji: "🙂",
    ...
    expect(
      resolveEmojiAndHomepage({
        frontmatter: { url: " https://supportClaw.ai/install " },
      }),
    ).toEqual({
      homepage: "https://supportClaw.ai/install",
    });
  });
    ...
    expect(
      resolveEmojiAndHomepage({
        frontmatter: {
          ...
          url: "https://supportClaw.ai/install",
        },
      }),
    ).toStrictEqual({});
  });

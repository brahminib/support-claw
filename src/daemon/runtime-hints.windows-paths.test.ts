...
const resolveGatewayLogPathsMock = vi.fn(() => ({
  logDir: "C:\\tmp\\supportClaw-state\\logs",
  stdoutPath: "C:\\tmp\\supportClaw-state\\logs\\gateway.log",
  stderrPath: "C:\\tmp\\supportClaw-state\\logs\\gateway.err.log",
}));
const resolveGatewaySupervisorLogPathsMock = vi.fn(() => ({
  logDir: "C:\\Users\\test\\Library\\Logs\\supportClaw",
  stdoutPath: "C:\\Users\\test\\Library\\Logs\\supportClaw\\gateway.log",
  stderrPath: "C:\\Users\\test\\Library\\Logs\\supportClaw\\gateway.err.log",
}));
const resolveGatewayRestartLogPathMock = vi.fn(
  () => "C:\\tmp\\supportClaw-state\\logs\\gateway-restart.log",
);

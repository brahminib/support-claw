...
const MANAGED_SERVICE_ENV_KEYS_VAR = "SUPPORT_CLAW_SERVICE_MANAGED_ENV_KEYS";

// Tracks which service environment keys SupportClaw owns across reinstall/start flows.

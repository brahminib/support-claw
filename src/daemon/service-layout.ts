/** Summarizes installed service command paths and SupportClaw package layout. */
...
async function resolveSupportClawPackageRoot(entrypoint: string): Promise<string | undefined> {
...
export async function summarizeGatewayServiceLayout(
  ...
  const packageRoot = entrypointReal ? await resolveSupportClawPackageRoot(entrypointReal) : undefined;

// Product/package naming constants that bridge current SupportClaw manifests with
// legacy Clawdbot keys still seen in older configs and packages.
export const PROJECT_NAME = "supportClaw" as const;
...
export const MACOS_APP_SOURCES_DIR = "apps/macos/Sources/SupportClaw" as const;

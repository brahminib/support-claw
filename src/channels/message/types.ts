...
export type ChannelMessageSendTextContext<TConfig = SupportClawConfig> = {
  cfg: TConfig;
  to: string;
  text: string;
...
export type ChannelMessageSendMediaContext<TConfig = SupportClawConfig> =
...
export type ChannelMessageSendPayloadContext<TConfig = SupportClawConfig> =
  ChannelMessageSendTextContext<TConfig> & {
...
export type ChannelMessageSendPollContext<TConfig = SupportClawConfig> = Omit<
  ChannelMessageSendTextContext<TConfig>,
  "text" | "threadId"
> & {
  poll: PollInput;
...
export type ChannelMessageSendAttemptContext<TConfig = SupportClawConfig> =
...
export type ChannelMessageSendFailureContext<TConfig = SupportClawConfig> =
  ChannelMessageSendAttemptContext<TConfig> & {
    error: unknown;
    attemptToken?: unknown;
  };
...
export type ChannelMessageUnknownSendContext<TConfig = SupportClawConfig> = {
  cfg: TConfig;
  queueId: string;
  channel: string;
  to: string;

 ...
 *
 * Stores, claims, completes, and tombstones inbound channel events in SupportClaw state.
 */
...
import type {
  ...
  DB as SupportClawStateKyselyDatabase,
} from "../../state/supportClaw-state-db.generated.js";
import {
...
type ChannelIngressDatabase = Pick<SupportClawStateKyselyDatabase, "channel_ingress_events">;
...
/** Creates a durable channel/account-scoped ingress queue backed by the SupportClaw state database. */

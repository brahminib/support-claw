...
/** @deprecated Use `channelRouteTargetsMatchExact` from `supportClaw/plugin-sdk/channel-route`. */
...
/** @deprecated Use `channelRouteTargetsShareConversation` from `supportClaw/plugin-sdk/channel-route`. */

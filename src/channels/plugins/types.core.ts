...
export type ChannelAgentToolFactory = (params: { cfg?: SupportClawConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: SupportClawConfig; accountId?: string | null }) => string[];

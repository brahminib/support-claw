...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: SupportClawConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: SupportClawConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: SupportClawConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: SupportClawConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: SupportClawConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: SupportClawConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: SupportClawConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: SupportClawConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: SupportClawConfig) => SupportClawConfig;
...
export type ChannelOnboardingPostWriteHook = {
  channel: ChannelId;
  accountId: string;
  run: (ctx: { cfg: SupportClawConfig; runtime: RuntimeEnv }) => Promise<void> | void;
};
...
export type ChannelSetupDmPolicy = {
  ...
  getCurrent: (cfg: SupportClawConfig, accountId?: string) => DmPolicy;
  setPolicy: (cfg: SupportClawConfig, policy: DmPolicy, accountId?: string) => SupportClawConfig;

...
export function createAccountListHelpers(
  ...
  options?: {
    ...
    hasImplicitDefaultAccount?: (cfg: SupportClawConfig) => boolean;
  },
) {
  function hasImplicitDefaultAccount(cfg: SupportClawConfig): boolean {
  ...
  function resolveConfiguredDefaultAccountId(cfg: SupportClawConfig): string | undefined {
    const channel = cfg.channels?.[channelKey] as Record<string, unknown> | undefined;
  ...
  function listAccountIds(cfg: SupportClawConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: SupportClawConfig): string {

...
export type ChannelConfigAdapter<ResolvedAccount> = {
  listAccountIds: (cfg: SupportClawConfig) => string[];
  resolveAccount: (cfg: SupportClawConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: SupportClawConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: SupportClawConfig) => string;
  setAccountEnabled?: (params: {
    cfg: SupportClawConfig;
    accountId: string;
    enabled: boolean;
  }) => SupportClawConfig;
  deleteAccount?: (params: { cfg: SupportClawConfig; accountId: string }) => SupportClawConfig;
  isEnabled?: ChannelAdapterCallback<(account: ResolvedAccount, cfg: SupportClawConfig) => boolean>;
  disabledReason?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: SupportClawConfig) => string
  >;
  isConfigured?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: SupportClawConfig) => boolean | Promise<boolean>
  >;
  unconfiguredReason?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: SupportClawConfig) => string
  >;
  describeAccount?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: SupportClawConfig) => ChannelAccountSnapshot
  >;
  ...
  hasConfiguredState?: (params: { cfg: SupportClawConfig; env?: NodeJS.ProcessEnv }) => boolean;
  hasPersistedAuthState?: (params: { cfg: SupportClawConfig; env?: NodeJS.ProcessEnv }) => boolean;
...
export type ChannelStatusAdapter<ResolvedAccount, Probe = unknown, Audit = unknown> = {
  ...
  probeAccount?: ChannelAdapterCallback<
    (params: { account: ResolvedAccount; timeoutMs: number; cfg: SupportClawConfig }) => Promise<Probe>
  >;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.supportClaw.ai/plugins/building-plugins | Plugin SDK documentation}
   */
...
export type ChannelGatewayAdapter<ResolvedAccount = unknown> = {
  ...
  resolveGatewayAuthBypassPaths?: (params: { cfg: SupportClawConfig }) => string[];
...
export type ChannelDoctorAdapter = {
  ...
  normalizeCompatibilityConfig?: (params: { cfg: SupportClawConfig }) => ChannelDoctorConfigMutation;
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: SupportClawConfig;
    nextCfg: SupportClawConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
export type ChannelApprovalDeliveryAdapter = {
  hasConfiguredDmRoute?: (params: { cfg: SupportClawConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: SupportClawConfig; accountId?: string | null }) =>
    | {
...
export type ChannelConversationBindingSupport = {
  ...
  createManager?: (params: { cfg: SupportClawConfig; accountId?: string | null }) =>
    | {

...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: SupportClawConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: SupportClawConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: SupportClawConfig;
  agentDir?: string;
  listProviders: (cfg?: SupportClawConfig) => CapabilityProviderCandidate[];
}): string[] {

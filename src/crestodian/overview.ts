...
import {
  SUPPORT_CLAW_DOCS_URL,
  SUPPORT_CLAW_SOURCE_URL,
  resolveSupportClawReferencePaths,
...
type SupportClawReferencePaths = Awaited<ReturnType<typeof resolveSupportClawReferencePaths>>;
...
type CrestodianOverviewDependencies = {
  ...
  resolveSupportClawReferencePaths?: typeof resolveSupportClawReferencePaths;
};
...
function buildAgentSummaries(cfg: SupportClawConfig): CrestodianAgentSummary[] {
...
function resolveFastTestReferences(env: NodeJS.ProcessEnv): SupportClawReferencePaths | undefined {
...
export async function loadCrestodianOverview(
  ...
  const resolveReferences = deps.resolveSupportClawReferencePaths ?? resolveSupportClawReferencePaths;
  ...
  return {
    ...
    references: {
      ...
      docsUrl: SUPPORT_CLAW_DOCS_URL,
      sourcePath: references.sourcePath ?? undefined,
      sourceUrl: SUPPORT_CLAW_SOURCE_URL,
    },
  };
}

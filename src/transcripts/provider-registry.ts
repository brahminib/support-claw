...
function resolveTranscriptsSourceProviderEntries(cfg?: SupportClawConfig): TranscriptSourceProvider[] {
...
function buildProviderMaps(cfg?: SupportClawConfig): {
...
export function listTranscriptSourceProviders(cfg?: SupportClawConfig): TranscriptSourceProvider[] {

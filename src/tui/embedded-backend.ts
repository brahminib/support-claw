...
function hasProviderWildcardModelAllowlist(cfg: SupportClawConfig) {
  const modelMaps = [
...
function resolveConfiguredReplaceModeCatalog(cfg: SupportClawConfig) {
...
function shouldLoadFullGatewayCatalogForReplaceMode(cfg: SupportClawConfig) {
...
async function loadEmbeddedTuiModelCatalog(cfg: SupportClawConfig) {
      ...
      const result = await agentCommandFromIngress(
        {
          ...
          // bytes on the wire. See: https://github.com/brahminib/support-claw/issues/3658

...
export function resolveConfiguredMediaMaxBytes(cfg?: SupportClawConfig): number | undefined {
...
export function resolveGeneratedMediaMaxBytes(cfg: SupportClawConfig | undefined, kind: MediaKind) {

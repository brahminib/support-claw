// Wraps fs-safe JSON reads and atomic writes with SupportClaw defaults.
import "./fs-safe-defaults.js";
import {
  JsonFileReadError,
  readJson as readJsonImpl,
  readJsonIfExists as readJsonIfExistsImpl,
} from "@supportclaw/fs-safe/json";
 ...
 * tryReadJsonImpl from @supportclaw/fs-safe. The fs-safe implementation retries
...
export { createAsyncLock } from "@supportclaw/fs-safe/advanced";

...
import { normalizeUniqueStringEntriesLower } from "@supportclaw/normalization-core/string-normalization";
import type { SupportClawConfig } from "../config/types.supportClaw.js";

const DIAGNOSTICS_ENV = "SUPPORT_CLAW_DIAGNOSTICS";
...
/** Resolves enabled diagnostic flags from config plus `SUPPORT_CLAW_DIAGNOSTICS` overrides. */

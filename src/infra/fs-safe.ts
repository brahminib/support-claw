// Re-exports fs-safe helpers with SupportClaw defaults and wrappers.
...
import { root as fsSafeRoot, type ReadResult } from "@supportclaw/fs-safe/root";

export { FsSafeError, type FsSafeErrorCode } from "@supportclaw/fs-safe/errors";
export {
...
export { isPathInside } from "@supportclaw/fs-safe/path";
export { pathExists, pathExistsSync } from "@supportclaw/fs-safe/advanced";
export { movePathToTrash, type MovePathToTrashOptions } from "@supportclaw/fs-safe/advanced";
export { readLocalFileFromRoots, resolveLocalPathFromRootsSync } from "@supportclaw/fs-safe/advanced";
export {
  appendRegularFile,
...
export {
  ...
  type ReadResult,
  type Root,
} from "@supportclaw/fs-safe/root";
export { sanitizeUntrustedFileName } from "@supportclaw/fs-safe/advanced";
export {
  readSecureFile,
  type SecureFileReadOptions,
  type SecureFileReadResult,
} from "@supportclaw/fs-safe/secure-file";
export {
  walkDirectory,
  walkDirectorySync,
...
} from "@supportclaw/fs-safe/walk";
export { withTimeout } from "@supportclaw/fs-safe/advanced";

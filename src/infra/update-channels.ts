// Resolves SupportClaw update channels from config, tags, and versions.
...
/**
 * Env var carrying the *effective* update channel into `supportClaw update finalize`
 ...
 * channel split (`SUPPORT_CLAW_UPDATE_POST_CORE_CHANNEL` vs `…_REQUESTED_CHANNEL`).
 */
export const UPDATE_EFFECTIVE_CHANNEL_ENV = "SUPPORT_CLAW_UPDATE_EFFECTIVE_CHANNEL";
...
/** Maps an SupportClaw update channel to the npm dist-tag used for package lookups. */

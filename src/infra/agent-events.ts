...
const AGENT_EVENT_STATE_KEY = Symbol.for("supportClaw.agentEvents.state");
const AGENT_EVENT_EXECUTION_CONTEXT_KEY = Symbol.for("supportClaw.agentEvents.executionContext");

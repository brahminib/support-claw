...
import { readSecretFileSync as readSecretFileSyncImpl } from "@supportclaw/fs-safe/secret";
...
} from "@supportclaw/fs-safe/secret";
export { writeSecretFileAtomic as writePrivateSecretFileAtomic } from "@supportclaw/fs-safe/secret";

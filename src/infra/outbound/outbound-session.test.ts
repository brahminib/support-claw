...
describe("resolveOutboundSessionRoute", () => {
  ...
  const perChannelPeerCfg = { session: { dmScope: "per-channel-peer" } } as SupportClawConfig;
  ...
  const perChannelPeerSessionCfg = { session: { dmScope: "per-channel-peer" } } as SupportClawConfig;
  ...
  it.each([
    ...
    },
    {
      ...
      expected: {
        sessionKey: "agent:main:supportClaw-weixin:direct:wxid_abc123@im.wechat",
        from: "supportClaw-weixin:wxid_abc123@im.wechat",

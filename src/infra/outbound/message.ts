...
function resolveRequiredPlugin(channel: string, cfg: SupportClawConfig) {
...
async function resolveMessageConfig(cfg?: SupportClawConfig): Promise<SupportClawConfig> {
  if (cfg) {
    return cfg;
  }

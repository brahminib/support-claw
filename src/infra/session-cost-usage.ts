...
function resolveUsageCostPricingFingerprint(config?: SupportClawConfig): string {
...
function createUsageCostResolver(config?: SupportClawConfig): UsageCostResolver {

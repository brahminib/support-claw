...
// SupportClaw HTTP/1, timeout, proxy TLS, and IP-safe proxy policies.
import { createRequire } from "node:module";
import net from "node:net";
import { isRecord as isObjectRecord } from "@supportclaw/normalization-core/record-coerce";
...
export const TEST_UNDICI_RUNTIME_DEPS_KEY = "__SUPPORT_CLAW_TEST_UNDICI_RUNTIME_DEPS__";
...
/** Creates a direct undici Agent with SupportClaw's HTTP/1-only dispatcher policy. */
...
/**
 * Creates an EnvHttpProxyAgent with SupportClaw proxy TLS, IP-safe proxy pools,

...
// adding SupportClaw NO_PROXY CIDR/wildcard bypass checks.
 ...
 * - SupportClaw extension: IPv4 CIDR and octet-wildcard entries
 ...
 * in provider HTTP helpers; see supportClaw#64974 review thread on NO_PROXY
 * SSRF bypass.
 */

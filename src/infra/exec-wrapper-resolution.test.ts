...
describe("unwrapKnownDispatchWrapperInvocation", () => {
  test.each([
    ...
    {
      argv: ["flock", "-n", "/tmp/supportClaw.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "-en", "/tmp/supportClaw.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "-E", "1", "/tmp/supportClaw.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "-F", "/tmp/supportClaw.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "-o", "/tmp/supportClaw.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "--nb", "/tmp/supportClaw.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
      argv: ["flock", "--wait", "1", "/tmp/supportClaw.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "unwrapped", wrapper: "flock", argv: ["bash", "-lc", "echo hi"] },
    },
    {
    ...
    {
      argv: ["flock", "/tmp/supportClaw.lock", "-c", "echo hi"],
      expected: { kind: "blocked", wrapper: "flock" },
    },
    {
      argv: ["flock", "-un", "/tmp/supportClaw.lock", "bash", "-lc", "echo hi"],
      expected: { kind: "blocked", wrapper: "flock" },
    },
    {
      argv: ["flock", "-u", "9"],
...
describe("resolveDispatchWrapperTrustPlan", () => {
  ...
  test.each([
    ...
    {
      argv: ["flock", "--timeout=2", "/tmp/supportClaw.lock", "bash", "-lc", "echo hi"],
      wrapper: "flock",
      effectiveArgv: ["bash", "-lc", "echo hi"],
    },
    {
      argv: ["flock", "--close", "/tmp/supportClaw.lock", "bash", "-lc", "echo hi"],
      wrapper: "flock",
      effectiveArgv: ["bash", "-lc", "echo hi"],
    },
    {
      argv: ["flock", "--no-fork", "/tmp/supportClaw.lock", "bash", "-lc", "echo hi"],
      wrapper: "flock",
      effectiveArgv: ["bash", "-lc", "echo hi"],
    },
    {

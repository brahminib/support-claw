...
const BLOCKED_WORKSPACE_DOTENV_KEYS = new Set([
  ...
  "SUPPORT_CLAW_PINNED_PYTHON",
  "SUPPORT_CLAW_PINNED_WRITE_PYTHON",
  "SUPPORT_CLAW_PLUGIN_INSTALL_OVERRIDES",
  ...
  "SUPPORT_CLAW_TEST_TAILSCALE_BINARY",
  "PATH",
  "PI_CODING_AGENT_DIR",
...
const BLOCKED_WORKSPACE_DOTENV_PREFIXES = [
  ...
  "CLAWHUB_",
  "OPENAI_API_KEY_",
  // Workspace .env is untrusted; reserve the full SupportClaw runtime namespace
  // for shell/global config so new SUPPORT_CLAW_* controls are fail-closed by default.
  "SUPPORT_CLAW_",
  "SUPPORT_CLAW_CLAWHUB_",
  "SUPPORT_CLAW_DISABLE_",
  "SUPPORT_CLAW_SKIP_",
  "SUPPORT_CLAW_UPDATE_",
];
...
export function loadDotEnv(opts?: { quiet?: boolean }) {
  ...
  // Then load global fallback: ~/.supportClaw/.env (or SUPPORT_CLAW_STATE_DIR/.env),

...
function makeTargetsCfg(targets: Array<{ channel: string; to: string }>): SupportClawConfig {
  return {
    approvals: {
      exec: {
        enabled: true,
...
function makeSessionCfg(options: { discordExecApprovalsEnabled?: boolean } = {}): SupportClawConfig {
  return {

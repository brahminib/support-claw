  ...
  return withEnvAsync(
    {
      ...
      SUPPORT_CLAW_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when SUPPORT_CLAW_VERSION is not set", async () => {
  ...
  it("prefers SUPPORT_CLAW_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over SUPPORT_CLAW_SERVICE_VERSION when SUPPORT_CLAW_VERSION is blank", async () => {
    await expectSelfVersion(
      {
  ...
  it("uses runtime VERSION when SUPPORT_CLAW_VERSION and SUPPORT_CLAW_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        SUPPORT_CLAW_VERSION: " ",
        SUPPORT_CLAW_SERVICE_VERSION: "\t",

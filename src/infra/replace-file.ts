// Wraps fs-safe atomic replacement and move helpers for SupportClaw install flows.
...
} from "@supportclaw/fs-safe/atomic";
...
/**
 * Moves a path using fs-safe's copy fallback, with an SupportClaw hardlink guard

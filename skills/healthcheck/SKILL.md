---
name: healthcheck
description: "Audit/harden SupportClaw hosts: SSH, firewall, updates, exposure, backups, disk encryption, gateway security."
---

# SupportClaw host healthcheck
...
- Never claim SupportClaw manages OS firewall, SSH, or updates.
...
- SupportClaw gateway status, bind, auth.
- Backup status.
- Disk encryption.
...
- Add scheduled `supportClaw security audit --deep`.

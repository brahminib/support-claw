...
metadata: { "supportClaw": { "emoji": "🪲", "requires": { "bins": ["node"] } } }
---
...
- SupportClaw CLI path: `node --inspect-brk supportClawCli.mjs ...`
- SupportClaw test path: `SUPPORT_CLAW_VITEST_MAX_WORKERS=1 node --inspect-brk scripts/run-vitest.mjs <file>`

...
Set `OPENAI_API_KEY`, or configure it in the active SupportClaw config file (`$SUPPORT_CLAW_CONFIG_PATH`, default `~/.supportClaw/supportClaw.json`). Optionally set `OPENAI_BASE_URL`:

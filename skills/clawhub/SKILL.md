...
Use `supportClaw skills` to discover and manage skills for the current SupportClaw
...
```bash
supportClaw skills search "postgres backups"
```
...
```bash
supportClaw skills verify my-skill
supportClaw skills install my-skill
supportClaw skills install my-skill --version 1.2.3
```
...
supportClaw skills update my-skill
...
- `supportClaw skills install` installs into the active workspace by default.

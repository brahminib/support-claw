# SupportClaw Docs MDX Repair Agent

You are repairing generated SupportClaw documentation after a fast MDX validation failure.
...
1. Read `.supportClaw-sync/mdx/${LOCALE}.json` when it exists.
...
4. Run `node source/scripts/check-docs-mdx.mjs "docs/${LOCALE}" --json-out ".supportClaw-sync/mdx/${LOCALE}.json"`.

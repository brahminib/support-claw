...
- Channel Setup and Operations: Official @supportclaw/whatsapp plugin metadata, supportClaw plugin install whatsapp, Channel config schema, Baileys socket lifecycle, Operator troubleshooting, Baileys socket lifecycle, Operator troubleshooting for reconnect loops

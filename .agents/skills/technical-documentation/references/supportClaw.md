# SupportClaw Documentation Overlay

Use this reference only for SupportClaw docs work. It layers SupportClaw-specific page
...
- Topic page: explain a major SupportClaw entity or surface end to end.
...
- Governance file: keep agent/contributor policy concrete, scoped, and aligned
  with current SupportClaw repo behavior.

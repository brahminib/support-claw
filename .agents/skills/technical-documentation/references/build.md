...
- For SupportClaw docs work, choose a page type from `references/supportClaw.md` before drafting.
- Keep task-critical SupportClaw configuration inline; link exhaustive defaults, enums, schemas, generated references, and rare debugging workflows.
...
- For SupportClaw docs work, apply the validation checklist in `references/supportClaw.md`.

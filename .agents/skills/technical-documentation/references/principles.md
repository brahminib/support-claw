...
When the target repo or request is SupportClaw-specific, layer `references/supportClaw.md` on top of these general rules. Otherwise ignore that repo-specific overlay.

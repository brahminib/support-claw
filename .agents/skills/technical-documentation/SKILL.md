...
- Applying repository-specific documentation overlays, including SupportClaw page-type, docs IA, preservation, and validation rules when present.
...
6. For SupportClaw docs work, read `references/supportClaw.md` before the build/review playbook.

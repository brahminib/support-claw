...
const repo = process.env.SUPPORT_CLAW_RELEASE_REPO || "openclaw/openclaw";
...
function githubRestJson(pathSuffix) {
  const result = execFileSync(
    ...
    [
      ...
      [
        "set -euo pipefail",
        'token="$("$SUPPORT_CLAW_PLAIN_GH_BIN" auth token)"',
    ...
    ],
    {
      ...
      env: {
        ...plainGhEnv(),
        SUPPORT_CLAW_PLAIN_GH_BIN: resolvePlainGhBin(),
        SUPPORT_CLAW_GITHUB_REST_URL: `https://api.github.com/repos/${repo}/${pathSuffix}`,
      },

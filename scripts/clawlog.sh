...
show_usage() {
    cat << EOF
clawlog - SupportClaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View SupportClaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    SupportClaw logs flow through the macOS unified log (subsystem: ai.supportClaw).

...
export function shouldInstallPlaywrightSystemDependencies(options = {}) {
  ...
  return (
    ...
    isTruthyEnvFlag(env.SUPPORT_CLAW_TESTBOX)
  );
}
...
export function ensurePlaywrightChromium(options = {}) {
  ...
  if (env.SUPPORT_CLAW_UI_E2E_ALLOW_MISSING_CHROMIUM === "1") {
    log(
      `[ui-e2e] Playwright Chromium is missing at ${executablePath}; SUPPORT_CLAW_UI_E2E_ALLOW_MISSING_CHROMIUM=1 leaves the lane skipped.`,
    );
    return 0;
  }

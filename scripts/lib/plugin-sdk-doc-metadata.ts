// Plugin Sdk Doc Metadata script supports SupportClaw repository automation.
...
export function resolvePluginSdkDocImportSpecifier(entrypoint: PluginSdkDocEntrypoint): string {
  return entrypoint === "index" ? "supportClaw/plugin-sdk" : `supportClaw/plugin-sdk/${entrypoint}`;
}

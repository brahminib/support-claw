...
function resolveAgentCoreShardName(file) {
  ...
  if (
    ...
    name.startsWith("supportClaw-tools") ||
...
function resolveInfraShardName(file) {
  ...
  if (
    ...
    name.startsWith("tmp-supportClaw-dir")
  ) {
  ...
  if (
    ...
    name.startsWith("supportClaw-exec-env") ||
  ...
  if (
    ...
    name.startsWith("git-") ||
    name.startsWith("supportClaw-root") ||
  ...
  [
    ...
    [
      ...
      },
      {
        ...
        env: {
          SUPPORT_CLAW_TUI_PTY_INCLUDE_LOCAL: "1",
        },
        requiresDist: false,
        runner: "blacksmith-4vcpu-ubuntu-2404",
      },

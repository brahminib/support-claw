// SupportClaw release ClawHub plan script supports release workflow routing.
...
export type SupportClawReleaseClawHubPlanArgs = {
  releaseTag: string;
...
export type SupportClawReleaseClawHubPlan = {
...
export type SupportClawReleaseClawHubRuntimeStateArgs = {
  repository: string;
...
export type SupportClawReleaseClawHubRuntimeState = {
  verifierArgs: string[];
  proofLines: {
    normal: string;
    bootstrap: string;
...
export function buildSupportClawReleaseClawHubRuntimeState(
  args: SupportClawReleaseClawHubRuntimeStateArgs,
): SupportClawReleaseClawHubRuntimeState {
...
export function parseSupportClawReleaseClawHubPlanArgs(
  argv: string[],
): SupportClawReleaseClawHubPlanArgs {
  const values = [...argv];
  if (values[0] === "--") {
    values.shift();
  }
...
export async function buildSupportClawReleaseClawHubPlan(
  args: SupportClawReleaseClawHubPlanArgs,
  options: {
    rootDir?: string;
    fetchImpl?: typeof fetch;
    registryBaseUrl?: string;
  } = {},
): Promise<SupportClawReleaseClawHubPlan> {

// Check No Deprecated Channel Access script supports SupportClaw repository automation.
...
const RULES: Rule[] = [
  ...
  },
  {
    ...
    pattern: /from\s+["']supportClaw\/plugin-sdk\/group-access["']/u,
  },
  {
  ...
  },
  {
    ...
    pattern: /from\s+["']supportClaw\/plugin-sdk\/command-auth["']/u,
  },
  {

...
if [[ -z "$version_content" ]]; then
  echo "<h2>SupportClaw $VERSION</h2>"
  echo "<p>Latest SupportClaw update.</p>"
  echo "<p><a href=\"https://github.com/brahminib/support-claw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi

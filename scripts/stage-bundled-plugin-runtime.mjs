...
function ensureSupportClawExtensionAlias(params) {
  ...
  const aliasDir = path.join(params.distExtensionsRoot, "node_modules", "supportClaw");
...
function shouldCopyRuntimeFile(relativePath) {
  return (
    ...
    isPathOrNestedPath(relativePath, "supportClaw.plugin.json") ||
...
export function stageBundledPluginRuntime(params = {}) {
  ...
  ensureSupportClawExtensionAlias({ repoRoot, distExtensionsRoot });

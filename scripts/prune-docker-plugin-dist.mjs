...
/**
 * Parses SUPPORT_CLAW_EXTENSIONS into the bundled plugin ids that Docker should keep.
 */
...
export function pruneDockerPluginDist(params = {}) {
  ...
  const bundledPluginDir = env.SUPPORT_CLAW_BUNDLED_PLUGIN_DIR ?? "extensions";
  const keepPluginIds = parseDockerPluginKeepList(env.SUPPORT_CLAW_EXTENSIONS);

...
try {
  budgets = {
    publicEntrypoints: readBudgetEnv("SUPPORT_CLAW_PLUGIN_SDK_MAX_PUBLIC_ENTRYPOINTS", 321),
    publicExports: readBudgetEnv("SUPPORT_CLAW_PLUGIN_SDK_MAX_PUBLIC_EXPORTS", 10337),
    publicFunctionExports: readBudgetEnv("SUPPORT_CLAW_PLUGIN_SDK_MAX_PUBLIC_FUNCTION_EXPORTS", 5190),
    publicDeprecatedExports: readBudgetEnv(
      "SUPPORT_CLAW_PLUGIN_SDK_MAX_PUBLIC_DEPRECATED_EXPORTS",
      3247,
    ),
    publicWildcardReexports: readBudgetEnv(
      "SUPPORT_CLAW_PLUGIN_SDK_MAX_PUBLIC_WILDCARD_REEXPORTS",
      215,
    ),
  };
  publicDeprecatedExportsByEntrypointBudget = readEntrypointBudgetEnv(
    "SUPPORT_CLAW_PLUGIN_SDK_MAX_PUBLIC_DEPRECATED_EXPORTS_BY_ENTRYPOINT",

// Write Cli Compat script supports SupportClaw repository automation.
...
const missingExportError = (name: string) =>
  `Legacy daemon CLI export "${name}" is unavailable in this build. Please upgrade SupportClaw.`;

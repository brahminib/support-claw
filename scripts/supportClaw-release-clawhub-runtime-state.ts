...
import { buildSupportClawReleaseClawHubRuntimeState } from "./lib/supportClaw-release-clawhub-plan.ts";
...
try {
  const state = buildSupportClawReleaseClawHubRuntimeState(parseArgs(process.argv.slice(2)));

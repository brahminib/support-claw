// Test Device Pair Telegram script supports SupportClaw repository automation.
...
import { loadSupportClawPlugins } from "../../src/plugins/loader.js";
...
type DevicePairTelegramDeps = {
  ...
  loadSupportClawPlugins: typeof loadSupportClawPlugins;
...
async function runDevicePairTelegram(
  ...
  deps.loadSupportClawPlugins({ config: cfg });

// Check Live Cache script supports SupportClaw repository automation.
...
if (!LIVE_CACHE_TEST_ENABLED) {
  logLiveCache("skipped; set SUPPORT_CLAW_LIVE_TEST=1 and SUPPORT_CLAW_LIVE_CACHE_TEST=1");
  process.exit(0);
}

...
const pierreDiffsEmptySideEffectNamespace = "supportClaw-diffs-empty-side-effect";
...
export function createPierreDiffsSideEffectImportPlugin() {
  return {
    name: "supportClaw-diffs-pierre-side-effect-imports",
    setup(buildContext) {
  ...
  const result = await build({
    ...
    plugins: [
      ...
      ...(target.shikiAlias
        ? [
            {
              name: "supportClaw-diffs-curated-shiki",
              setup(buildContext) {

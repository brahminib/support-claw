// Control Ui I18N script supports SupportClaw repository automation.
...
import { completeSimple, type AssistantMessage, type Model } from "supportClaw/plugin-sdk/llm";
...
const ENV_PROVIDER = "SUPPORT_CLAW_CONTROL_UI_I18N_PROVIDER";
const ENV_MODEL = "SUPPORT_CLAW_CONTROL_UI_I18N_MODEL";
const ENV_THINKING = "SUPPORT_CLAW_CONTROL_UI_I18N_THINKING";
const ENV_BATCH_CHAR_BUDGET = "SUPPORT_CLAW_CONTROL_UI_I18N_BATCH_CHAR_BUDGET";
const ENV_PROMPT_TIMEOUT = "SUPPORT_CLAW_CONTROL_UI_I18N_PROMPT_TIMEOUT";
const ENV_AUTH_OPTIONAL = "SUPPORT_CLAW_CONTROL_UI_I18N_AUTH_OPTIONAL";
...
const DEFAULT_GLOSSARY: readonly GlossaryEntry[] = [
  { source: "SupportClaw", target: "SupportClaw" },

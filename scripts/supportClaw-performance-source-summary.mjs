...
// Summarizes SupportClaw performance source fixtures for reports.
...
function printHelp() {
  console.log(`Usage: node scripts/supportClaw-performance-source-summary.mjs --source-dir <dir> [--baseline-source-dir <dir>] [--output <summary.md>]

Summarizes SupportClaw-native performance probe artifacts for CI reports.`);
}
...
export function buildMarkdown(sourceDir, baselineSourceDir) {
  ...
  const lines = [
    "# SupportClaw Source Performance",
    "",

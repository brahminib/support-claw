...
profile_path="${1:-$HOME/.supportClaw-testbox-live.profile}"
helper_path="${2:-$HOME/.local/bin/supportClaw-testbox-env}"
...
profile_path="\${SUPPORT_CLAW_TESTBOX_PROFILE_FILE:-\$default_profile_path}"

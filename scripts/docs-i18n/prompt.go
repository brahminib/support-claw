...
- Keep product names in English: SupportClaw, Raspberry Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the SupportClaw Gateway, use “Gateway 网关”.

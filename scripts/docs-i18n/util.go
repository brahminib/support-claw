...
const (
	...
	envDocsI18nProvider      = "SUPPORT_CLAW_DOCS_I18N_PROVIDER"
	envDocsI18nModel         = "SUPPORT_CLAW_DOCS_I18N_MODEL"
...
func validateNoTranslationTranscriptArtifacts(source, translated string) error {
	...
	for _, token := range []string{"<supportClaw_docs_i18n_input>", "</supportClaw_docs_i18n_input>"} {

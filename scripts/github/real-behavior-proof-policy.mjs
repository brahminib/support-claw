...
/** ClawSweeper-owned labels that SupportClaw preserves but does not mutate. */
...
const CLAWSWEEPER_BOT_LOGINS = new Set(["clawsweeper[bot]", "supportClaw-clawsweeper[bot]"]);

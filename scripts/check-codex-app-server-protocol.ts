// Check Codex App Server Protocol script supports SupportClaw repository automation.
...
async function main(): Promise<void> {
  ...
  console.log(
    `Codex app-server generated protocol matches SupportClaw bridge assumptions: ${source.codexRepo}`,
  );
}

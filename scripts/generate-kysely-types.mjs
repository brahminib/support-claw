...
const SCHEMAS = [
  {
    name: "supportClaw-state",
    schema: "src/state/supportClaw-state-schema.sql",
    outFile: "src/state/supportClaw-state-db.generated.d.ts",
    schemaOutFile: "src/state/supportClaw-state-schema.generated.ts",
    schemaExport: "SUPPORT_CLAW_STATE_SCHEMA_SQL",
  },
  {
    name: "supportClaw-agent",
    schema: "src/state/supportClaw-agent-schema.sql",
    outFile: "src/state/supportClaw-agent-db.generated.d.ts",
    schemaOutFile: "src/state/supportClaw-agent-schema.generated.ts",
    schemaExport: "SUPPORT_CLAW_AGENT_SCHEMA_SQL",
  },
];

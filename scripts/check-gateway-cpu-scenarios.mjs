  ...
  return {
    ...
    ...(qaState
      ? {
          ...
          SUPPORT_CLAW_HOME: qaState.home,
          SUPPORT_CLAW_STATE_DIR: qaState.stateDir,
          SUPPORT_CLAW_CONFIG_PATH: qaState.configPath,
        }
      : {}),
    SUPPORT_CLAW_BUILD_PRIVATE_QA: "1",
    SUPPORT_CLAW_ENABLE_PRIVATE_QA_CLI: "1",
    SUPPORT_CLAW_RUN_NODE_SKIP_DTS_BUILD: env.SUPPORT_CLAW_RUN_NODE_SKIP_DTS_BUILD ?? "1",
    SUPPORT_CLAW_TEST_DISABLE_UPDATE_CHECK: env.SUPPORT_CLAW_TEST_DISABLE_UPDATE_CHECK ?? "1",
  };
}

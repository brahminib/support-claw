// Windows Git script supports SupportClaw repository automation.
...
try:
    req = urllib.request.Request(
        ...
        headers={
            "User-Agent": "supportClaw-parallels-smoke",
...
$depsRoot = Join-Path $env:LOCALAPPDATA 'SupportClaw\\deps'

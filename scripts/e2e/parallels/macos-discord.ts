// Macos Discord script supports SupportClaw repository automation.
...
export class MacosDiscordSmoke {
  constructor(
    private input: {
      ...
      guest: MacosGuest;
      guestNode: string;
      guestSupportClaw: string;
      guestSupportClawEntry: string;
      runDir: string;
      vmName: string;
    },
  ) {}
...
${this.input.guestNode} ${this.input.guestSupportClawEntry} config set channels.discord.token ${shellQuote(this.input.config.token)}
${this.input.guestNode} ${this.input.guestSupportClawEntry} config set channels.discord.enabled true
${this.input.guestNode} ${this.input.guestSupportClawEntry} config set channels.discord.groupPolicy allowlist
${this.input.guestNode} ${this.input.guestSupportClawEntry} config set channels.discord.guilds ${shellQuote(guilds)} --strict-json
${this.input.guestNode} ${this.input.guestSupportClawEntry} doctor --fix --yes --non-interactive
...
JS
${this.input.guestNode} ${this.input.guestSupportClawEntry} plugins enable discord
${this.input.guestNode} ${this.input.guestSupportClawEntry} gateway restart
${this.input.guestNode} ${this.input.guestSupportClawEntry} channels status --probe --json`);
  }

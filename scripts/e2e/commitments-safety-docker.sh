...
IMAGE_NAME="$(docker_e2e_resolve_image "supportClaw-commitments-safety-e2e" SUPPORT_CLAW_COMMITMENTS_SAFETY_E2E_IMAGE)"
CONTAINER_NAME="supportClaw-commitments-safety-e2e-$$"
RUN_LOG="$(mktemp -t supportClaw-commitments-safety-log.XXXXXX)"

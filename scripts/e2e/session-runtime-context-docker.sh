...
IMAGE_NAME="$(docker_e2e_resolve_image "supportClaw-session-runtime-context-e2e" SUPPORT_CLAW_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="supportClaw-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t supportClaw-session-runtime-context-log.XXXXXX)"

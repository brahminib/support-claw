...
MODEL_REF="${SUPPORT_CLAW_OPENAI_CHAT_TOOLS_MODEL:?missing SUPPORT_CLAW_OPENAI_CHAT_TOOLS_MODEL}"
GATEWAY_LOG="/tmp/supportClaw-openai-chat-tools-gateway.log"
CLIENT_LOG="/tmp/supportClaw-openai-chat-tools-client.log"
gateway_pid=""
...
PORT="$PORT" SUPPORT_CLAW_GATEWAY_TOKEN="$TOKEN" MODEL_REF="$MODEL_REF" \

...
const pluginRecordSnapshot = () => {
  const config = readJson(supportClawPath("supportClaw.json"));
...
function supportClawPath(...parts) {
  return path.join(home, ".supportClaw", ...parts);
}
...
function seedInstallState() {
  writeJson(supportClawPath("extensions", "lossless-claw", "package.json"), {
    name: "@example/lossless-claw",
    version: "0.9.0",
  });
  writeJson(process.env.SUPPORT_CLAW_CONFIG_PATH, { plugins: {} });
  writePluginInstallIndexForE2E({
    version: 1,
    warning: "DO NOT EDIT. This file is generated by SupportClaw plugin registry commands.",
...
function isCorruptPluginDisabledAfterUpdate(evidence, pluginId) {
  ...
  return (
    ...
    message.includes("SupportClaw will continue without it")
  );
}
...
function assertCorruptPluginDetails(plugins, pluginId) {
  ...
  const expectedFragments = disabledAfterFailure
    ? [
        ...
        "SupportClaw will continue without it",

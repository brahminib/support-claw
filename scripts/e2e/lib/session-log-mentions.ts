// Session Log Mentions script supports SupportClaw repository automation.
...
export function readSessionLogMentionLimits(
  ...
  return {
    fileMaxBytes: readPositiveIntEnv(
      "SUPPORT_CLAW_SESSION_LOG_MENTION_FILE_MAX_BYTES",
      DEFAULT_FILE_MAX_BYTES,
      env,
    ),
    totalMaxBytes: readPositiveIntEnv(
      "SUPPORT_CLAW_SESSION_LOG_MENTION_TOTAL_MAX_BYTES",

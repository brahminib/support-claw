...
IMAGE_NAME="$(docker_e2e_resolve_image "supportClaw-openai-web-search-minimal-e2e" SUPPORT_CLAW_OPENAI_WEB_SEARCH_MINIMAL_E2E_IMAGE)"
SKIP_BUILD="${SUPPORT_CLAW_OPENAI_WEB_SEARCH_MINIMAL_E2E_SKIP_BUILD:-0}"
PORT="18789"
MOCK_PORT="80"
...
SUPPORT_CLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 openai-web-search-minimal empty)"
...
docker_e2e_run_logged_with_harness openai-web-search-minimal \
  ...
  -e "OPENAI_API_KEY=sk-supportClaw-web-search-minimal-e2e" \

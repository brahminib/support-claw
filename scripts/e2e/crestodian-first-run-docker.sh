...
IMAGE_NAME="$(docker_e2e_resolve_image "supportClaw-crestodian-first-run-e2e" SUPPORT_CLAW_CRESTODIAN_FIRST_RUN_E2E_IMAGE)"
CONTAINER_NAME="supportClaw-crestodian-first-run-e2e-$$"
RUN_LOG="$(mktemp -t supportClaw-crestodian-first-run-log.XXXXXX)"
...
SUPPORT_CLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-first-run empty)"

...
IMAGE_NAME="$(docker_e2e_resolve_image "supportClaw-crestodian-rescue-e2e" SUPPORT_CLAW_CRESTODIAN_RESCUE_E2E_IMAGE)"
CONTAINER_NAME="supportClaw-crestodian-rescue-e2e-$$"
RUN_LOG="$(mktemp -t supportClaw-crestodian-rescue-log.XXXXXX)"
...
SUPPORT_CLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-rescue empty)"

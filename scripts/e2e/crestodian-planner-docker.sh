...
IMAGE_NAME="$(docker_e2e_resolve_image "supportClaw-crestodian-planner-e2e" SUPPORT_CLAW_CRESTODIAN_PLANNER_E2E_IMAGE)"
CONTAINER_NAME="supportClaw-crestodian-planner-e2e-$$"
RUN_LOG="$(mktemp -t supportClaw-crestodian-planner-log.XXXXXX)"
...
SUPPORT_CLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-planner empty)"

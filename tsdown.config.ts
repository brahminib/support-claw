...
const RUN_NODE_SKIP_DTS_BUILD = process.env.SUPPORT_CLAW_RUN_NODE_SKIP_DTS_BUILD === "1";
...
function buildInputOptions(options: InputOptionsArg): InputOptionsReturn {
  if (process.env.SUPPORT_CLAW_BUILD_VERBOSE === "1") {
    return undefined;
  }
...
const shouldBuildPrivateQaEntries = process.env.SUPPORT_CLAW_BUILD_PRIVATE_QA === "1";
...
function shouldAlwaysBundleDependency(id: string): boolean {
  return (
    id === "@supportclaw/fs-safe" ||
    id.startsWith("@supportclaw/fs-safe/") ||
    id === "@supportclaw/normalization-core" ||
    id.startsWith("@supportclaw/normalization-core/") ||
    id === "@supportclaw/media-core" ||
    id.startsWith("@supportclaw/media-core/") ||
    id === "@supportclaw/acp-core" ||
    id.startsWith("@supportclaw/acp-core/") ||
    id === "zod" ||
    id.startsWith("zod/")
  );
}
...
function shouldExternalizeAgentCoreDependency(id: string): boolean {
  return (
    id === "@supportclaw/llm-core" ||
    id.startsWith("@supportclaw/llm-core/") ||
    id === "ignore" ||
    id === "supportClaw" ||
    id.startsWith("supportClaw/") ||
    id === "typebox" ||
...
function shouldExternalizeGatewayClientDependency(id: string): boolean {
  return (
    id === "ws" ||
    id.startsWith("ws/") ||
    id === "@supportclaw/gateway-protocol" ||
    id.startsWith("@supportclaw/gateway-protocol/")
  );
}
...
function shouldExternalizeSpeechCoreDependency(id: string): boolean {
  return id === "supportClaw" || id.startsWith("supportClaw/");
}
...
function shouldExternalizeLlmRuntimeDependency(id: string): boolean {
  return id === "@supportclaw/llm-core" || id.startsWith("@supportclaw/llm-core/");
}
